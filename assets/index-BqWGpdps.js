...
`;function Ke(s,e){const t=document.getElementById("gdpr-modal");t&&t.remove();const i=document.createElement("div");i.id="gdpr-modal",i.className="gdpr-modal",i.innerHTML=`
  ...
  `,document.body.appendChild(i);const a=i.querySelector(".gdpr-close-btn"),o=i.querySelector(".gdpr-btn-accept"),l=i.querySelector(".gdpr-btn-decline"),p=i.querySelector(".gdpr-modal-overlay"),v=()=>{i.remove()};a.addEventListener("click",()=>{v(),e&&e()}),p.addEventListener("click",()=>{v(),e&&e()}),l.addEventListener("click",()=>{v(),e&&e()}),o.addEventListener("click",()=>{v(),s&&s()}),document.body.style.overflow="hidden";const f=v,m=()=>{document.body.style.overflow="",f()};a.onclick=()=>{m(),e&&e()},p.onclick=()=>{m(),e&&e()},l.onclick=()=>{m(),e&&e()},o.onclick=()=>{m(),s&&s()}}function qe(){const s=document.createElement("div");return s.className="gdpr-checkbox-container",s.innerHTML=`
...
<div class="screen" id="screen-matches">
  ...
  <div class="scroll-content">
    <div class="search-wrap"><span class="search-icon">🔢</span><input class="search-input" id="match-id-search" placeholder="${r("search_match_placeholder")}" type="number"><button class="btn-primary" style="margin-left:10px;padding:8px 16px;font-size:14px;" onclick="searchMatchByIdHandler()">Søk</button></div>
