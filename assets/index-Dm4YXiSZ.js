import{initializeApp as ft}from"https://www.gstatic.com/firebasejs/10.12.2/firebase-app.js";import{getAuth as bt,onAuthStateChanged as yt,signInWithEmailAndPassword as wt,createUserWithEmailAndPassword as kt,signOut as xt}from"https://www.gstatic.com/firebasejs/10.12.2/firebase-auth.js";import{getFirestore as St,getDoc as be,doc as U,setDoc as Ne,query as $e,collection as Le,where as Fe,getDocs as He,onSnapshot as ze,serverTimestamp as Me,updateDoc as de,arrayUnion as it,deleteDoc as Lt}from"https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js";import{getFunctions as Pt,httpsCallable as Et}from"https://www.gstatic.com/firebasejs/10.12.2/firebase-functions.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=t(a);fetch(a.href,n)}})();const Tt={apiKey:"AIzaSyA11OPapSOfwLQzs-oEoF7papT9S3T5p7Q",authDomain:"ipsc-insight-coach.firebaseapp.com",projectId:"ipsc-insight-coach",storageBucket:"ipsc-insight-coach.firebasestorage.app",messagingSenderId:"864793320312",appId:"1:864793320312:web:c586e384bbe365444bc68d",measurementId:"G-3Y4NZTBBS2"},st=ft(Tt),Ae=bt(st),O=St(st),It=Pt();let je=null,oe=null;function Mt(e){yt(Ae,async i=>{if(i){je=i;try{const t=await be(U(O,"users",i.uid));t.exists()?oe={uid:i.uid,...t.data()}:oe={uid:i.uid,email:i.email,name:i.email?i.email.split("@")[0]:"Bruker",role:"user"},e(oe)}catch(t){console.error("Feil ved lasting av brukerprofil:",t),oe={uid:i.uid,email:i.email,name:i.email?i.email.split("@")[0]:"Bruker",role:"user"},e(oe)}}else je=null,oe=null,e(null)})}async function Ct(e,i){try{const t=(e||"").trim();return{success:!0,user:(await wt(Ae,t,i||"")).user}}catch(t){console.error("Innlogging feilet:",t);let s="Innlogging feilet";return t.code==="auth/user-not-found"||t.code==="auth/wrong-password"||t.code==="auth/invalid-credential"?s="Feil e-post eller passord":t.code==="auth/invalid-email"?s="Ugyldig e-postadresse":t.code==="auth/user-disabled"&&(s="Denne kontoen er deaktivert"),{success:!1,error:s}}}async function _t(e,i,t,s,a,n,r,u,m,b){try{const f=(e||"").trim(),p=i||"",h=(t||"").trim(),E=(s||"").trim(),k=(a||"").trim(),P=(n||"").trim(),C=(r||"").trim(),L=(u||"minor").trim(),I=(m||"").trim(),B=(b||"").trim(),_=(await kt(Ae,f,p)).user,K=Et(It,"validateInviteCode");try{await K({code:h,userId:_.uid,userEmail:f})}catch(j){await _.delete();let w="Ugyldig invitasjonskode";return j.code==="functions/not-found"?w="Ugyldig invitasjonskode":j.code==="functions/permission-denied"?w="Denne koden er deaktivert":j.code==="functions/resource-exhausted"?w="Denne koden har nådd maksimalt antall bruk":j.code==="functions/already-exists"?w="Du har allerede brukt denne koden":j.message&&(w=j.message),{success:!1,error:w}}return await Ne(U(O,"users",_.uid),{email:f,firstName:E,lastName:k,division:P,category:C,powerFactor:L,region:I,club:B,role:"user",inviteCode:h,createdAt:new Date,draw:null,reloadTime:null,gdprConsent:!0,gdprConsentDate:new Date,gdprVersion:"1.0"}),{success:!0,user:_}}catch(f){console.error("Registrering feilet:",f);let p="Registrering feilet";return f.code==="auth/email-already-in-use"?p="E-postadressen er allerede i bruk":f.code==="auth/weak-password"?p="Passordet må være minst 6 tegn":f.code==="auth/invalid-email"?p="Ugyldig e-postadresse":f.message&&(p=f.message),{success:!1,error:p}}}async function Nt(){try{return await xt(Ae),{success:!0}}catch(e){return console.error("Utlogging feilet:",e),{success:!1,error:"Kunne ikke logge ut"}}}function W(){return je}function Pe(){return oe}const $t=`
...
`;function Ft(e,i){const t=document.getElementById("gdpr-modal");t&&t.remove();const s=document.createElement("div");s.id="gdpr-modal",s.className="gdpr-modal",s.innerHTML=`
  ...
  `,document.body.appendChild(s);const a=s.querySelector(".gdpr-close-btn"),n=s.querySelector(".gdpr-btn-accept"),r=s.querySelector(".gdpr-btn-decline"),u=s.querySelector(".gdpr-modal-overlay"),m=()=>{s.remove()};a.addEventListener("click",()=>{m(),i&&i()}),u.addEventListener("click",()=>{m(),i&&i()}),r.addEventListener("click",()=>{m(),i&&i()}),n.addEventListener("click",()=>{m(),e&&e()}),document.body.style.overflow="hidden";const b=m,f=()=>{document.body.style.overflow="",b()};a.onclick=()=>{f(),i&&i()},u.onclick=()=>{f(),i&&i()},r.onclick=()=>{f(),i&&i()},n.onclick=()=>{f(),e&&e()}}function At(){const e=document.createElement("div");return e.className="gdpr-checkbox-container",e.innerHTML=`
  ...
  `,setTimeout(()=>{const i=e.querySelector("#gdpr-open-modal");i&&i.addEventListener("click",t=>{t.preventDefault(),Ft(()=>{const s=document.getElementById("gdpr-consent-checkbox");s&&(s.checked=!0)},()=>{const s=document.getElementById("gdpr-consent-checkbox");s&&(s.checked=!1)})})},0),e}function Rt(){const e=document.getElementById("gdpr-consent-checkbox");return!e||!e.checked?{valid:!1,error:"Du må godta personvernerklæringen for å registrere deg"}:{valid:!0}}function Bt(e,i){e.innerHTML=`
    <style>
      * {
  ...
  `;const t={no:{subtitle:"Analyse. Prognose. Resultat.",loginEmailLabel:"E-post",loginEmailPlaceholder:"navn@epost.no",loginPasswordLabel:"Passord",loginPasswordPlaceholder:"Passord",login:"Logg inn",or:"eller",showRegister:"Registrer ny bruker",registerFirstNameLabel:"Fornavn",registerFirstNamePlaceholder:"Fornavn",registerLastNameLabel:"Etternavn",registerLastNamePlaceholder:"Etternavn",registerEmailLabel:"E-post",registerEmailPlaceholder:"navn@epost.no",registerEmailConfirmLabel:"Bekreft e-post",registerEmailConfirmPlaceholder:"Gjenta e-post",registerPasswordLabel:"Passord",registerPasswordPlaceholder:"Passord",registerPasswordConfirmLabel:"Bekreft passord",registerPasswordConfirmPlaceholder:"Gjenta passord",registerDivisionLabel:"Divisjon",registerCategoryLabel:"Kategori",registerPowerFactorLabel:"Power Factor",registerRegionLabel:"Region",registerClubLabel:"Klubb",registerCodeLabel:"Invitasjonskode",registerCodePlaceholder:"Invitasjonskode",register:"Opprett bruker",cancel:"Avbryt",emailMismatch:"E-postadressene er ikke like",passwordMismatch:"Passordene er ikke like",missingFields:"Fyll ut alle påkrevde feltene",missingName:"Du må skrive inn fornavn og etternavn",missingDivision:"Du må velge divisjon",weakPassword:"Passordet er for svakt",strengthEmpty:"",strengthVeryWeak:"Passordstyrke: Svært svak",strengthWeak:"Passordstyrke: Svak",strengthMedium:"Passordstyrke: Middels",strengthStrong:"Passordstyrke: Sterk",strengthVeryStrong:"Passordstyrke: Svært sterk",gdprRequired:"Du må godta personvernerklæringen for å registrere deg"},en:{subtitle:"Analyze. Predict. Perform.",loginEmailLabel:"Email",loginEmailPlaceholder:"name@email.com",loginPasswordLabel:"Password",loginPasswordPlaceholder:"Password",login:"Log in",or:"or",showRegister:"Create new user",registerFirstNameLabel:"First Name",registerFirstNamePlaceholder:"First name",registerLastNameLabel:"Last Name",registerLastNamePlaceholder:"Last name",registerEmailLabel:"Email",registerEmailPlaceholder:"name@email.com",registerEmailConfirmLabel:"Confirm email",registerEmailConfirmPlaceholder:"Repeat email",registerPasswordLabel:"Password",registerPasswordPlaceholder:"Password",registerPasswordConfirmLabel:"Confirm password",registerPasswordConfirmPlaceholder:"Repeat password",registerDivisionLabel:"Division",registerCategoryLabel:"Category",registerPowerFactorLabel:"Power Factor",registerRegionLabel:"Region",registerClubLabel:"Club",registerCodeLabel:"Invite code",registerCodePlaceholder:"Invite code",register:"Create account",cancel:"Cancel",emailMismatch:"The email addresses do not match",passwordMismatch:"Passwords do not match",missingFields:"Please fill in all required fields",missingName:"Please enter your first and last name",missingDivision:"Please select a division",weakPassword:"The password is too weak",strengthEmpty:"",strengthVeryWeak:"Password strength: Very weak",strengthWeak:"Password strength: Weak",strengthMedium:"Password strength: Medium",strengthStrong:"Password strength: Strong",strengthVeryStrong:"Password strength: Very strong",gdprRequired:"You must accept the privacy policy to register"}};let s="no",a="minor";const n=document.getElementById("error"),r=document.getElementById("loginSection"),u=document.getElementById("registerSection"),m=document.getElementById("showRegisterBtn"),b=document.getElementById("cancelRegisterBtn"),f=document.getElementById("loginBtn"),p=document.getElementById("registerBtn"),h=document.getElementById("langNo"),E=document.getElementById("langEn"),k=document.getElementById("registerPassword"),P=document.getElementById("passwordStrengthBar"),C=document.getElementById("passwordStrengthText"),L=document.getElementById("pfMinor"),I=document.getElementById("pfMajor");L.onclick=()=>{a="minor",L.classList.add("selected"),I.classList.remove("selected")},I.onclick=()=>{a="major",I.classList.add("selected"),L.classList.remove("selected")};function B(w){let y=0;return w?(w.length>=8&&(y+=1),w.length>=12&&(y+=1),/[a-z]/.test(w)&&/[A-Z]/.test(w)&&(y+=1),/\d/.test(w)&&(y+=1),/[^A-Za-z0-9]/.test(w)&&(y+=1),y<=1?{score:y,width:"20%",labelKey:"strengthVeryWeak",color:"#ff6b6b"}:y===2?{score:y,width:"40%",labelKey:"strengthWeak",color:"#ff9f43"}:y===3?{score:y,width:"60%",labelKey:"strengthMedium",color:"#feca57"}:y===4?{score:y,width:"80%",labelKey:"strengthStrong",color:"#1dd1a1"}:{score:y,width:"100%",labelKey:"strengthVeryStrong",color:"#10ac84"}):{score:0,width:"0%",labelKey:"strengthEmpty",color:"#ff6b6b"}}function D(){const w=t[s],y=k.value,H=B(y);P.style.width=H.width,P.style.background=H.color,C.innerText=w[H.labelKey]}function _(w){s=w;const y=t[w];document.getElementById("brandSubtitle").innerText=y.subtitle,document.getElementById("loginEmailLabel").innerText=y.loginEmailLabel,document.getElementById("loginEmail").placeholder=y.loginEmailPlaceholder,document.getElementById("loginPasswordLabel").innerText=y.loginPasswordLabel,document.getElementById("loginPassword").placeholder=y.loginPasswordPlaceholder,document.getElementById("loginBtn").innerText=y.login,document.getElementById("separatorText").innerText=y.or,document.getElementById("showRegisterBtn").innerText=y.showRegister,document.getElementById("registerFirstNameLabel").innerText=y.registerFirstNameLabel,document.getElementById("registerFirstName").placeholder=y.registerFirstNamePlaceholder,document.getElementById("registerLastNameLabel").innerText=y.registerLastNameLabel,document.getElementById("registerLastName").placeholder=y.registerLastNamePlaceholder,document.getElementById("registerEmailLabel").innerText=y.registerEmailLabel,document.getElementById("registerEmail").placeholder=y.registerEmailPlaceholder,document.getElementById("registerEmailConfirmLabel").innerText=y.registerEmailConfirmLabel,document.getElementById("registerEmailConfirm").placeholder=y.registerEmailConfirmPlaceholder,document.getElementById("registerPasswordLabel").innerText=y.registerPasswordLabel,document.getElementById("registerPassword").placeholder=y.registerPasswordPlaceholder,document.getElementById("registerPasswordConfirmLabel").innerText=y.registerPasswordConfirmLabel,document.getElementById("registerPasswordConfirm").placeholder=y.registerPasswordConfirmPlaceholder,document.getElementById("registerDivisionLabel").innerText=y.registerDivisionLabel,document.getElementById("registerCategoryLabel").innerText=y.registerCategoryLabel,document.getElementById("registerPowerFactorLabel").innerText=y.registerPowerFactorLabel,document.getElementById("registerRegionLabel").innerText=y.registerRegionLabel,document.getElementById("registerClubLabel").innerText=y.registerClubLabel,document.getElementById("registerCodeLabel").innerText=y.registerCodeLabel,document.getElementById("registerCode").placeholder=y.registerCodePlaceholder,document.getElementById("registerBtn").innerText=y.register,document.getElementById("cancelRegisterBtn").innerText=y.cancel,h.classList.toggle("active",w==="no"),E.classList.toggle("active",w==="en"),D()}function K(){r.classList.remove("active"),u.classList.add("active"),n.innerText="";const w=document.getElementById("gdprCheckboxContainer");if(w&&!w.hasChildNodes()){const y=At();w.appendChild(y)}}function j(){u.classList.remove("active"),r.classList.add("active"),n.innerText=""}h.onclick=()=>_("no"),E.onclick=()=>_("en"),m.onclick=K,b.onclick=j,k.oninput=D,f.onclick=async()=>{n.innerText="";const w=document.getElementById("loginEmail").value.trim(),y=document.getElementById("loginPassword").value,H=await Ct(w,y);H.success?i():n.innerText=H.error},p.onclick=async()=>{n.innerText="";const w=t[s],y=document.getElementById("registerFirstName").value.trim(),H=document.getElementById("registerLastName").value.trim(),Y=document.getElementById("registerEmail").value.trim(),ce=document.getElementById("registerEmailConfirm").value.trim(),X=document.getElementById("registerPassword").value,pe=document.getElementById("registerPasswordConfirm").value,se=document.getElementById("registerDivision").value,ae=document.getElementById("registerCategory").value,T=document.getElementById("registerRegion").value,M=document.getElementById("registerClub").value.trim(),c=document.getElementById("registerCode").value.trim();if(!y||!H){n.innerText=w.missingName;return}if(!Y||!ce||!X||!pe||!c){n.innerText=w.missingFields;return}if(!se){n.innerText=w.missingDivision;return}if(Y!==ce){n.innerText=w.emailMismatch;return}if(X!==pe){n.innerText=w.passwordMismatch;return}if(B(X).score<=1){n.innerText=w.weakPassword;return}if(!Rt().valid){n.innerText=w.gdprRequired;return}const v=await _t(Y,X,c,y,H,se,ae,a,T,M);v.success?i():n.innerText=v.error},_("no"),D()}async function Dt(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{return await de(U(O,"users",i.uid),{...e,updatedAt:Me()}),{success:!0}}catch(t){return console.error("Save profile error:",t),{success:!1,error:t.message}}}async function Ot(){const e=W();if(!e)return null;try{const i=await be(U(O,"users",e.uid));return i.exists()?{uid:e.uid,...i.data()}:null}catch(i){return console.error("Get profile error:",i),null}}async function jt(e){try{const i=await be(U(O,"users",e));return i.exists()?{uid:e,...i.data()}:null}catch(i){return console.error("Get user by ID error:",i),null}}async function Ut(){const e=U(O,"counters","matchId");try{const i=await be(e);if(!i.exists())return await Ne(e,{value:1}),1;const s=i.data().value+1;return await de(e,{value:s}),s}catch(i){throw console.error("Error getting next match ID:",i),i}}async function Ht(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{const t=await Ut(),s={id:t,...e,searchable:e.searchable!==!1,ownerId:i.uid,participants:[i.uid],createdAt:Me(),updatedAt:Me()};return await Ne(U(O,"matches",t.toString()),s),{success:!0,matchId:t}}catch(t){return console.error("Create match error:",t),{success:!1,error:t.message}}}async function Ee(e,i){if(!W())return{success:!1,error:"Not authenticated"};try{return await de(U(O,"matches",e.toString()),{...i,updatedAt:Me()}),{success:!0}}catch(s){return console.error("Update match error:",s),{success:!1,error:s.message}}}async function zt(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{const t=await be(U(O,"matches",e.toString()));return t.exists()?t.data().ownerId!==i.uid?{success:!1,error:"Only the creator can delete this match"}:(await Lt(U(O,"matches",e.toString())),{success:!0}):{success:!1,error:"Match not found"}}catch(t){return console.error("Delete match error:",t),{success:!1,error:t.message}}}async function Gt(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{const t=await be(U(O,"matches",e.toString()));if(!t.exists())return{success:!1,error:"Match not found"};const s={id:t.id,...t.data()};return s.searchable?(s.participants.includes(i.uid)||await de(U(O,"matches",e.toString()),{participants:it(i.uid)}),{success:!0,match:s}):{success:!1,error:"Match is not searchable"}}catch(t){return console.error("Search match error:",t),{success:!1,error:t.message}}}async function Kt(){const e=W();if(!e)return[];try{const i=$e(Le(O,"matches"),Fe("participants","array-contains",e.uid)),t=await He(i),s=[];return t.forEach(a=>{s.push({id:a.id,...a.data()})}),s.sort((a,n)=>{var m,b;const r=a.date||((m=a.createdAt)==null?void 0:m.toDate())||new Date(0);return(n.date||((b=n.createdAt)==null?void 0:b.toDate())||new Date(0))-r}),s}catch(i){return console.error("Get user matches error:",i),[]}}function Vt(e){const i=W();if(!i)return()=>{};const t=$e(Le(O,"matches"),Fe("participants","array-contains",i.uid));return ze(t,a=>{const n=[];a.forEach(r=>{n.push({id:r.id,...r.data()})}),n.sort((r,u)=>{var f,p;const m=r.date||((f=r.createdAt)==null?void 0:f.toDate())||new Date(0);return(u.date||((p=u.createdAt)==null?void 0:p.toDate())||new Date(0))-m}),e(n)},a=>{console.error("Listen to matches error:",a)})}function qt(e,i){return ze(U(O,"matches",e.toString()),s=>{s.exists()?i({id:s.id,...s.data()}):i(null)},s=>{console.error("Listen to match error:",s)})}async function Ge(e,i){const t=W();if(!t)return{success:!1,error:"Not authenticated"};try{console.log("🔍 Søker etter bruker med email:",e);const s=$e(Le(O,"users"),Fe("email","==",e)),a=await He(s);if(a.empty)return console.error("❌ Bruker ikke funnet:",e),{success:!1,error:"Bruker ikke funnet"};const n=a.docs[0],r=n.id;return console.log("✅ Bruker funnet:",r,n.data()),console.log("📨 Sender invitasjon..."),await Ne(U(O,"users",r,"invitations",i.matchId.toString()),{matchId:i.matchId,matchName:i.matchName,invitedBy:t.email,invitedByUid:t.uid,timestamp:new Date().toISOString(),status:"pending"}),console.log("✅ Invitasjon sendt!"),{success:!0}}catch(s){return console.error("❌ Send invitation error:",s),{success:!1,error:s.message}}}async function Ke(e){const i=W();if(!i)return[];try{const t=e.toLowerCase().trim();if(t.length===0)return[];console.log("🔍 Søker etter brukere:",t);const s=await He(Le(O,"users")),a=[];return s.forEach(n=>{const r=n.data(),u=`${r.firstName||""} ${r.lastName||""}`.toLowerCase(),m=(r.email||"").toLowerCase();n.id!==i.uid&&(u.includes(t)||m.includes(t))&&a.push({uid:n.id,email:r.email,firstName:r.firstName||"",lastName:r.lastName||"",displayName:`${r.firstName||""} ${r.lastName||""}`.trim()})}),console.log(`✅ Fant ${a.length} brukere`),a}catch(t){return console.error("❌ Search users error:",t),[]}}async function Wt(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{return await de(U(O,"matches",e.toString()),{participants:it(i.uid)}),await de(U(O,"users",i.uid,"invitations",e.toString()),{status:"accepted"}),{success:!0}}catch(t){return console.error("Accept invitation error:",t),{success:!1,error:t.message}}}async function Jt(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{return await de(U(O,"users",i.uid,"invitations",e.toString()),{status:"declined"}),{success:!0}}catch(t){return console.error("Decline invitation error:",t),{success:!1,error:t.message}}}function Yt(e){const i=W();if(!i)return()=>{};const t=Le(O,"users",i.uid,"invitations"),s=$e(t,Fe("status","==","pending"));return ze(s,a=>{const n=[];a.forEach(r=>{n.push({id:r.id,...r.data()})}),e(n)})}function Zt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Qt={exports:{}};(function(e){var i=function(t){var s=Object.prototype,a=s.hasOwnProperty,n=Object.defineProperty||function(c,l,v){c[l]=v.value},r,u=typeof Symbol=="function"?Symbol:{},m=u.iterator||"@@iterator",b=u.asyncIterator||"@@asyncIterator",f=u.toStringTag||"@@toStringTag";function p(c,l,v){return Object.defineProperty(c,l,{value:v,enumerable:!0,configurable:!0,writable:!0}),c[l]}try{p({},"")}catch{p=function(l,v,S){return l[v]=S}}function h(c,l,v,S){var x=l&&l.prototype instanceof B?l:B,N=Object.create(x.prototype),z=new ae(S||[]);return n(N,"_invoke",{value:ce(c,v,z)}),N}t.wrap=h;function E(c,l,v){try{return{type:"normal",arg:c.call(l,v)}}catch(S){return{type:"throw",arg:S}}}var k="suspendedStart",P="suspendedYield",C="executing",L="completed",I={};function B(){}function D(){}function _(){}var K={};p(K,m,function(){return this});var j=Object.getPrototypeOf,w=j&&j(j(T([])));w&&w!==s&&a.call(w,m)&&(K=w);var y=_.prototype=B.prototype=Object.create(K);D.prototype=_,n(y,"constructor",{value:_,configurable:!0}),n(_,"constructor",{value:D,configurable:!0}),D.displayName=p(_,f,"GeneratorFunction");function H(c){["next","throw","return"].forEach(function(l){p(c,l,function(v){return this._invoke(l,v)})})}t.isGeneratorFunction=function(c){var l=typeof c=="function"&&c.constructor;return l?l===D||(l.displayName||l.name)==="GeneratorFunction":!1},t.mark=function(c){return Object.setPrototypeOf?Object.setPrototypeOf(c,_):(c.__proto__=_,p(c,f,"GeneratorFunction")),c.prototype=Object.create(y),c},t.awrap=function(c){return{__await:c}};function Y(c,l){function v(N,z,V,J){var q=E(c[N],c,z);if(q.type==="throw")J(q.arg);else{var De=q.arg,we=De.value;return we&&typeof we=="object"&&a.call(we,"__await")?l.resolve(we.__await).then(function(ne){v("next",ne,V,J)},function(ne){v("throw",ne,V,J)}):l.resolve(we).then(function(ne){De.value=ne,V(De)},function(ne){return v("throw",ne,V,J)})}}var S;function x(N,z){function V(){return new l(function(J,q){v(N,z,J,q)})}return S=S?S.then(V,V):V()}n(this,"_invoke",{value:x})}H(Y.prototype),p(Y.prototype,b,function(){return this}),t.AsyncIterator=Y,t.async=function(c,l,v,S,x){x===void 0&&(x=Promise);var N=new Y(h(c,l,v,S),x);return t.isGeneratorFunction(l)?N:N.next().then(function(z){return z.done?z.value:N.next()})};function ce(c,l,v){var S=k;return function(N,z){if(S===C)throw new Error("Generator is already running");if(S===L){if(N==="throw")throw z;return M()}for(v.method=N,v.arg=z;;){var V=v.delegate;if(V){var J=X(V,v);if(J){if(J===I)continue;return J}}if(v.method==="next")v.sent=v._sent=v.arg;else if(v.method==="throw"){if(S===k)throw S=L,v.arg;v.dispatchException(v.arg)}else v.method==="return"&&v.abrupt("return",v.arg);S=C;var q=E(c,l,v);if(q.type==="normal"){if(S=v.done?L:P,q.arg===I)continue;return{value:q.arg,done:v.done}}else q.type==="throw"&&(S=L,v.method="throw",v.arg=q.arg)}}}function X(c,l){var v=l.method,S=c.iterator[v];if(S===r)return l.delegate=null,v==="throw"&&c.iterator.return&&(l.method="return",l.arg=r,X(c,l),l.method==="throw")||v!=="return"&&(l.method="throw",l.arg=new TypeError("The iterator does not provide a '"+v+"' method")),I;var x=E(S,c.iterator,l.arg);if(x.type==="throw")return l.method="throw",l.arg=x.arg,l.delegate=null,I;var N=x.arg;if(!N)return l.method="throw",l.arg=new TypeError("iterator result is not an object"),l.delegate=null,I;if(N.done)l[c.resultName]=N.value,l.next=c.nextLoc,l.method!=="return"&&(l.method="next",l.arg=r);else return N;return l.delegate=null,I}H(y),p(y,f,"Generator"),p(y,m,function(){return this}),p(y,"toString",function(){return"[object Generator]"});function pe(c){var l={tryLoc:c[0]};1 in c&&(l.catchLoc=c[1]),2 in c&&(l.finallyLoc=c[2],l.afterLoc=c[3]),this.tryEntries.push(l)}function se(c){var l=c.completion||{};l.type="normal",delete l.arg,c.completion=l}function ae(c){this.tryEntries=[{tryLoc:"root"}],c.forEach(pe,this),this.reset(!0)}t.keys=function(c){var l=Object(c),v=[];for(var S in l)v.push(S);return v.reverse(),function x(){for(;v.length;){var N=v.pop();if(N in l)return x.value=N,x.done=!1,x}return x.done=!0,x}};function T(c){if(c){var l=c[m];if(l)return l.call(c);if(typeof c.next=="function")return c;if(!isNaN(c.length)){var v=-1,S=function x(){for(;++v<c.length;)if(a.call(c,v))return x.value=c[v],x.done=!1,x;return x.value=r,x.done=!0,x};return S.next=S}}return{next:M}}t.values=T;function M(){return{value:r,done:!0}}return ae.prototype={constructor:ae,reset:function(c){if(this.prev=0,this.next=0,this.sent=this._sent=r,this.done=!1,this.delegate=null,this.method="next",this.arg=r,this.tryEntries.forEach(se),!c)for(var l in this)l.charAt(0)==="t"&&a.call(this,l)&&!isNaN(+l.slice(1))&&(this[l]=r)},stop:function(){this.done=!0;var c=this.tryEntries[0],l=c.completion;if(l.type==="throw")throw l.arg;return this.rval},dispatchException:function(c){if(this.done)throw c;var l=this;function v(J,q){return N.type="throw",N.arg=c,l.next=J,q&&(l.method="next",l.arg=r),!!q}for(var S=this.tryEntries.length-1;S>=0;--S){var x=this.tryEntries[S],N=x.completion;if(x.tryLoc==="root")return v("end");if(x.tryLoc<=this.prev){var z=a.call(x,"catchLoc"),V=a.call(x,"finallyLoc");if(z&&V){if(this.prev<x.catchLoc)return v(x.catchLoc,!0);if(this.prev<x.finallyLoc)return v(x.finallyLoc)}else if(z){if(this.prev<x.catchLoc)return v(x.catchLoc,!0)}else if(V){if(this.prev<x.finallyLoc)return v(x.finallyLoc)}else throw new Error("try statement without catch or finally")}}},abrupt:function(c,l){for(var v=this.tryEntries.length-1;v>=0;--v){var S=this.tryEntries[v];if(S.tryLoc<=this.prev&&a.call(S,"finallyLoc")&&this.prev<S.finallyLoc){var x=S;break}}x&&(c==="break"||c==="continue")&&x.tryLoc<=l&&l<=x.finallyLoc&&(x=null);var N=x?x.completion:{};return N.type=c,N.arg=l,x?(this.method="next",this.next=x.finallyLoc,I):this.complete(N)},complete:function(c,l){if(c.type==="throw")throw c.arg;return c.type==="break"||c.type==="continue"?this.next=c.arg:c.type==="return"?(this.rval=this.arg=c.arg,this.method="return",this.next="end"):c.type==="normal"&&l&&(this.next=l),I},finish:function(c){for(var l=this.tryEntries.length-1;l>=0;--l){var v=this.tryEntries[l];if(v.finallyLoc===c)return this.complete(v.completion,v.afterLoc),se(v),I}},catch:function(c){for(var l=this.tryEntries.length-1;l>=0;--l){var v=this.tryEntries[l];if(v.tryLoc===c){var S=v.completion;if(S.type==="throw"){var x=S.arg;se(v)}return x}}throw new Error("illegal catch attempt")},delegateYield:function(c,l,v){return this.delegate={iterator:T(c),resultName:l,nextLoc:v},this.method==="next"&&(this.arg=r),I}},t}(e.exports);try{regeneratorRuntime=i}catch{typeof globalThis=="object"?globalThis.regeneratorRuntime=i:Function("r","regeneratorRuntime = r")(i)}})(Qt);var Ve=(e,i)=>`${e}-${i}-${Math.random().toString(16).slice(3,8)}`;const Xt=Ve;let Ye=0;var at=({id:e,action:i,payload:t={}})=>{let s=e;return typeof s>"u"&&(s=Xt("Job",Ye),Ye+=1),{id:s,action:i,payload:t}},ye={};let qe=!1;ye.logging=qe;ye.setLogging=e=>{qe=e};ye.log=(...e)=>qe?console.log.apply(void 0,e):null;const ei=at,{log:Te}=ye,ti=Ve;let Ze=0;var ii=()=>{const e=ti("Scheduler",Ze),i={},t={};let s=[];Ze+=1;const a=()=>s.length,n=()=>Object.keys(i).length,r=()=>{if(s.length!==0){const p=Object.keys(i);for(let h=0;h<p.length;h+=1)if(typeof t[p[h]]>"u"){s[0](i[p[h]]);break}}},u=(p,h)=>new Promise((E,k)=>{const P=ei({action:p,payload:h});s.push(async C=>{s.shift(),t[C.id]=P;try{E(await C[p].apply(void 0,[...h,P.id]))}catch(L){k(L)}finally{delete t[C.id],r()}}),Te(`[${e}]: Add ${P.id} to JobQueue`),Te(`[${e}]: JobQueue length=${s.length}`),r()});return{addWorker:p=>(i[p.id]=p,Te(`[${e}]: Add ${p.id}`),Te(`[${e}]: Number of workers=${n()}`),r(),p.id),addJob:async(p,...h)=>{if(n()===0)throw Error(`[${e}]: You need to have at least one worker before adding jobs`);return u(p,h)},terminate:async()=>{Object.keys(i).forEach(async p=>{await i[p].terminate()}),s=[]},getQueueLen:a,getNumWorkers:n}};function si(e){throw new Error('Could not dynamically require "'+e+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var ai=e=>{const i={};return typeof WorkerGlobalScope<"u"?i.type="webworker":typeof document=="object"?i.type="browser":typeof process=="object"&&typeof si=="function"&&(i.type="node"),typeof e>"u"?i:i[e]};const ni=ai("type")==="browser",ri=ni?e=>new URL(e,window.location.href).href:e=>e;var oi=e=>{const i={...e};return["corePath","workerPath","langPath"].forEach(t=>{e[t]&&(i[t]=ri(i[t]))}),i},nt={TESSERACT_ONLY:0,LSTM_ONLY:1,TESSERACT_LSTM_COMBINED:2,DEFAULT:3};const li="7.0.0",di={version:li};var ci={workerBlobURL:!0,logger:()=>{}};const pi=di.version,ui=ci;var gi={...ui,workerPath:`https://cdn.jsdelivr.net/npm/tesseract.js@v${pi}/dist/worker.min.js`},vi=({workerPath:e,workerBlobURL:i})=>{let t;if(Blob&&URL&&i){const s=new Blob([`importScripts("${e}");`],{type:"application/javascript"});t=new Worker(URL.createObjectURL(s))}else t=new Worker(e);return t},mi=e=>{e.terminate()},hi=(e,i)=>{e.onmessage=({data:t})=>{i(t)}},fi=async(e,i)=>{e.postMessage(i)};const Oe=e=>new Promise((i,t)=>{const s=new FileReader;s.onload=()=>{i(s.result)},s.onerror=({target:{error:{code:a}}})=>{t(Error(`File could not be read! Code=${a}`))},s.readAsArrayBuffer(e)}),Ue=async e=>{let i=e;if(typeof e>"u")return"undefined";if(typeof e=="string")/data:image\/([a-zA-Z]*);base64,([^"]*)/.test(e)?i=atob(e.split(",")[1]).split("").map(t=>t.charCodeAt(0)):i=await(await fetch(e)).arrayBuffer();else if(typeof HTMLElement<"u"&&e instanceof HTMLElement)e.tagName==="IMG"&&(i=await Ue(e.src)),e.tagName==="VIDEO"&&(i=await Ue(e.poster)),e.tagName==="CANVAS"&&await new Promise(t=>{e.toBlob(async s=>{i=await Oe(s),t()})});else if(typeof OffscreenCanvas<"u"&&e instanceof OffscreenCanvas){const t=await e.convertToBlob();i=await Oe(t)}else(e instanceof File||e instanceof Blob)&&(i=await Oe(e));return new Uint8Array(i)};var bi=Ue;const yi=gi,wi=vi,ki=mi,xi=hi,Si=fi,Li=bi;var Pi={defaultOptions:yi,spawnWorker:wi,terminateWorker:ki,onMessage:xi,send:Si,loadImage:Li};const Ei=oi,Z=at,{log:Qe}=ye,Ti=Ve,re=nt,{defaultOptions:Ii,spawnWorker:Mi,terminateWorker:Ci,onMessage:_i,loadImage:Xe,send:Ni}=Pi;let et=0;var rt=async(e="eng",i=re.LSTM_ONLY,t={},s={})=>{const a=Ti("Worker",et),{logger:n,errorHandler:r,...u}=Ei({...Ii,...t}),m={},b=typeof e=="string"?e.split("+"):e;let f=i,p=s;const h=[re.DEFAULT,re.LSTM_ONLY].includes(i)&&!u.legacyCore;let E,k;const P=new Promise((T,M)=>{k=T,E=M}),C=T=>{E(T.message)};let L=Mi(u);L.onerror=C,et+=1;const I=({id:T,action:M,payload:c})=>new Promise((l,v)=>{Qe(`[${a}]: Start ${T}, action=${M}`);const S=`${M}-${T}`;m[S]={resolve:l,reject:v},Ni(L,{workerId:a,jobId:T,action:M,payload:c})}),B=()=>console.warn("`load` is depreciated and should be removed from code (workers now come pre-loaded)"),D=T=>I(Z({id:T,action:"load",payload:{options:{lstmOnly:h,corePath:u.corePath,logging:u.logging}}})),_=(T,M,c)=>I(Z({id:c,action:"FS",payload:{method:"writeFile",args:[T,M]}})),K=(T,M)=>I(Z({id:M,action:"FS",payload:{method:"readFile",args:[T,{encoding:"utf8"}]}})),j=(T,M)=>I(Z({id:M,action:"FS",payload:{method:"unlink",args:[T]}})),w=(T,M,c)=>I(Z({id:c,action:"FS",payload:{method:T,args:M}})),y=(T,M)=>I(Z({id:M,action:"loadLanguage",payload:{langs:T,options:{langPath:u.langPath,dataPath:u.dataPath,cachePath:u.cachePath,cacheMethod:u.cacheMethod,gzip:u.gzip,lstmOnly:[re.DEFAULT,re.LSTM_ONLY].includes(f)&&!u.legacyLang}}})),H=(T,M,c,l)=>I(Z({id:l,action:"initialize",payload:{langs:T,oem:M,config:c}})),Y=(T="eng",M,c,l)=>{if(h&&[re.TESSERACT_ONLY,re.TESSERACT_LSTM_COMBINED].includes(M))throw Error("Legacy model requested but code missing.");const v=M||f;f=v;const S=c||p;p=S;const N=(typeof T=="string"?T.split("+"):T).filter(z=>!b.includes(z));return b.push(...N),N.length>0?y(N,l).then(()=>H(T,v,S,l)):H(T,v,S,l)},ce=(T={},M)=>I(Z({id:M,action:"setParameters",payload:{params:T}})),X=async(T,M={},c={text:!0},l)=>I(Z({id:l,action:"recognize",payload:{image:await Xe(T),options:M,output:c}})),pe=async(T,M)=>{if(h)throw Error("`worker.detect` requires Legacy model, which was not loaded.");return I(Z({id:M,action:"detect",payload:{image:await Xe(T)}}))},se=async()=>(L!==null&&(Ci(L),L=null),Promise.resolve());_i(L,({workerId:T,jobId:M,status:c,action:l,data:v})=>{const S=`${l}-${M}`;if(c==="resolve")Qe(`[${T}]: Complete ${M}`),m[S].resolve({jobId:M,data:v}),delete m[S];else if(c==="reject")if(m[S].reject(v),delete m[S],l==="load"&&E(v),r)r(v);else throw Error(v);else c==="progress"&&n({...v,userJobId:M})});const ae={id:a,worker:L,load:B,writeText:_,readText:K,removeFile:j,FS:w,reinitialize:Y,setParameters:ce,recognize:X,detect:pe,terminate:se};return D().then(()=>y(e)).then(()=>H(e,i,s)).then(()=>k(ae)).catch(()=>{}),P};const ot=rt,$i=async(e,i,t)=>{const s=await ot(i,1,t);return s.recognize(e).finally(async()=>{await s.terminate()})},Fi=async(e,i)=>{const t=await ot("osd",0,i);return t.detect(e).finally(async()=>{await t.terminate()})};var Ai={recognize:$i,detect:Fi},Ri={AFR:"afr",AMH:"amh",ARA:"ara",ASM:"asm",AZE:"aze",AZE_CYRL:"aze_cyrl",BEL:"bel",BEN:"ben",BOD:"bod",BOS:"bos",BUL:"bul",CAT:"cat",CEB:"ceb",CES:"ces",CHI_SIM:"chi_sim",CHI_TRA:"chi_tra",CHR:"chr",CYM:"cym",DAN:"dan",DEU:"deu",DZO:"dzo",ELL:"ell",ENG:"eng",ENM:"enm",EPO:"epo",EST:"est",EUS:"eus",FAS:"fas",FIN:"fin",FRA:"fra",FRK:"frk",FRM:"frm",GLE:"gle",GLG:"glg",GRC:"grc",GUJ:"guj",HAT:"hat",HEB:"heb",HIN:"hin",HRV:"hrv",HUN:"hun",IKU:"iku",IND:"ind",ISL:"isl",ITA:"ita",ITA_OLD:"ita_old",JAV:"jav",JPN:"jpn",KAN:"kan",KAT:"kat",KAT_OLD:"kat_old",KAZ:"kaz",KHM:"khm",KIR:"kir",KOR:"kor",KUR:"kur",LAO:"lao",LAT:"lat",LAV:"lav",LIT:"lit",MAL:"mal",MAR:"mar",MKD:"mkd",MLT:"mlt",MSA:"msa",MYA:"mya",NEP:"nep",NLD:"nld",NOR:"nor",ORI:"ori",PAN:"pan",POL:"pol",POR:"por",PUS:"pus",RON:"ron",RUS:"rus",SAN:"san",SIN:"sin",SLK:"slk",SLV:"slv",SPA:"spa",SPA_OLD:"spa_old",SQI:"sqi",SRP:"srp",SRP_LATN:"srp_latn",SWA:"swa",SWE:"swe",SYR:"syr",TAM:"tam",TEL:"tel",TGK:"tgk",TGL:"tgl",THA:"tha",TIR:"tir",TUR:"tur",UIG:"uig",UKR:"ukr",URD:"urd",UZB:"uzb",UZB_CYRL:"uzb_cyrl",VIE:"vie",YID:"yid"},Bi={OSD_ONLY:"0",AUTO_OSD:"1",AUTO_ONLY:"2",AUTO:"3",SINGLE_COLUMN:"4",SINGLE_BLOCK_VERT_TEXT:"5",SINGLE_BLOCK:"6",SINGLE_LINE:"7",SINGLE_WORD:"8",CIRCLE_WORD:"9",SINGLE_CHAR:"10",SPARSE_TEXT:"11",SPARSE_TEXT_OSD:"12",RAW_LINE:"13"};const Di=ii,Oi=rt,ji=Ai,Ui=Ri,Hi=nt,zi=Bi,{setLogging:Gi}=ye;var Ki={languages:Ui,OEM:Hi,PSM:zi,createScheduler:Di,createWorker:Oi,setLogging:Gi,...ji};const Vi=Zt(Ki);let g,R=null,ue="all",$=[],ke=null,xe=null;const qi={no:{tracker:"INSIGHT",tagline:"Analyse. Prognose. Resultat.",home:"Hjem",matches:"Matcher",prognosis:"Prognose",results:"Live",profile:"Profil",leading:"LEDER",behind:"BAK",active:"Aktiv",no_match_selected:"Ingen match valgt",new_match:"Ny match",match_name:"Matchnavn",location:"Sted",date:"Dato",type:"Type",planned_stages:"Antall stages",save:"Lagre",cancel:"Avbryt",delete:"Slett",edit_profile:"Rediger profil",first_name:"Fornavn",last_name:"Etternavn",club:"Klubb",region:"Region",category:"Kategori",division:"Divisjon",power_factor:"Power Factor",draw_seconds:"Trekk (s)",reload_seconds:"Reload (s)",save_profile:"Lagre profil",logout:"Logg ut",matches_count:"Matcher",stages_count:"Stages",avg_hf:"Snitt HF",a_rate:"A-andel",shots:"Skudd",targets:"Skiver",steel:"Stål",move_seconds:"Beveg. (s)",calculate:"Beregn",add_shooter:"Legg til skytter",add_result:"Legg til resultat",save_shooter:"Lagre skytter",save_result:"Lagre resultat",match_types_trening:"Trening",match_types_level1:"Level 1",match_types_level2:"Level 2",match_types_level3:"Level 3",match_types_level4:"Level 4",match_types_level5:"Level 5",allow_search:"Tillat at andre kan finne denne matchen",search_match_placeholder:"Skriv inn match-ID (f.eks. 12345)",select_power_factor:"Velg Power Factor",stages_added_later:"Stages legges til senere",edit_match:"Rediger match",create_stage:"Opprett stage",edit_stage:"Rediger stage",stage_number:"Nummer",stage_name:"Navn",paper_targets:"Paper targets",poppers:"Poppers",plates:"Plates",no_shoots:"No-Shoots",bonus_paper_targets:"Bonus Paper targets",included:"Included",invite_user:"Invite user",invite:"Invite",search_user_email:"Search for user email",invitation_sent:"Invitation sent",invitations:"Invitations",accept:"Accept",decline:"Decline",invited_to_match:"You are invited to",no_invitations:"No invitations",invite_user:"Inviter bruker",invite:"Inviter",search_user_email:"Søk etter brukers e-post",invitation_sent:"Invitasjon sendt",invitations:"Invitasjoner",accept:"Aksepter",decline:"Avvis",invited_to_match:"Du er invitert til",no_invitations:"Ingen invitasjoner"},en:{tracker:"INSIGHT",tagline:"Analysis. Prognosis. Results.",home:"Home",matches:"Matches",prognosis:"Prognosis",results:"Live",profile:"Profile",leading:"LEADING",behind:"BEHIND",active:"Active",no_match_selected:"No match selected",new_match:"New Match",match_name:"Match Name",location:"Location",date:"Date",type:"Type",planned_stages:"Number of stages",save:"Save",cancel:"Cancel",delete:"Delete",edit_profile:"Edit Profile",first_name:"First Name",last_name:"Last Name",club:"Club",region:"Region",category:"Category",division:"Division",power_factor:"Power Factor",draw_seconds:"Draw (s)",reload_seconds:"Reload (s)",save_profile:"Save Profile",logout:"Log Out",matches_count:"Matches",stages_count:"Stages",avg_hf:"Avg HF",a_rate:"A-rate",shots:"Shots",targets:"Targets",steel:"Steel",move_seconds:"Move (s)",calculate:"Calculate",add_shooter:"Add Shooter",add_result:"Add Result",save_shooter:"Save Shooter",save_result:"Save Result",match_types_trening:"Training",match_types_level1:"Level 1",match_types_level2:"Level 2",match_types_level3:"Level 3",match_types_level4:"Level 4",match_types_level5:"Level 5",allow_search:"Allow others to find this match",search_match_placeholder:"Enter match ID (e.g. 12345)",select_power_factor:"Select Power Factor",stages_added_later:"Stages will be added later"}};let lt="no";function d(e){return qi[lt][e]||e}const tt={major:{A:5,C:4,D:2,miss:-10,ns:-10,proc:-10},minor:{A:5,C:3,D:1,miss:-10,ns:-10,proc:-10}},Wi={Standard:{minor:21,major:21},Open:{minor:29,major:29},Production:{minor:15,major:15},"Production Optics":{minor:15,major:15},"Production Optics Carbine":{minor:15,major:15},Classic:{minor:10,major:8},Revolver:{minor:8,major:6},"Pistol Caliber Carbine":{minor:30,major:30},"Pistol Caliber Carbine Optics":{minor:30,major:30},Optics:{minor:21,major:21}},Ji=["Standard","Open","Production","Production Optics","Production Optics Carbine","Classic","Revolver","Pistol Caliber Carbine","Pistol Caliber Carbine Optics"],Yi={Standard:["minor","major"],Open:["minor","major"],Production:["minor"],"Production Optics":["minor"],"Production Optics Carbine":["minor"],Classic:["minor","major"],Revolver:["minor","major"],"Pistol Caliber Carbine":["minor","major"],"Pistol Caliber Carbine Optics":["minor","major"]},Zi=["—","Junior","Senior","Super Senior","Lady","Lady Junior","Lady Senior"],Qi=["Norge","Sverige","Danmark","Finland","Tyskland","Storbritannia","USA","Annet"];function Xi(e,i){const t=Wi[e];return t&&(t[i]||t.minor)||15}function Se(e,i,t){return Math.max(0,Math.ceil(e/Xi(i,t))-1)}function dt(){const e=$.find(k=>k.id==R);if(!e||!e.stages||e.stages.length===0)return null;const i=e.stages.filter(k=>k.time&&k.pts);if(i.length===0)return null;const t=g.division||"Classic",s=g.powerFactor||"minor",a=g.draw||1.42,n=g.reloadTime||1.8;let r=0,u=0,m=0,b=0,f=0,p=0;for(const k of i){const P=(k.paperTargets||0)*2+(k.poppers||0)+(k.plates||0);if(P===0)continue;const C=Se(P,t,s),L=k.time-a-C*n;L>0&&(r+=P,u+=L,m+=k.a||0,b+=k.c||0,f+=k.d||0,p+=k.miss||0)}if(r===0)return null;const h=u/r,E=m+b+f+p;return{avgSplit:h,completedStages:i.length,totalStages:e.stages.length,aPercent:E>0?m/E:0,cPercent:E>0?b/E:0,dPercent:E>0?f/E:0,missPercent:E>0?p/E:0}}function ge(e){return e.charAt(0).toUpperCase()+e.slice(1)}function ct(e){if(!e)return"";try{const i=lt==="no"?"nb-NO":"en-US";return new Date(e).toLocaleDateString(i,{day:"numeric",month:"short",year:"numeric"})}catch{return e}}function o(e){return document.getElementById(e)}function F(e){const i=o(e);return i?i.value:""}function he(e,i){const t=parseFloat(F(e));return isNaN(t)?i||0:t}function A(e,i){const t=parseInt(F(e));return isNaN(t)?i||0:t}function le(){const e=(g==null?void 0:g.firstName)||"",i=(g==null?void 0:g.lastName)||"";return(e.charAt(0)+i.charAt(0)).toUpperCase()||"U"}async function es(e){var s;const i=await Ot(),t=Pe();if(i?g=i:g={firstName:t.name||((s=t.email)==null?void 0:s.split("@")[0])||"",lastName:"",division:"",category:"",powerFactor:"",region:"",club:"",draw:null,reloadTime:null},$=await Kt(),$&&$.length>0){const a=new Date,n=$.filter(r=>r.status!=="finished"&&r.date);if(n.length>0){let r=n[0],u=Math.abs(new Date(n[0].date)-a);for(const m of n){const b=new Date(m.date),f=Math.abs(b-a);f<u&&(u=f,r=m)}R=r.id}}ke&&ke(),ke=Vt(a=>{$=a,fe(),te()}),Yt(a=>{ee=a,Je()}),e.innerHTML=`
<div class="phone">
...
<div class="modal-overlay" id="modal-confirm-delete" onclick="closeModalOutside(event,'modal-confirm-delete')">
  ...
  `,ts(),ut(),te(),fe(),gt(),Be()}function ts(){window.switchTab=is,window.setFilter=ns,window.openModal=ie,window.closeModal=G,window.closeModalOutside=as,window.createMatch=rs,window.searchMatchByIdHandler=os,window.openEditProfile=Cs,window.saveProfileData=Ns,window.selectPF=_s,window.updatePFOptions=vt,window.calcPrognose=Be,window.renderMatchList=fe,window.selectMatch=ls,window.addShooter=Bs,window.addStageResult=Ds,window.handleLogout=zs,window.openEditMatch=ds,window.saveEditMatch=cs,window.openCreateStage=Re,window.openCreateStageFromEdit=gs,window.openCreateStageFromNewMatch=vs,window.openEditStage=ms,window.changeStageNumber=hs,window.changeStageField=fs,window.saveStage=bs,window.openInviteUser=ys,window.openInvitationsModal=Ts,window.acceptInvitation=Is,window.declineInvitation=Ms,window.searchUsers=ws,window.toggleUserSelection=ks,window.sendMultipleInvitations=xs,window.searchUsersNewMatch=Ss,window.toggleUserNewMatch=Ls,window.searchUsersEditMatch=Ps,window.toggleUserEditMatch=Es,window.confirmDeleteMatch=ps,window.deleteMatchConfirmed=us,window.uploadAndScanResult=js,window.saveOCRResult=Hs,window.openCreateStageFromUpload=Os}function is(e){document.querySelectorAll(".screen").forEach(s=>s.classList.remove("active")),document.querySelectorAll(".tab-item").forEach(s=>s.classList.remove("active")),o(e).classList.add("active");const i=["screen-home","screen-matches","screen-prognose","screen-results","screen-profile"].indexOf(e),t=document.querySelectorAll(".tab-item");t[i]&&t[i].classList.add("active"),e==="screen-home"&&te(),e==="screen-matches"&&fe(),e==="screen-results"&&_e()}function ie(e){o(e).classList.add("open"),e==="modal-upload-result"&&ss()}async function ss(){const e=$.find(n=>n.id==R);if(!e)return;const i=o("upload-match-name");i&&(i.textContent=e.name||"Ukjent match");const t=o("upload-stage-select");if(t.innerHTML="",e.stages&&e.stages.length>0)e.stages.forEach(n=>{const r=document.createElement("option");r.value=n.number,r.textContent=`Stage ${n.number} - ${n.name}`,t.appendChild(r)});else{const n=document.createElement("option");n.value="",n.textContent="Ingen stages - opprett ny",t.appendChild(n)}const s=o("upload-shooter-select");s.innerHTML="";const a=document.createElement("option");if(a.value="me",a.textContent="Meg ("+(g.firstName||"")+" "+(g.lastName||"")+")",s.appendChild(a),e.participants&&e.participants.length>0)for(const n of e.participants){const r=Pe();if(!(r&&n===r.uid))try{const u=await jt(n);if(u){const m=document.createElement("option");m.value=n,m.textContent=(u.firstName||"")+" "+(u.lastName||""),s.appendChild(m)}}catch(u){console.error("Error fetching user:",n,u)}}e.shooters&&e.shooters.length>0&&e.shooters.forEach(n=>{const r=document.createElement("option");r.value=n.id,r.textContent=n.firstName+" "+n.lastName,s.appendChild(r)})}function G(e){o(e).classList.remove("open")}function as(e,i){e.target.id===i&&G(i)}function ns(e,i){ue=e,document.querySelectorAll(".filter-chip").forEach(t=>t.classList.remove("active")),i.classList.add("active"),fe()}async function rs(){var t;const e={name:F("new-match-name")||"Ny match",type:F("new-match-type")||"Trening",date:F("new-match-date")||new Date().toISOString().split("T")[0],location:F("new-match-location")||"",plannedStages:A("new-match-stages",6),searchable:((t=o("new-match-searchable"))==null?void 0:t.checked)!==!1,status:"active",stages:[],shooters:[],stageDefs:[]},i=await Ht(e);if(i.success){let s=0;for(const a of ve)(await Ge(a.email,{matchId:i.matchId,matchName:e.name})).success&&s++;G("modal-new-match"),o("new-match-name").value="",o("new-match-location").value="",o("new-match-stages").value="6",o("new-match-searchable")&&(o("new-match-searchable").checked=!0),o("new-match-user-search").value="",o("new-match-search-results").innerHTML="",ve=[],s>0&&alert(`Match opprettet! Invitasjoner sendt til ${s} bruker(e).`)}else alert("Kunne ikke opprette match: "+i.error)}async function os(){const e=F("match-id-search").trim();if(!e){alert("Skriv inn et match-ID");return}const i=await Gt(e);i.success?(alert(`Match funnet: ${i.match.name} (ID: ${i.match.id})`),o("match-id-search").value=""):alert(`Fant ingen match med ID ${e}${i.error?": "+i.error:""}`)}function ls(e){R=e;const i=$.find(t=>t.id==e);if(i){const t=i.id?"Match ID "+i.id+" "+i.name:i.name||"Match";["home-chip-name","prog-chip-name","results-chip-name"].forEach(a=>{const n=o(a);n&&(n.textContent=t)})}xe&&xe(),e&&(xe=qt(e,t=>{const s=$.findIndex(a=>a.id==e);s!==-1&&t&&($[s]=t,te(),_e())})),te(),_e(),Be()}function ds(){const e=$.find(n=>n.id==R);if(!e){alert("Ingen match valgt");return}o("edit-match-name").value=e.name||"",o("edit-match-type").value=e.type||"Trening",o("edit-match-date").value=e.date||"",o("edit-match-location").value=e.location||"",o("edit-match-stages").value=e.plannedStages||0,o("edit-match-searchable")&&(o("edit-match-searchable").checked=e.searchable!==!1),o("edit-match-finished")&&(o("edit-match-finished").checked=e.status==="finished");const i=o("edit-match-rival");i.innerHTML='<option value="">Ingen rival valgt</option>';const t=document.createElement("option");t.value="me",t.textContent="Meg ("+(g.firstName||"")+" "+(g.lastName||"")+")",i.appendChild(t),e.shooters&&e.shooters.length>0&&e.shooters.forEach(n=>{const r=document.createElement("option");r.value=n.id,r.textContent=n.firstName+" "+n.lastName,i.appendChild(r)}),e.rivalId&&(i.value=e.rivalId),o("edit-match-user-search").value="",o("edit-match-search-results").innerHTML="",me=[];const s=Pe(),a=o("delete-match-btn");a&&s&&e.ownerId===s.uid?a.style.display="block":a&&(a.style.display="none"),ie("modal-edit-match")}async function cs(){var s,a;const e=$.find(n=>n.id==R);if(!e){alert("Ingen match valgt");return}const i={name:F("edit-match-name")||e.name,type:F("edit-match-type")||e.type,date:F("edit-match-date")||e.date,location:F("edit-match-location")||e.location,plannedStages:A("edit-match-stages",e.plannedStages),searchable:((s=o("edit-match-searchable"))==null?void 0:s.checked)!==!1,status:(a=o("edit-match-finished"))!=null&&a.checked?"finished":"active",rivalId:F("edit-match-rival")||null},t=await Ee(e.id,i);if(t.success){let n=0;for(const r of me)(await Ge(r.email,{matchId:e.id,matchName:i.name})).success&&n++;G("modal-edit-match"),n>0&&alert(`Match oppdatert! Invitasjoner sendt til ${n} bruker(e).`)}else alert("Kunne ikke oppdatere match: "+t.error)}function ps(){const e=$.find(t=>t.id==R);if(!e){alert("Ingen match valgt");return}const i=e.id?"Match ID "+e.id+" "+e.name:e.name;o("delete-match-name").textContent=i,ie("modal-confirm-delete")}async function us(){const e=$.find(t=>t.id==R);if(!e){alert("Ingen match valgt");return}const i=await zt(e.id);i.success?(G("modal-confirm-delete"),G("modal-edit-match"),R=null,te(),fe(),alert("Match slettet")):alert("Kunne ikke slette match: "+i.error)}let Ce=null,Ie=null;function Re(){var i;const e=$.find(t=>t.id==R);if(!e){alert("Ingen match valgt");return}Ce=null,o("stage-modal-title").textContent=d("create_stage"),o("stage-number").value=(((i=e.stages)==null?void 0:i.length)||0)+1,o("stage-name").value="",o("stage-paper-targets").value=0,o("stage-poppers").value=0,o("stage-plates").value=0,o("stage-no-shoots").value=0,o("stage-bonus-paper-targets").value=0,o("stage-bonus-included").checked=!1,ie("modal-create-stage")}function gs(){G("modal-edit-match"),Re()}function vs(){G("modal-new-match"),Re()}function ms(e){const i=$.find(s=>s.id==R);if(!i||!i.stages||!i.stages[e]){alert("Stage ikke funnet");return}Ce=e;const t=i.stages[e];o("stage-modal-title").textContent=d("edit_stage"),o("stage-number").value=t.number||e+1,o("stage-name").value=t.name||"",o("stage-paper-targets").value=t.paperTargets||0,o("stage-poppers").value=t.poppers||0,o("stage-plates").value=t.plates||0,o("stage-no-shoots").value=t.noShoots||0,o("stage-bonus-paper-targets").value=t.bonusPaperTargets||0,o("stage-bonus-included").checked=t.bonusIncluded||!1,ie("modal-create-stage")}function hs(e){const i=o("stage-number"),t=Math.max(1,parseInt(i.value)+e);i.value=t}function fs(e,i){const t=o("stage-"+e),s=Math.max(0,parseInt(t.value)+i);t.value=s}async function bs(){var a;const e=$.find(n=>n.id==R);if(!e){alert("Ingen match valgt");return}const i={number:A("stage-number",1),name:F("stage-name")||"",paperTargets:A("stage-paper-targets",0),poppers:A("stage-poppers",0),plates:A("stage-plates",0),noShoots:A("stage-no-shoots",0),bonusPaperTargets:A("stage-bonus-paper-targets",0),bonusIncluded:((a=o("stage-bonus-included"))==null?void 0:a.checked)||!1},t=e.stages||[];Ce!==null?t[Ce]=i:t.push(i);const s=await Ee(e.id,{stages:t});s.success?G("modal-create-stage"):alert("Kunne ikke lagre stage: "+s.error)}let ee=[],Q=[],ve=[],me=[];function ys(){if(!R){alert("Ingen match valgt");return}Q=[],o("user-search-input").value="",o("user-search-results").innerHTML="",o("send-invitations-btn").style.display="none",ie("modal-invite-user")}async function ws(){const e=F("user-search-input").trim();if(e.length===0){o("user-search-results").innerHTML='<p style="color:#9ca3af;text-align:center;">Skriv inn et søk</p>';return}const i=await Ke(e),t=o("user-search-results");if(!t)return;if(i.length===0){t.innerHTML='<p style="color:#9ca3af;text-align:center;">Ingen brukere funnet</p>';return}let s='<div style="margin-bottom:10px;font-weight:600;">RESULTATER ('+i.length+"):</div>";i.forEach(a=>{const n=a.displayName||a.email,r=Q.some(m=>m.uid===a.uid),u=n.replace(/'/g,"\\'");s+=`
    ...
    `}),t.innerHTML=s,pt()}function ks(e,i,t){const s=Q.findIndex(a=>a.uid===e);s>-1?Q.splice(s,1):Q.push({uid:e,email:i,displayName:t}),pt()}function pt(){const e=o("send-invitations-btn");e&&(Q.length>0?(e.style.display="block",e.textContent=`Send invitasjoner (${Q.length} valgt)`):e.style.display="none")}async function xs(){if(Q.length===0){alert("Ingen brukere valgt");return}const e=$.find(s=>s.id==R);if(!e)return;let i=0,t=0;for(const s of Q)(await Ge(s.email,{matchId:e.id,matchName:e.name})).success?i++:t++;G("modal-invite-user"),i>0&&alert(`Invitasjoner sendt til ${i} bruker(e)!`),t>0&&alert(`${t} invitasjon(er) feilet.`),Q=[]}async function Ss(){const e=F("new-match-user-search").trim();if(e.length===0){o("new-match-search-results").innerHTML="";return}const i=await Ke(e),t=o("new-match-search-results");if(!t)return;if(i.length===0){t.innerHTML='<p style="color:#9ca3af;text-align:center;font-size:14px;">Ingen brukere funnet</p>';return}let s='<div style="margin-bottom:8px;font-size:14px;font-weight:600;">RESULTATER ('+i.length+"):</div>";i.forEach(a=>{const n=a.displayName||a.email,r=ve.some(m=>m.uid===a.uid),u=n.replace(/'/g,"\\'");s+=`
    ...
    `}),t.innerHTML=s,console.log("✅ HTML rendered to container")}function Es(e,i,t){const s=me.findIndex(a=>a.uid===e);s>-1?me.splice(s,1):me.push({uid:e,email:i,displayName:t})}function Ts(){We(),ie("modal-invitations")}function We(){const e=o("invitations-list");if(!e)return;if(!ee||ee.length===0){e.innerHTML='<div class="empty-state"><div class="empty-sub">'+d("no_invitations")+"</div></div>";return}let i="";ee.forEach((t,s)=>{i+='<div class="card" style="margin-bottom:10px;">',i+='<div style="margin-bottom:10px;"><strong>'+d("invited_to_match")+"</strong></div>",i+='<div style="margin-bottom:10px;">Match ID '+t.matchId+" "+t.matchName+"</div>",i+='<div style="margin-bottom:10px;color:#94a3b8;">Fra: '+t.invitedBy+"</div>",i+='<div style="display:flex;gap:10px;">',i+='<button class="btn-primary" onclick="acceptInvitation('+s+')" style="flex:1;">'+d("accept")+"</button>",i+='<button onclick="declineInvitation('+s+')" style="flex:1;padding:12px;background:#374151;color:white;border:none;border-radius:8px;font-weight:600;cursor:pointer;">'+d("decline")+"</button>",i+="</div>",i+="</div>"}),e.innerHTML=i}async function Is(e){const i=ee[e];if(!i)return;const t=await Wt(i.matchId);t.success?(ee.splice(e,1),Je(),We()):alert("Kunne ikke akseptere invitasjon: "+t.error)}async function Ms(e){const i=ee[e];if(!i)return;const t=await Jt(i.matchId);t.success?(ee.splice(e,1),Je(),We()):alert("Kunne ikke avvise invitasjon: "+t.error)}function Je(){const e=o("invitation-badge");if(!e)return;const i=ee.length;i>0?(e.textContent=i,e.style.display="flex"):e.style.display="none"}function te(){var a,n;const e=o("home-content");if(!e)return;const i=$.find(r=>r.id==R);if(!i){e.innerHTML=`
    ...
    `;return}let t="";t+='<div class="card">',t+='<div class="mhc-name">'+i.name+"</div>",t+='<div class="mhc-meta">'+ct(i.date)+" · "+i.type+"</div>",t+='<div class="mhc-stats">',t+='<div><div class="mhc-val">'+(((a=i.stages)==null?void 0:a.length)||0)+'</div><div class="mhc-lbl">Stages</div></div>',t+='<div><div class="mhc-val">'+(((n=i.shooters)==null?void 0:n.length)||0)+'</div><div class="mhc-lbl">Skyttere</div></div>',t+="</div>",t+='<div style="display:flex;gap:10px;margin-top:15px;">',t+='<button class="btn-primary" onclick="openEditMatch()" style="flex:1;">Rediger match</button>',t+='<button class="btn-primary" onclick="openCreateStage()" style="flex:1;">Ny stage</button>',t+="</div>",t+='<div style="margin-top:10px;">',t+='<button class="btn-primary" onclick="openInviteUser()" style="width:100%;">Inviter bruker</button>',t+="</div>";const s=Pe();s&&i.ownerId===s.uid&&(t+='<div style="margin-top:10px;">',t+='<button onclick="confirmDeleteMatch()" style="width:100%;padding:12px;background:#ef4444;color:white;border:none;border-radius:8px;font-weight:600;cursor:pointer;">Slett match</button>',t+="</div>"),t+="</div>",i.stages&&i.stages.length>0&&(t+='<div class="section-title">Stages</div>',t+='<div class="card">',i.stages.forEach((r,u)=>{t+='<div class="stage-row" style="cursor:pointer;border-bottom:1px solid #2d3748;padding:12px 0;" onclick="openEditStage('+u+')">',t+='<div class="stage-num">S'+(r.number||u+1)+"</div>",t+='<div class="stage-info">',t+='<div class="stage-name">'+(r.name||"Stage "+(r.number||u+1))+"</div>",t+='<div class="stage-meta">',r.paperTargets&&(t+="Paper: "+r.paperTargets+" "),r.poppers&&(t+="Poppers: "+r.poppers+" "),r.plates&&(t+="Plates: "+r.plates+" "),r.noShoots&&(t+="NS: "+r.noShoots+" "),r.bonusPaperTargets&&(t+="Bonus: "+r.bonusPaperTargets+(r.bonusIncluded?" (included)":"")),t+="</div>",t+="</div>",t+="</div>"}),t+="</div>"),e.innerHTML=t}function fe(){const e=o("match-list-container");if(!e)return;let i=$.filter(s=>{if(ue==="all")return!0;if(ue==="active")return s.status!=="finished";if(ue==="trening")return s.type==="Trening";if(ue==="stevne")return s.type==="Stevne";const a=s.date?new Date(s.date).getFullYear().toString():"";return ue===a});if(i.length===0){e.innerHTML='<div class="empty-state"><div class="empty-sub">Ingen matcher funnet</div></div>';return}let t="";i.forEach(s=>{var r;const a=s.id===R,n=s.id?"Match ID "+s.id+" "+s.name:s.name;t+='<div class="match-row">',t+='<div class="match-row-icon'+(a?" is-active":"")+`" onclick="selectMatch('`+s.id+`')">🏆</div>`,t+=`<div class="match-row-info" onclick="selectMatch('`+s.id+`')">`,t+='<div class="match-row-name">'+n+"</div>",t+='<div class="match-row-meta">'+ct(s.date)+" · "+(s.location||s.type)+"</div>",t+="</div>",t+='<div class="match-row-right">',t+=`<button onclick="event.stopPropagation(); selectMatch('`+s.id+`'); openEditMatch();" style="padding:8px 16px;background:#e8b84b;color:#1a202c;border:none;border-radius:8px;font-weight:600;cursor:pointer;margin-bottom:8px;">Rediger</button>`,t+='<div class="match-stg-count">'+(((r=s.stages)==null?void 0:r.length)||0)+"</div>",t+='<div class="match-stg-lbl">stages</div>',t+="</div>",t+="</div>"}),e.innerHTML=t}function _e(){var n;const e=o("results-content");if(!e)return;const i=$.find(r=>r.id===R);if(!i){e.innerHTML='<div class="empty-state"><div class="empty-sub">Velg en match først</div></div>';return}if(!i.shooters||i.shooters.length===0){e.innerHTML='<div class="empty-state"><div class="empty-icon">👥</div><div class="empty-title">Ingen skyttere</div><div class="empty-sub">Trykk + for å legge til skyttere</div></div>';return}let t='<div class="card">';t+='<div class="card-header"><div class="card-title">Standings</div></div>',t+='<div class="standings-table-wrap"><table class="standings-table">',t+='<thead><tr class="standings-header-row">',t+='<th class="standings-th standings-th-rank">#</th>',t+='<th class="standings-th standings-th-shooter">Skytter</th>',t+='<th class="standings-th standings-th-pts">Pts</th>',t+='<th class="standings-th standings-th-pct">%</th>',t+="</tr></thead>",t+="<tbody>";const s=i.shooters.map(r=>{var m;const u=((m=r.stages)==null?void 0:m.reduce((b,f)=>b+(f.pts||0),0))||0;return{...r,totalPts:u}}).sort((r,u)=>u.totalPts-r.totalPts),a=((n=s[0])==null?void 0:n.totalPts)||0;s.forEach((r,u)=>{const m=a>0?(r.totalPts/a*100).toFixed(2):"0.00";t+='<tr class="standings-row">',t+='<td class="standings-td standings-td-rank">'+(u+1)+"</td>",t+='<td class="standings-td standings-td-shooter">',t+='<div class="standings-shooter-name">'+r.firstName+" "+r.lastName+"</div>",t+='<div class="standings-shooter-meta">'+r.division+" · "+ge(r.pf||"minor")+"</div>",t+="</td>",t+='<td class="standings-td standings-td-pts">'+r.totalPts.toFixed(2)+"</td>",t+='<td class="standings-td standings-td-pct">'+m+"%</td>",t+="</tr>"}),t+="</tbody></table></div>",t+="</div>",e.innerHTML=t}function ut(){const e=le();["prof-avatar","nav-av-home","nav-av-matches","nav-av-prog","nav-av-results"].forEach(u=>{const m=o(u);m&&(m.textContent=e)});const t=o("prof-name");t&&(t.textContent=(g.firstName||"")+" "+(g.lastName||""));const s=o("prof-div");s&&(s.textContent=(g.division||"—")+" · "+(g.club||"—"));const a=o("prof-badge-pf");a&&(a.textContent=g.powerFactor?ge(g.powerFactor):"—");const n=o("prof-badge-region");n&&(n.textContent=g.region||"—");const r={"info-firstname":g.firstName||"—","info-lastname":g.lastName||"—","info-division":g.division||"—","info-category":g.category||"—","info-pf":g.powerFactor?ge(g.powerFactor):"—","info-region":g.region||"—","info-club":g.club||"—"};Object.keys(r).forEach(u=>{const m=o(u);m&&(m.textContent=r[u])}),gt()}function gt(){const e=[];$.forEach(p=>{p.stages&&p.stages.forEach(h=>e.push(h))});let i=0,t=0,s=0;e.forEach(p=>{i+=p.a||0,t+=(p.a||0)+(p.c||0)+(p.d||0),s+=p.hf||0});const a=e.length?(s/e.length).toFixed(2):"—",n=t?Math.round(i/t*100)+"%":"—",r=o("stat-matches");r&&(r.textContent=$.length);const u=o("stat-stages");u&&(u.textContent=e.length);const m=o("stat-avg-hf");m&&(m.textContent=a);const b=o("stat-a-rate");b&&(b.textContent=n);const f=o("prog-a-rate");f&&(f.textContent=n)}function Cs(){o("edit-firstname").value=g.firstName||"",o("edit-lastname").value=g.lastName||"",o("edit-club").value=g.club||"",o("edit-draw").value=g.draw||"",o("edit-reload").value=g.reloadTime||"";let e="";Ji.forEach(s=>{e+='<option value="'+s+'"'+(s===g.division?" selected":"")+">"+s+"</option>"}),o("edit-division").innerHTML=e;let i="";Zi.forEach(s=>{i+='<option value="'+s+'"'+(s===g.category?" selected":"")+">"+s+"</option>"}),o("edit-category").innerHTML=i;let t="";Qi.forEach(s=>{t+='<option value="'+s+'"'+(s===g.region?" selected":"")+">"+s+"</option>"}),o("edit-region").innerHTML=t,vt(),ie("modal-edit-profile")}function vt(){const e=F("edit-division"),i=Yi[e]||["minor","major"];let t="";i.forEach(s=>{const a=g.powerFactor===s;t+='<label class="pf-option'+(a?" active":"")+`" onclick="selectPF(this,'`+s+`')">`,t+='<input type="radio" name="pf" value="'+s+'">',t+='<div class="pf-label">'+s.toUpperCase()+"</div>",t+='<div class="pf-sub">'+(s==="major"?"≥170 PF":"<170 PF")+"</div>",t+="</label>"}),o("pf-options").innerHTML=t,i.indexOf(g.powerFactor)<0&&(g.powerFactor=i[0])}function _s(e,i){document.querySelectorAll(".pf-option").forEach(t=>t.classList.remove("active")),e.classList.add("active"),g.powerFactor=i}async function Ns(){g.firstName=F("edit-firstname").trim()||"",g.lastName=F("edit-lastname").trim()||"",g.division=F("edit-division")||"",g.category=F("edit-category")||"",g.region=F("edit-region")||"",g.club=F("edit-club").trim()||"",g.draw=he("edit-draw")||null,g.reloadTime=he("edit-reload")||null;const e=await Dt(g),i=o("save-profile-btn");e.success?(i.textContent="✓ Lagret!",i.style.background="var(--green)",setTimeout(()=>{i.textContent=d("save_profile"),i.style.background=""},1800)):(i.textContent="❌ Feil!",i.style.background="var(--red)",setTimeout(()=>{i.textContent=d("save_profile"),i.style.background=""},1800)),ut(),Be(),te(),G("modal-edit-profile")}function $s(e,i,t,s){var k;if(!e||!e.rivalId||!i)return null;let a=0,n=0;e.stages&&e.stages.forEach(P=>{P.pts&&P.pts>0&&(a+=P.pts,n++)});let r=0,u="";if(e.rivalId==="me")u="Meg (baseline)",r=a;else{const P=(k=e.shooters)==null?void 0:k.find(C=>C.id===e.rivalId);P&&(u=P.firstName+" "+P.lastName,P.stages&&P.stages.forEach(C=>{C.pts&&C.pts>0&&(r+=C.pts)}))}const m=a-r,b=m>0,f=Math.abs(m);let p="",h="",E=null;if(b)p=`LEDER ${f.toFixed(1)} pts`,f>20?h=`Meget god ledelse! Hold tempoet. Skytt ${(i.aPercent*100).toFixed(0)}%A som vanlig, unngå miss.`:f>10?h="God ledelse. Hold fokus på prosessen. Skytt som vanlig, unngå miss.":h=`Jevnt! Hold tempoet. Prøv å holde ${(i.aPercent*100).toFixed(0)}%A, unngå miss.`;else{p=`BAK ${f.toFixed(1)} pts`;const P=(e.plannedStages||6)-n;if(P>0){const C=f/P,L=g.draw||1.42,I=g.reloadTime||1.8,B=g.division||"Classic",D=g.powerFactor||"minor",_=Se(s,B,D),K=L+s*i.avgSplit+_*I+3;E=(t*s+C)/K,f>20?h=`Må presse hardt! Target HF ${E.toFixed(2)} vs estimat ${t.toFixed(2)}. Øk tempo litt, hold ${(i.aPercent*100).toFixed(0)}%A.`:f>10?h=`Må presse litt over vanlig nivå. Target HF ${E.toFixed(2)} vs estimat ${t.toFixed(2)}.`:h=`Meget jevnt! Hold fokus på prosessen. Skytt ${(i.aPercent*100).toFixed(0)}%A som vanlig, unngå miss.`}else h=`BAK ${f.toFixed(1)} pts. Ingen stages igjen.`}return{statusText:p,advice:h,rivalName:u,gap:m,targetHF:E}}function Be(){const e=A("prog-shots",12),i=A("prog-targets",6),t=A("prog-steel",2),s=he("prog-move",3),a=he("prog-draw",g.draw||1.42),n=g.division||"Classic",r=g.powerFactor||"minor",u=Se(e,n,r);o("prog-reloads").value=u;const m=g.reloadTime||1.8,b=dt();let f=.18,p="—";b&&b.avgSplit&&(f=b.avgSplit,b.aPercent!==void 0&&(p=(b.aPercent*100).toFixed(0)+"%")),o("prog-split-display")&&(o("prog-split-display").textContent=f.toFixed(3)+"s");const h=o("prog-a-rate");h&&(h.textContent=p);const E=a+e*f+u*m+s;let P=i*10+t*10;if(b&&b.aPercent!==void 0){const w=i*2+t,y=tt[r]||tt.minor;P=w*b.aPercent*y.A+w*b.cPercent*y.C+w*b.dPercent*y.D+w*b.missPercent*y.miss}const C=E>0?P/E:0;o("prog-hf-out").textContent=C.toFixed(2);let L="";L+='<div class="prog-breakdown-detail">',L+="Trekk: "+a.toFixed(2)+"s · ",L+="Skudd: "+(e*f).toFixed(2)+"s · ",L+="Reload: "+(u*m).toFixed(2)+"s · ",L+="Beveg: "+s.toFixed(2)+"s",L+="</div>",b?(L+='<div class="prog-breakdown-detail" style="margin-top:8px;color:var(--muted);font-size:12px;">',L+="Basert på "+b.completedStages+" av "+b.totalStages+" stages",b.aPercent!==void 0?L+=" (t/skudd: "+f.toFixed(3)+"s, "+(b.aPercent*100).toFixed(0)+"%A)":L+=" (t/skudd: "+f.toFixed(3)+"s)",L+="</div>"):(L+='<div class="prog-breakdown-detail" style="margin-top:8px;color:var(--muted);font-size:12px;">',L+="Ingen data ennå - bruker standard 0.18s split",L+="</div>"),o("prog-breakdown").innerHTML=L;const I=$.find(K=>K.id==R),B=$s(I,b,C,e),D=o("prog-coaching");if(B&&D){const j=B.gap>0?"var(--green)":"var(--red)";let w="";w+='<div style="background:var(--card-bg);border-radius:12px;padding:15px;border-left:4px solid '+j+';">',w+='<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">',w+='<div style="font-size:13px;color:var(--muted);">vs. '+B.rivalName+"</div>",w+='<div style="font-size:18px;font-weight:700;color:'+j+';">'+B.statusText+"</div>",w+="</div>",w+='<div style="font-size:14px;line-height:1.5;color:var(--text);">'+B.advice+"</div>",w+="</div>",D.innerHTML=w}else D&&(D.innerHTML="");const _=o("prog-data-status");_&&(!b||b.completedStages===0?_.style.display="block":_.style.display="none"),Fs()}function Fs(){const e=$.find(a=>a.id==R),i=o("prog-stages-container");if(!i||!e||!e.stages||e.stages.length===0){i&&(i.innerHTML="");return}let t="";const s=[...e.stages].sort((a,n)=>(a.number||0)-(n.number||0));s.forEach((a,n)=>{const r=a.time&&a.pts;if(t+='<div class="card" style="margin-top:15px;border-left:4px solid '+(r?"var(--green)":"var(--muted)")+';">',t+='<div class="card-header">',t+='<div class="card-title">Stage '+a.number+". "+a.name+"</div>",t+='<span class="badge '+(r?"badge-green":"badge-gray")+'">'+(r?"✅ SKUTT":"⏳ IKKE SKUTT")+"</span>",t+="</div>",r){const m=[];Pe()&&m.push({name:(g.firstName||"")+" "+(g.lastName||""),pts:a.pts,hf:a.hf,isMe:!0}),m.sort((k,P)=>P.pts-k.pts);const f=m.length>0?m[0].pts:0;t+='<div style="overflow-x:auto;margin-top:12px;">',t+='<table style="width:100%;font-size:13px;border-collapse:collapse;">',t+='<tr style="border-bottom:1px solid var(--border);color:var(--muted);">',t+='<th style="padding:8px;text-align:left;">#</th>',t+='<th style="padding:8px;text-align:left;">NAVN</th>',t+='<th style="padding:8px;text-align:right;">PTS</th>',t+='<th style="padding:8px;text-align:right;">%</th>',t+='<th style="padding:8px;text-align:right;">HF</th>',t+="</tr>",m.forEach((k,P)=>{const C=f>0?k.pts/f*100:0,L=k.isMe?"background:var(--accent-fade);font-weight:600;":"";t+='<tr style="'+L+'border-bottom:1px solid var(--border);">',t+='<td style="padding:8px;">'+(P+1)+"</td>",t+='<td style="padding:8px;">'+k.name+"</td>",t+='<td style="padding:8px;text-align:right;color:var(--accent);">'+k.pts.toFixed(1)+"</td>",t+='<td style="padding:8px;text-align:right;">'+C.toFixed(2)+"%</td>",t+='<td style="padding:8px;text-align:right;">'+(k.hf||0).toFixed(2)+"</td>",t+="</tr>"}),t+="</table>",t+="</div>";const p=dt();p&&(t+='<div style="margin-top:15px;padding:12px;background:var(--bg);border-radius:8px;">',t+='<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;font-size:13px;">',t+='<div><div style="color:var(--muted);margin-bottom:4px;">t/skudd</div><div style="font-weight:600;">'+p.avgSplit.toFixed(3)+"s</div></div>",p.aPercent!==void 0&&(t+='<div><div style="color:var(--muted);margin-bottom:4px;">Treff</div><div style="font-weight:600;color:var(--green);">'+(p.aPercent*100).toFixed(0)+"%A</div></div>"),t+='<div><div style="color:var(--muted);margin-bottom:4px;">Est. HF neste</div><div style="font-weight:600;color:var(--accent);">—</div></div>',t+="</div>",t+="</div>");const h=n+1;if(h<s.length){const k=s[h],P=As(a,k,p,e);if(P){if(t+='<div style="margin-top:15px;padding:12px;background:var(--accent-fade);border-radius:8px;border-left:3px solid var(--accent);">',t+='<div style="font-size:12px;color:var(--muted);margin-bottom:8px;">NESTE: '+k.name.toUpperCase(),k.paperTargets||k.poppers||k.plates){const C=(k.paperTargets||0)*2+(k.poppers||0)+(k.plates||0),L=(k.paperTargets||0)*10+(k.poppers||0)*10+(k.plates||0)*10;t+=" ("+C+" SKUDD, MAX "+L+" PTS)"}t+="</div>",t+='<div style="font-size:14px;line-height:1.5;">'+P+"</div>",t+="</div>"}}const E=Rs(a,s,n,p);E&&(t+='<div style="margin-top:15px;padding:12px;background:var(--card-bg);border-radius:8px;">',t+='<div style="font-size:12px;color:var(--muted);margin-bottom:8px;">💢 REFLEKSJON</div>',t+='<div style="font-size:13px;line-height:1.5;color:var(--text);">'+E+"</div>",t+="</div>")}else t+='<div style="padding:20px;text-align:center;color:var(--muted);font-size:13px;">',t+="Ingen resultater ennå. Last opp resultat eller legg til manuelt.",t+="</div>";t+="</div>"}),i.innerHTML=t}function As(e,i,t,s){if(!s||!s.rivalId||!t)return"Hold fokus på siktet. Skytt som vanlig.";let a=0,n=0;s.stages&&s.stages.forEach(p=>{p.pts&&p.pts>0&&(a+=p.pts)});const r=a-n,u=r>0,m=Math.abs(r),b={leadingLarge:["Meget god ledelse! Hold tempoet som nå.","Suverent! Fortsett slik du gjør.","Solid ledelse. Fokuser på prosessen.","Bra! Skytt som vanlig, behold kontrollen."],leadingSmall:["Jevnt! Hold fokus på siktet.","God ledelse. Behold kontrollen, skytt som vanlig.","Fortsett som nå, ta deg tid på siktet.","Bra ledelse. Skytt bevisst, hold siktet."],behindLarge:["Må presse hardt! Øk tempo, behold A%.","Stort gap. Trenger perfekt utførelse.","Tøff situasjon. Fokus på maksimal HF, hold siktet.","Presse på tempo, men behold kontroll på siktet."],behindSmall:["Jevnt! Du er med i kampen. Hold fokus.","Presse litt over vanlig nivå. Behold A%.","Meget jevnt! Skytt som vanlig, ta deg tid på siktet.","Fortsett som nå, hold siktet."],even:["Dønn jevnt! Alt avgjøres nå. Hold fokus.","Knalljevnt! Hold nerven, skytt som vanlig.","Kan gå begge veier. Fokuser på prosessen.","Perfekt balanse. Behold kontrollen."]};let f=b.even;return u?f=m>20?b.leadingLarge:b.leadingSmall:f=m>20?b.behindLarge:b.behindSmall,f[Math.floor(Math.random()*f.length)]}function Rs(e,i,t,s){if(t===0||!s)return null;const a=i[t-1];if(!a||!a.time||!a.pts)return null;const n=g.division||"Classic",r=g.powerFactor||"minor",u=g.draw||1.42,m=g.reloadTime||1.8,b=(a.paperTargets||0)*2+(a.poppers||0)+(a.plates||0),f=Se(b,n,r),p=a.time-u-f*m,h=b>0?p/b:0,E=(e.paperTargets||0)*2+(e.poppers||0)+(e.plates||0),k=Se(E,n,r),P=e.time-u-k*m,C=E>0?P/E:0,L=C-h;let I=0,B=0;a.a&&b>0&&(I=a.a/b),e.a&&E>0&&(B=e.a/E);const D=B-I,_={tempoFell:[`Tempoet falt (${h.toFixed(3)}s → ${C.toFixed(3)}s/skudd). Teknisk stage? Mye bevegelse? Reflekter over hva som tok tid.`,"Saktere enn forrige stage. Vær obs på hva som krevde ekstra tid.","Tempoet droppet. Var det en god beslutning, eller var det uplanlagt?"],treffFell:[`Treffbildet falt (${(I*100).toFixed(0)}%A → ${(B*100).toFixed(0)}%A). For mye press på tempo? Reflekter: Var det verdt det?`,"Flere C/D enn vanlig. Hva endret seg? Skyting eller sikting?","A% nede. Reflekter over hva som påvirket siktet."],tempoOppTreffHolder:[`Raskere enn forrige stage (${h.toFixed(3)}s → ${C.toFixed(3)}s/skudd), men treffbildet holder! Bra! Kan du holde dette tempoet videre?`,"Du økte tempoet uten å miste A%. Solid! Fortsett slik.","Godt skytt! Tempoet opp, siktet holder. Dette er greia."],both:["Både tempo og treffbilde falt. Hva skjedde? Teknisk stage? Analyser hva som gikk galt.","Tøff stage. Begge deler sviktet. Mental eller teknisk?"]};return L>.05&&D<-.1?_.both[Math.floor(Math.random()*_.both.length)]:L>.05?_.tempoFell[Math.floor(Math.random()*_.tempoFell.length)]:D<-.1?_.treffFell[Math.floor(Math.random()*_.treffFell.length)]:L<-.05&&D>-.05?_.tempoOppTreffHolder[Math.floor(Math.random()*_.tempoOppTreffHolder.length)]:null}async function Bs(){const e=$.find(n=>n.id===R);if(!e)return;const i=F("new-shooter-firstname").trim(),t=F("new-shooter-lastname").trim(),s=F("new-shooter-division")||"Classic";if(!i||!t){alert("Fyll inn navn");return}const a={id:"s_"+Date.now(),isMe:!1,firstName:i,lastName:t,division:s,pf:"minor",club:"",stages:[]};e.shooters||(e.shooters=[]),e.shooters.push(a),await Ee(e.id,e),G("modal-add-shooter"),_e()}async function Ds(){const e=$.find(f=>f.id===R);if(!e)return;const i=A("new-result-stage",1),t=he("new-result-time",0),s=A("new-result-points",0),a=A("new-result-a",0),n=A("new-result-c",0),r=A("new-result-d",0),u=A("new-result-miss",0),m=t>0?s/t:0,b={num:i,name:"Stage "+i,hf:m,time:t,pts:s,pf:g.powerFactor||"minor",a,c:n,d:r,miss:u};e.stages||(e.stages=[]),e.stages.push(b),await Ee(e.id,e),G("modal-add"),te()}function Os(){G("modal-upload-result"),Re()}async function js(){if(!$.find(u=>u.id==R)){alert("Ingen aktiv match valgt");return}const i=o("upload-stage-select"),t=o("upload-shooter-select"),s=o("upload-result-file");if(!i.value||!t.value){alert("Velg stage og skytter");return}if(!s.files||s.files.length===0){alert("Velg en fil");return}const a=s.files[0];Ie=i.value,t.value;const n=event.target,r=n.textContent;n.textContent="Skanner...",n.disabled=!0;try{const u=new FileReader;u.onload=async function(m){const b=m.target.result,p=(await Vi.recognize(b,"eng+nor",{logger:E=>console.log(E)})).data.text;console.log("OCR Text:",p);const h=Us(p);o("ocr-time").value=h.time||"",o("ocr-points").value=h.points||"",o("ocr-a").value=h.a||0,o("ocr-c").value=h.c||0,o("ocr-d").value=h.d||0,o("ocr-miss").value=h.miss||0,o("ocr-ns").value=h.ns||0,o("ocr-proc").value=h.proc||0,G("modal-upload-result"),ie("modal-ocr-confirm"),n.textContent=r,n.disabled=!1},u.readAsDataURL(a)}catch(u){console.error("OCR Error:",u),alert("Feil ved skanning: "+u.message),n.textContent=r,n.disabled=!1}}function Us(e){const i={time:null,points:null,a:0,c:0,d:0,miss:0,ns:0,proc:0},t=e.replace(/[\n\r]+/g," ").toLowerCase(),s=[/time[:\s]*(\d+\.?\d*)/i,/(\d+\.\d+)\s*s(?:ec)?/i,/^(\d+\.\d+)$/m];for(const p of s){const h=t.match(p);if(h){i.time=parseFloat(h[1]);break}}const a=[/(?:points?|pts?)[:\s]*(\d+)/i,/score[:\s]*(\d+)/i];for(const p of a){const h=t.match(p);if(h){i.points=parseInt(h[1]);break}}const n=[/(\d+)\s*a(?:lpha)?(?:\s|$)/i,/a(?:lpha)?[:\s]*(\d+)/i];for(const p of n){const h=t.match(p);if(h){i.a=parseInt(h[1]);break}}const r=[/(\d+)\s*c(?:harlie)?(?:\s|$)/i,/c(?:harlie)?[:\s]*(\d+)/i];for(const p of r){const h=t.match(p);if(h){i.c=parseInt(h[1]);break}}const u=[/(\d+)\s*d(?:elta)?(?:\s|$)/i,/d(?:elta)?[:\s]*(\d+)/i];for(const p of u){const h=t.match(p);if(h){i.d=parseInt(h[1]);break}}const m=[/(\d+)\s*m(?:iss)?(?:\s|$)/i,/m(?:iss)?[:\s]*(\d+)/i];for(const p of m){const h=t.match(p);if(h){i.miss=parseInt(h[1]);break}}const b=[/(\d+)\s*ns(?:\s|$)/i,/ns[:\s]*(\d+)/i,/no-?shoot[:\s]*(\d+)/i];for(const p of b){const h=t.match(p);if(h){i.ns=parseInt(h[1]);break}}const f=[/(\d+)\s*p(?:roc)?(?:\s|$)/i,/p(?:roc)?[:\s]*(\d+)/i,/procedural[:\s]*(\d+)/i];for(const p of f){const h=t.match(p);if(h){i.proc=parseInt(h[1]);break}}return i}async function Hs(){var k;const e=$.find(P=>P.id==R);if(!e)return;const i=he("ocr-time",0),t=A("ocr-points",0),s=A("ocr-a",0),a=A("ocr-c",0),n=A("ocr-d",0),r=A("ocr-miss",0),u=A("ocr-ns",0),m=A("ocr-proc",0);if(i<=0||t<=0){alert("Tid og poeng må være større enn 0");return}const b=i>0?t/i:0,f=(k=e.stages)==null?void 0:k.findIndex(P=>P.number==Ie);if(f===-1||f===void 0){alert("Stage ikke funnet");return}const p=e.stages[f],h={num:p.number,name:p.name,hf:b,time:i,pts:t,pf:g.powerFactor||"minor",a:s,c:a,d:n,miss:r,ns:u,proc:m,paperTargets:p.paperTargets,poppers:p.poppers,plates:p.plates},E=e.stages.findIndex(P=>P.number==Ie);E>=0?e.stages[E]=h:e.stages.push(h),await Ee(e.id,e),G("modal-ocr-confirm"),te(),Ie=null}async function zs(){ke&&ke(),xe&&xe(),await Nt(),window.location.reload()}const mt=document.getElementById("app");function Gs(){Bt(mt,ht)}function ht(){es(mt)}Mt(e=>{e?ht():Gs()});
