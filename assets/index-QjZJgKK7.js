import{initializeApp as Oe}from"https://www.gstatic.com/firebasejs/10.12.2/firebase-app.js";import{getAuth as Ue,onAuthStateChanged as He,signInWithEmailAndPassword as ze,createUserWithEmailAndPassword as Ve,signOut as Ge}from"https://www.gstatic.com/firebasejs/10.12.2/firebase-auth.js";import{getFirestore as Ke,getDoc as J,doc as x,setDoc as se,query as ae,collection as W,where as ne,getDocs as ve,onSnapshot as ue,serverTimestamp as ee,updateDoc as D,arrayUnion as Ee,deleteDoc as qe}from"https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js";import{getFunctions as Je,httpsCallable as We}from"https://www.gstatic.com/firebasejs/10.12.2/firebase-functions.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function e(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=e(a);fetch(a.href,o)}})();const Ye={apiKey:"AIzaSyA11OPapSOfwLQzs-oEoF7papT9S3T5p7Q",authDomain:"ipsc-insight-coach.firebaseapp.com",projectId:"ipsc-insight-coach",storageBucket:"ipsc-insight-coach.firebasestorage.app",messagingSenderId:"864793320312",appId:"1:864793320312:web:c586e384bbe365444bc68d",measurementId:"G-3Y4NZTBBS2"},Ie=Oe(Ye),re=Ue(Ie),y=Ke(Ie),Qe=Je();let ge=null,F=null;function Ze(t){He(re,async i=>{if(i){ge=i;try{const e=await J(x(y,"users",i.uid));e.exists()?F={uid:i.uid,...e.data()}:F={uid:i.uid,email:i.email,name:i.email?i.email.split("@")[0]:"Bruker",role:"user"},t(F)}catch(e){console.error("Feil ved lasting av brukerprofil:",e),F={uid:i.uid,email:i.email,name:i.email?i.email.split("@")[0]:"Bruker",role:"user"},t(F)}}else ge=null,F=null,t(null)})}async function Xe(t,i){try{const e=(t||"").trim();return{success:!0,user:(await ze(re,e,i||"")).user}}catch(e){console.error("Innlogging feilet:",e);let s="Innlogging feilet";return e.code==="auth/user-not-found"||e.code==="auth/wrong-password"||e.code==="auth/invalid-credential"?s="Feil e-post eller passord":e.code==="auth/invalid-email"?s="Ugyldig e-postadresse":e.code==="auth/user-disabled"&&(s="Denne kontoen er deaktivert"),{success:!1,error:s}}}async function et(t,i,e,s,a,o,r,p,g,m){try{const v=(t||"").trim(),h=i||"",E=(e||"").trim(),R=(s||"").trim(),w=(a||"").trim(),Y=(o||"").trim(),de=(r||"").trim(),z=(p||"minor").trim(),V=(g||"").trim(),Q=(m||"").trim(),_=(await Ve(re,v,h)).user,ce=We(Qe,"validateInviteCode");try{await ce({code:E,userId:_.uid,userEmail:v})}catch(C){await _.delete();let u="Ugyldig invitasjonskode";return C.code==="functions/not-found"?u="Ugyldig invitasjonskode":C.code==="functions/permission-denied"?u="Denne koden er deaktivert":C.code==="functions/resource-exhausted"?u="Denne koden har nådd maksimalt antall bruk":C.code==="functions/already-exists"?u="Du har allerede brukt denne koden":C.message&&(u=C.message),{success:!1,error:u}}return await se(x(y,"users",_.uid),{email:v,firstName:R,lastName:w,division:Y,category:de,powerFactor:z,region:V,club:Q,role:"user",inviteCode:E,createdAt:new Date,draw:null,reloadTime:null,gdprConsent:!0,gdprConsentDate:new Date,gdprVersion:"1.0"}),{success:!0,user:_}}catch(v){console.error("Registrering feilet:",v);let h="Registrering feilet";return v.code==="auth/email-already-in-use"?h="E-postadressen er allerede i bruk":v.code==="auth/weak-password"?h="Passordet må være minst 6 tegn":v.code==="auth/invalid-email"?h="Ugyldig e-postadresse":v.message&&(h=v.message),{success:!1,error:h}}}async function tt(){try{return await Ge(re),{success:!0}}catch(t){return console.error("Utlogging feilet:",t),{success:!1,error:"Kunne ikke logge ut"}}}function L(){return ge}function me(){return F}const it=`
...
`;function st(t,i){const e=document.getElementById("gdpr-modal");e&&e.remove();const s=document.createElement("div");s.id="gdpr-modal",s.className="gdpr-modal",s.innerHTML=`
  ...
  `,document.body.appendChild(s);const a=s.querySelector(".gdpr-close-btn"),o=s.querySelector(".gdpr-btn-accept"),r=s.querySelector(".gdpr-btn-decline"),p=s.querySelector(".gdpr-modal-overlay"),g=()=>{s.remove()};a.addEventListener("click",()=>{g(),i&&i()}),p.addEventListener("click",()=>{g(),i&&i()}),r.addEventListener("click",()=>{g(),i&&i()}),o.addEventListener("click",()=>{g(),t&&t()}),document.body.style.overflow="hidden";const m=g,v=()=>{document.body.style.overflow="",m()};a.onclick=()=>{v(),i&&i()},p.onclick=()=>{v(),i&&i()},r.onclick=()=>{v(),i&&i()},o.onclick=()=>{v(),t&&t()}}function at(){const t=document.createElement("div");return t.className="gdpr-checkbox-container",t.innerHTML=`
  ...
  `,setTimeout(()=>{const i=t.querySelector("#gdpr-open-modal");i&&i.addEventListener("click",e=>{e.preventDefault(),st(()=>{const s=document.getElementById("gdpr-consent-checkbox");s&&(s.checked=!0)},()=>{const s=document.getElementById("gdpr-consent-checkbox");s&&(s.checked=!1)})})},0),t}function nt(){const t=document.getElementById("gdpr-consent-checkbox");return!t||!t.checked?{valid:!1,error:"Du må godta personvernerklæringen for å registrere deg"}:{valid:!0}}function rt(t,i){t.innerHTML=`
    <style>
      * {
  ...
  `;const e={no:{subtitle:"Analyse. Prognose. Resultat.",loginEmailLabel:"E-post",loginEmailPlaceholder:"navn@epost.no",loginPasswordLabel:"Passord",loginPasswordPlaceholder:"Passord",login:"Logg inn",or:"eller",showRegister:"Registrer ny bruker",registerFirstNameLabel:"Fornavn",registerFirstNamePlaceholder:"Fornavn",registerLastNameLabel:"Etternavn",registerLastNamePlaceholder:"Etternavn",registerEmailLabel:"E-post",registerEmailPlaceholder:"navn@epost.no",registerEmailConfirmLabel:"Bekreft e-post",registerEmailConfirmPlaceholder:"Gjenta e-post",registerPasswordLabel:"Passord",registerPasswordPlaceholder:"Passord",registerPasswordConfirmLabel:"Bekreft passord",registerPasswordConfirmPlaceholder:"Gjenta passord",registerDivisionLabel:"Divisjon",registerCategoryLabel:"Kategori",registerPowerFactorLabel:"Power Factor",registerRegionLabel:"Region",registerClubLabel:"Klubb",registerCodeLabel:"Invitasjonskode",registerCodePlaceholder:"Invitasjonskode",register:"Opprett bruker",cancel:"Avbryt",emailMismatch:"E-postadressene er ikke like",passwordMismatch:"Passordene er ikke like",missingFields:"Fyll ut alle påkrevde feltene",missingName:"Du må skrive inn fornavn og etternavn",missingDivision:"Du må velge divisjon",weakPassword:"Passordet er for svakt",strengthEmpty:"",strengthVeryWeak:"Passordstyrke: Svært svak",strengthWeak:"Passordstyrke: Svak",strengthMedium:"Passordstyrke: Middels",strengthStrong:"Passordstyrke: Sterk",strengthVeryStrong:"Passordstyrke: Svært sterk",gdprRequired:"Du må godta personvernerklæringen for å registrere deg"},en:{subtitle:"Analyze. Predict. Perform.",loginEmailLabel:"Email",loginEmailPlaceholder:"name@email.com",loginPasswordLabel:"Password",loginPasswordPlaceholder:"Password",login:"Log in",or:"or",showRegister:"Create new user",registerFirstNameLabel:"First Name",registerFirstNamePlaceholder:"First name",registerLastNameLabel:"Last Name",registerLastNamePlaceholder:"Last name",registerEmailLabel:"Email",registerEmailPlaceholder:"name@email.com",registerEmailConfirmLabel:"Confirm email",registerEmailConfirmPlaceholder:"Repeat email",registerPasswordLabel:"Password",registerPasswordPlaceholder:"Password",registerPasswordConfirmLabel:"Confirm password",registerPasswordConfirmPlaceholder:"Repeat password",registerDivisionLabel:"Division",registerCategoryLabel:"Category",registerPowerFactorLabel:"Power Factor",registerRegionLabel:"Region",registerClubLabel:"Club",registerCodeLabel:"Invite code",registerCodePlaceholder:"Invite code",register:"Create account",cancel:"Cancel",emailMismatch:"The email addresses do not match",passwordMismatch:"Passwords do not match",missingFields:"Please fill in all required fields",missingName:"Please enter your first and last name",missingDivision:"Please select a division",weakPassword:"The password is too weak",strengthEmpty:"",strengthVeryWeak:"Password strength: Very weak",strengthWeak:"Password strength: Weak",strengthMedium:"Password strength: Medium",strengthStrong:"Password strength: Strong",strengthVeryStrong:"Password strength: Very strong",gdprRequired:"You must accept the privacy policy to register"}};let s="no",a="minor";const o=document.getElementById("error"),r=document.getElementById("loginSection"),p=document.getElementById("registerSection"),g=document.getElementById("showRegisterBtn"),m=document.getElementById("cancelRegisterBtn"),v=document.getElementById("loginBtn"),h=document.getElementById("registerBtn"),E=document.getElementById("langNo"),R=document.getElementById("langEn"),w=document.getElementById("registerPassword"),Y=document.getElementById("passwordStrengthBar"),de=document.getElementById("passwordStrengthText"),z=document.getElementById("pfMinor"),V=document.getElementById("pfMajor");z.onclick=()=>{a="minor",z.classList.add("selected"),V.classList.remove("selected")},V.onclick=()=>{a="major",V.classList.add("selected"),z.classList.remove("selected")};function Q(u){let c=0;return u?(u.length>=8&&(c+=1),u.length>=12&&(c+=1),/[a-z]/.test(u)&&/[A-Z]/.test(u)&&(c+=1),/\d/.test(u)&&(c+=1),/[^A-Za-z0-9]/.test(u)&&(c+=1),c<=1?{score:c,width:"20%",labelKey:"strengthVeryWeak",color:"#ff6b6b"}:c===2?{score:c,width:"40%",labelKey:"strengthWeak",color:"#ff9f43"}:c===3?{score:c,width:"60%",labelKey:"strengthMedium",color:"#feca57"}:c===4?{score:c,width:"80%",labelKey:"strengthStrong",color:"#1dd1a1"}:{score:c,width:"100%",labelKey:"strengthVeryStrong",color:"#10ac84"}):{score:0,width:"0%",labelKey:"strengthEmpty",color:"#ff6b6b"}}function Z(){const u=e[s],c=w.value,M=Q(c);Y.style.width=M.width,Y.style.background=M.color,de.innerText=u[M.labelKey]}function _(u){s=u;const c=e[u];document.getElementById("brandSubtitle").innerText=c.subtitle,document.getElementById("loginEmailLabel").innerText=c.loginEmailLabel,document.getElementById("loginEmail").placeholder=c.loginEmailPlaceholder,document.getElementById("loginPasswordLabel").innerText=c.loginPasswordLabel,document.getElementById("loginPassword").placeholder=c.loginPasswordPlaceholder,document.getElementById("loginBtn").innerText=c.login,document.getElementById("separatorText").innerText=c.or,document.getElementById("showRegisterBtn").innerText=c.showRegister,document.getElementById("registerFirstNameLabel").innerText=c.registerFirstNameLabel,document.getElementById("registerFirstName").placeholder=c.registerFirstNamePlaceholder,document.getElementById("registerLastNameLabel").innerText=c.registerLastNameLabel,document.getElementById("registerLastName").placeholder=c.registerLastNamePlaceholder,document.getElementById("registerEmailLabel").innerText=c.registerEmailLabel,document.getElementById("registerEmail").placeholder=c.registerEmailPlaceholder,document.getElementById("registerEmailConfirmLabel").innerText=c.registerEmailConfirmLabel,document.getElementById("registerEmailConfirm").placeholder=c.registerEmailConfirmPlaceholder,document.getElementById("registerPasswordLabel").innerText=c.registerPasswordLabel,document.getElementById("registerPassword").placeholder=c.registerPasswordPlaceholder,document.getElementById("registerPasswordConfirmLabel").innerText=c.registerPasswordConfirmLabel,document.getElementById("registerPasswordConfirm").placeholder=c.registerPasswordConfirmPlaceholder,document.getElementById("registerDivisionLabel").innerText=c.registerDivisionLabel,document.getElementById("registerCategoryLabel").innerText=c.registerCategoryLabel,document.getElementById("registerPowerFactorLabel").innerText=c.registerPowerFactorLabel,document.getElementById("registerRegionLabel").innerText=c.registerRegionLabel,document.getElementById("registerClubLabel").innerText=c.registerClubLabel,document.getElementById("registerCodeLabel").innerText=c.registerCodeLabel,document.getElementById("registerCode").placeholder=c.registerCodePlaceholder,document.getElementById("registerBtn").innerText=c.register,document.getElementById("cancelRegisterBtn").innerText=c.cancel,E.classList.toggle("active",u==="no"),R.classList.toggle("active",u==="en"),Z()}function ce(){r.classList.remove("active"),p.classList.add("active"),o.innerText="";const u=document.getElementById("gdprCheckboxContainer");if(u&&!u.hasChildNodes()){const c=at();u.appendChild(c)}}function C(){p.classList.remove("active"),r.classList.add("active"),o.innerText=""}E.onclick=()=>_("no"),R.onclick=()=>_("en"),g.onclick=ce,m.onclick=C,w.oninput=Z,v.onclick=async()=>{o.innerText="";const u=document.getElementById("loginEmail").value.trim(),c=document.getElementById("loginPassword").value,M=await Xe(u,c);M.success?i():o.innerText=M.error},h.onclick=async()=>{o.innerText="";const u=e[s],c=document.getElementById("registerFirstName").value.trim(),M=document.getElementById("registerLastName").value.trim(),pe=document.getElementById("registerEmail").value.trim(),ke=document.getElementById("registerEmailConfirm").value.trim(),X=document.getElementById("registerPassword").value,xe=document.getElementById("registerPasswordConfirm").value,Se=document.getElementById("registerDivision").value,Re=document.getElementById("registerCategory").value,Ae=document.getElementById("registerRegion").value,je=document.getElementById("registerClub").value.trim(),Pe=document.getElementById("registerCode").value.trim();if(!c||!M){o.innerText=u.missingName;return}if(!pe||!ke||!X||!xe||!Pe){o.innerText=u.missingFields;return}if(!Se){o.innerText=u.missingDivision;return}if(pe!==ke){o.innerText=u.emailMismatch;return}if(X!==xe){o.innerText=u.passwordMismatch;return}if(Q(X).score<=1){o.innerText=u.weakPassword;return}if(!nt().valid){o.innerText=u.gdprRequired;return}const Le=await et(pe,X,Pe,c,M,Se,Re,a,Ae,je);Le.success?i():o.innerText=Le.error},_("no"),Z()}async function ot(t){const i=L();if(!i)return{success:!1,error:"Not authenticated"};try{return await D(x(y,"users",i.uid),{...t,updatedAt:ee()}),{success:!0}}catch(e){return console.error("Save profile error:",e),{success:!1,error:e.message}}}async function lt(){const t=L();if(!t)return null;try{const i=await J(x(y,"users",t.uid));return i.exists()?{uid:t.uid,...i.data()}:null}catch(i){return console.error("Get profile error:",i),null}}async function dt(){const t=x(y,"counters","matchId");try{const i=await J(t);if(!i.exists())return await se(t,{value:1}),1;const s=i.data().value+1;return await D(t,{value:s}),s}catch(i){throw console.error("Error getting next match ID:",i),i}}async function ct(t){const i=L();if(!i)return{success:!1,error:"Not authenticated"};try{const e=await dt(),s={id:e,...t,searchable:t.searchable!==!1,ownerId:i.uid,participants:[i.uid],createdAt:ee(),updatedAt:ee()};return await se(x(y,"matches",e.toString()),s),{success:!0,matchId:e}}catch(e){return console.error("Create match error:",e),{success:!1,error:e.message}}}async function oe(t,i){if(!L())return{success:!1,error:"Not authenticated"};try{return await D(x(y,"matches",t.toString()),{...i,updatedAt:ee()}),{success:!0}}catch(s){return console.error("Update match error:",s),{success:!1,error:s.message}}}async function pt(t){const i=L();if(!i)return{success:!1,error:"Not authenticated"};try{const e=await J(x(y,"matches",t.toString()));return e.exists()?e.data().ownerId!==i.uid?{success:!1,error:"Only the creator can delete this match"}:(await qe(x(y,"matches",t.toString())),{success:!0}):{success:!1,error:"Match not found"}}catch(e){return console.error("Delete match error:",e),{success:!1,error:e.message}}}async function gt(t){const i=L();if(!i)return{success:!1,error:"Not authenticated"};try{const e=await J(x(y,"matches",t.toString()));if(!e.exists())return{success:!1,error:"Match not found"};const s={id:e.id,...e.data()};return s.searchable?(s.participants.includes(i.uid)||await D(x(y,"matches",t.toString()),{participants:Ee(i.uid)}),{success:!0,match:s}):{success:!1,error:"Match is not searchable"}}catch(e){return console.error("Search match error:",e),{success:!1,error:e.message}}}async function vt(){const t=L();if(!t)return[];try{const i=ae(W(y,"matches"),ne("participants","array-contains",t.uid)),e=await ve(i),s=[];return e.forEach(a=>{s.push({id:a.id,...a.data()})}),s.sort((a,o)=>{var g,m;const r=a.date||((g=a.createdAt)==null?void 0:g.toDate())||new Date(0);return(o.date||((m=o.createdAt)==null?void 0:m.toDate())||new Date(0))-r}),s}catch(i){return console.error("Get user matches error:",i),[]}}function ut(t){const i=L();if(!i)return()=>{};const e=ae(W(y,"matches"),ne("participants","array-contains",i.uid));return ue(e,a=>{const o=[];a.forEach(r=>{o.push({id:r.id,...r.data()})}),o.sort((r,p)=>{var v,h;const g=r.date||((v=r.createdAt)==null?void 0:v.toDate())||new Date(0);return(p.date||((h=p.createdAt)==null?void 0:h.toDate())||new Date(0))-g}),t(o)},a=>{console.error("Listen to matches error:",a)})}function mt(t,i){return ue(x(y,"matches",t.toString()),s=>{s.exists()?i({id:s.id,...s.data()}):i(null)},s=>{console.error("Listen to match error:",s)})}async function he(t,i){const e=L();if(!e)return{success:!1,error:"Not authenticated"};try{console.log("🔍 Søker etter bruker med email:",t);const s=ae(W(y,"users"),ne("email","==",t)),a=await ve(s);if(a.empty)return console.error("❌ Bruker ikke funnet:",t),{success:!1,error:"Bruker ikke funnet"};const o=a.docs[0],r=o.id;return console.log("✅ Bruker funnet:",r,o.data()),console.log("📨 Sender invitasjon..."),await se(x(y,"users",r,"invitations",i.matchId.toString()),{matchId:i.matchId,matchName:i.matchName,invitedBy:e.email,invitedByUid:e.uid,timestamp:new Date().toISOString(),status:"pending"}),console.log("✅ Invitasjon sendt!"),{success:!0}}catch(s){return console.error("❌ Send invitation error:",s),{success:!1,error:s.message}}}async function fe(t){const i=L();if(!i)return[];try{const e=t.toLowerCase().trim();if(e.length===0)return[];console.log("🔍 Søker etter brukere:",e);const s=await ve(W(y,"users")),a=[];return s.forEach(o=>{const r=o.data(),p=`${r.firstName||""} ${r.lastName||""}`.toLowerCase(),g=(r.email||"").toLowerCase();o.id!==i.uid&&(p.includes(e)||g.includes(e))&&a.push({uid:o.id,email:r.email,firstName:r.firstName||"",lastName:r.lastName||"",displayName:`${r.firstName||""} ${r.lastName||""}`.trim()})}),console.log(`✅ Fant ${a.length} brukere`),a}catch(e){return console.error("❌ Search users error:",e),[]}}async function ht(t){const i=L();if(!i)return{success:!1,error:"Not authenticated"};try{return await D(x(y,"matches",t.toString()),{participants:Ee(i.uid)}),await D(x(y,"users",i.uid,"invitations",t.toString()),{status:"accepted"}),{success:!0}}catch(e){return console.error("Accept invitation error:",e),{success:!1,error:e.message}}}async function ft(t){const i=L();if(!i)return{success:!1,error:"Not authenticated"};try{return await D(x(y,"users",i.uid,"invitations",t.toString()),{status:"declined"}),{success:!0}}catch(e){return console.error("Decline invitation error:",e),{success:!1,error:e.message}}}function bt(t){const i=L();if(!i)return()=>{};const e=W(y,"users",i.uid,"invitations"),s=ae(e,ne("status","==","pending"));return ue(s,a=>{const o=[];a.forEach(r=>{o.push({id:r.id,...r.data()})}),t(o)})}let d,k=null,A="all",b=[],G=null,K=null;const yt={no:{tracker:"INSIGHT",tagline:"Analyse. Prognose. Resultat.",home:"Hjem",matches:"Matcher",prognosis:"Prognose",results:"Live",profile:"Profil",leading:"LEDER",behind:"BAK",active:"Aktiv",no_match_selected:"Ingen match valgt",new_match:"Ny match",match_name:"Matchnavn",location:"Sted",date:"Dato",type:"Type",planned_stages:"Antall stages",save:"Lagre",cancel:"Avbryt",delete:"Slett",edit_profile:"Rediger profil",first_name:"Fornavn",last_name:"Etternavn",club:"Klubb",region:"Region",category:"Kategori",division:"Divisjon",power_factor:"Power Factor",draw_seconds:"Trekk (s)",reload_seconds:"Reload (s)",save_profile:"Lagre profil",logout:"Logg ut",matches_count:"Matcher",stages_count:"Stages",avg_hf:"Snitt HF",a_rate:"A-andel",shots:"Skudd",targets:"Skiver",steel:"Stål",move_seconds:"Beveg. (s)",calculate:"Beregn",add_shooter:"Legg til skytter",add_result:"Legg til resultat",save_shooter:"Lagre skytter",save_result:"Lagre resultat",match_types_trening:"Trening",match_types_level1:"Level 1",match_types_level2:"Level 2",match_types_level3:"Level 3",match_types_level4:"Level 4",match_types_level5:"Level 5",allow_search:"Tillat at andre kan finne denne matchen",search_match_placeholder:"Skriv inn match-ID (f.eks. 12345)",select_power_factor:"Velg Power Factor",stages_added_later:"Stages legges til senere",edit_match:"Rediger match",create_stage:"Opprett stage",edit_stage:"Rediger stage",stage_number:"Nummer",stage_name:"Navn",paper_targets:"Paper targets",poppers:"Poppers",plates:"Plates",no_shoots:"No-Shoots",bonus_paper_targets:"Bonus Paper targets",included:"Included",invite_user:"Invite user",invite:"Invite",search_user_email:"Search for user email",invitation_sent:"Invitation sent",invitations:"Invitations",accept:"Accept",decline:"Decline",invited_to_match:"You are invited to",no_invitations:"No invitations",invite_user:"Inviter bruker",invite:"Inviter",search_user_email:"Søk etter brukers e-post",invitation_sent:"Invitasjon sendt",invitations:"Invitasjoner",accept:"Aksepter",decline:"Avvis",invited_to_match:"Du er invitert til",no_invitations:"Ingen invitasjoner"},en:{tracker:"INSIGHT",tagline:"Analysis. Prognosis. Results.",home:"Home",matches:"Matches",prognosis:"Prognosis",results:"Live",profile:"Profile",leading:"LEADING",behind:"BEHIND",active:"Active",no_match_selected:"No match selected",new_match:"New Match",match_name:"Match Name",location:"Location",date:"Date",type:"Type",planned_stages:"Number of stages",save:"Save",cancel:"Cancel",delete:"Delete",edit_profile:"Edit Profile",first_name:"First Name",last_name:"Last Name",club:"Club",region:"Region",category:"Category",division:"Division",power_factor:"Power Factor",draw_seconds:"Draw (s)",reload_seconds:"Reload (s)",save_profile:"Save Profile",logout:"Log Out",matches_count:"Matches",stages_count:"Stages",avg_hf:"Avg HF",a_rate:"A-rate",shots:"Shots",targets:"Targets",steel:"Steel",move_seconds:"Move (s)",calculate:"Calculate",add_shooter:"Add Shooter",add_result:"Add Result",save_shooter:"Save Shooter",save_result:"Save Result",match_types_trening:"Training",match_types_level1:"Level 1",match_types_level2:"Level 2",match_types_level3:"Level 3",match_types_level4:"Level 4",match_types_level5:"Level 5",allow_search:"Allow others to find this match",search_match_placeholder:"Enter match ID (e.g. 12345)",select_power_factor:"Select Power Factor",stages_added_later:"Stages will be added later"}};let Me="no";function n(t){return yt[Me][t]||t}const wt={Standard:{minor:21,major:21},Open:{minor:29,major:29},Production:{minor:15,major:15},"Production Optics":{minor:15,major:15},"Production Optics Carbine":{minor:15,major:15},Classic:{minor:10,major:8},Revolver:{minor:8,major:6},"Pistol Caliber Carbine":{minor:30,major:30},"Pistol Caliber Carbine Optics":{minor:30,major:30},Optics:{minor:21,major:21}},kt=["Standard","Open","Production","Production Optics","Production Optics Carbine","Classic","Revolver","Pistol Caliber Carbine","Pistol Caliber Carbine Optics"],xt={Standard:["minor","major"],Open:["minor","major"],Production:["minor"],"Production Optics":["minor"],"Production Optics Carbine":["minor"],Classic:["minor","major"],Revolver:["minor","major"],"Pistol Caliber Carbine":["minor","major"],"Pistol Caliber Carbine Optics":["minor","major"]},St=["—","Junior","Senior","Super Senior","Lady","Lady Junior","Lady Senior"],Pt=["Norge","Sverige","Danmark","Finland","Tyskland","Storbritannia","USA","Annet"];function Lt(t,i){const e=wt[t];return e&&(e[i]||e.minor)||15}function Te(t,i,e){return Math.max(0,Math.ceil(t/Lt(i,e))-1)}function Et(){const t=b.find(m=>m.id==k);if(!t||!t.stages||t.stages.length===0)return null;const i=t.stages.filter(m=>m.time&&m.pts);if(i.length===0)return null;const e=d.division||"Classic",s=d.powerFactor||"minor",a=d.draw||1.42,o=d.reloadTime||1.8;let r=0,p=0;for(const m of i){const v=(m.paperTargets||0)*2+(m.poppers||0)+(m.plates||0);if(v===0)continue;const h=Te(v,e,s),E=m.time-a-h*o;E>0&&(r+=v,p+=E)}return r===0?null:{avgSplit:p/r,completedStages:i.length,totalStages:t.stages.length}}function j(t){return t.charAt(0).toUpperCase()+t.slice(1)}function _e(t){if(!t)return"";try{const i=Me==="no"?"nb-NO":"en-US";return new Date(t).toLocaleDateString(i,{day:"numeric",month:"short",year:"numeric"})}catch{return t}}function l(t){return document.getElementById(t)}function f(t){const i=l(t);return i?i.value:""}function q(t,i){const e=parseFloat(f(t));return isNaN(e)?i||0:e}function S(t,i){const e=parseInt(f(t));return isNaN(e)?i||0:e}function B(){const t=(d==null?void 0:d.firstName)||"",i=(d==null?void 0:d.lastName)||"";return(t.charAt(0)+i.charAt(0)).toUpperCase()||"U"}async function It(t){var s;const i=await lt(),e=me();if(i?d=i:d={firstName:e.name||((s=e.email)==null?void 0:s.split("@")[0])||"",lastName:"",division:"",category:"",powerFactor:"",region:"",club:"",draw:null,reloadTime:null},b=await vt(),b&&b.length>0){const a=new Date,o=b.filter(r=>r.status!=="finished"&&r.date);if(o.length>0){let r=o[0],p=Math.abs(new Date(o[0].date)-a);for(const g of o){const m=new Date(g.date),v=Math.abs(m-a);v<p&&(p=v,r=g)}k=r.id}}G&&G(),G=ut(a=>{b=a,H(),N()}),bt(a=>{T=a,we()}),t.innerHTML=`
<div class="phone">
  ...
  <div class="scroll-content">
    ...
    <div class="card">
      ...
      <div class="prognose-result">
        <div class="prog-pf-note" id="prog-pf-note">${d.powerFactor?j(d.powerFactor):"Minor"} · ${d.division||"Classic"}</div>
  ...
  <div class="scroll-content">
    <div class="profile-header">
      ...
      <div class="profile-badges">
        <span class="badge badge-gold" id="prof-badge-pf">${d.powerFactor?j(d.powerFactor):"—"}</span>
    ...
    <div class="card">
      ...
      <div class="info-row">
        ...
        <span id="info-pf">${d.powerFactor?j(d.powerFactor):"—"}</span>
      </div>
      <div class="info-row">
...
<div class="modal-overlay" id="modal-confirm-delete" onclick="closeModalOutside(event,'modal-confirm-delete')">
  ...
  `,Mt(),Ne(),N(),H(),$e(),le()}function Mt(){window.switchTab=Tt,window.setFilter=Ct,window.openModal=$,window.closeModal=P,window.closeModalOutside=_t,window.createMatch=Nt,window.searchMatchByIdHandler=$t,window.openEditProfile=ii,window.saveProfileData=ai,window.selectPF=si,window.updatePFOptions=Fe,window.calcPrognose=le,window.renderMatchList=H,window.selectMatch=Ft,window.addShooter=ni,window.addStageResult=ri,window.handleLogout=oi,window.openEditMatch=Bt,window.saveEditMatch=Dt,window.openCreateStage=be,window.openCreateStageFromEdit=jt,window.openCreateStageFromNewMatch=Ot,window.openEditStage=Ut,window.changeStageNumber=Ht,window.changeStageField=zt,window.saveStage=Vt,window.openInviteUser=Gt,window.openInvitationsModal=Xt,window.acceptInvitation=ei,window.declineInvitation=ti,window.searchUsers=Kt,window.toggleUserSelection=qt,window.sendMultipleInvitations=Jt,window.searchUsersNewMatch=Wt,window.toggleUserNewMatch=Yt,window.searchUsersEditMatch=Qt,window.toggleUserEditMatch=Zt,window.confirmDeleteMatch=Rt,window.deleteMatchConfirmed=At}function Tt(t){document.querySelectorAll(".screen").forEach(s=>s.classList.remove("active")),document.querySelectorAll(".tab-item").forEach(s=>s.classList.remove("active")),l(t).classList.add("active");const i=["screen-home","screen-matches","screen-prognose","screen-results","screen-profile"].indexOf(t),e=document.querySelectorAll(".tab-item");e[i]&&e[i].classList.add("active"),t==="screen-home"&&N(),t==="screen-matches"&&H(),t==="screen-results"&&ie()}function $(t){l(t).classList.add("open")}function P(t){l(t).classList.remove("open")}function _t(t,i){t.target.id===i&&P(i)}function Ct(t,i){A=t,document.querySelectorAll(".filter-chip").forEach(e=>e.classList.remove("active")),i.classList.add("active"),H()}async function Nt(){var e;const t={name:f("new-match-name")||"Ny match",type:f("new-match-type")||"Trening",date:f("new-match-date")||new Date().toISOString().split("T")[0],location:f("new-match-location")||"",plannedStages:S("new-match-stages",6),searchable:((e=l("new-match-searchable"))==null?void 0:e.checked)!==!1,status:"active",stages:[],shooters:[],stageDefs:[]},i=await ct(t);if(i.success){let s=0;for(const a of O)(await he(a.email,{matchId:i.matchId,matchName:t.name})).success&&s++;P("modal-new-match"),l("new-match-name").value="",l("new-match-location").value="",l("new-match-stages").value="6",l("new-match-searchable")&&(l("new-match-searchable").checked=!0),l("new-match-user-search").value="",l("new-match-search-results").innerHTML="",O=[],s>0&&alert(`Match opprettet! Invitasjoner sendt til ${s} bruker(e).`)}else alert("Kunne ikke opprette match: "+i.error)}async function $t(){const t=f("match-id-search").trim();if(!t){alert("Skriv inn et match-ID");return}const i=await gt(t);i.success?(alert(`Match funnet: ${i.match.name} (ID: ${i.match.id})`),l("match-id-search").value=""):alert(`Fant ingen match med ID ${t}${i.error?": "+i.error:""}`)}function Ft(t){k=t;const i=b.find(e=>e.id==t);if(i){const e=i.id?"Match ID "+i.id+" "+i.name:i.name||"Match";["home-chip-name","prog-chip-name","results-chip-name"].forEach(a=>{const o=l(a);o&&(o.textContent=e)})}K&&K(),t&&(K=mt(t,e=>{const s=b.findIndex(a=>a.id==t);s!==-1&&e&&(b[s]=e,N(),ie())})),N(),ie(),le()}function Bt(){const t=b.find(s=>s.id==k);if(!t){alert("Ingen match valgt");return}l("edit-match-name").value=t.name||"",l("edit-match-type").value=t.type||"Trening",l("edit-match-date").value=t.date||"",l("edit-match-location").value=t.location||"",l("edit-match-stages").value=t.plannedStages||0,l("edit-match-searchable")&&(l("edit-match-searchable").checked=t.searchable!==!1),l("edit-match-finished")&&(l("edit-match-finished").checked=t.status==="finished"),l("edit-match-user-search").value="",l("edit-match-search-results").innerHTML="",U=[];const i=me(),e=l("delete-match-btn");e&&i&&t.ownerId===i.uid?e.style.display="block":e&&(e.style.display="none"),$("modal-edit-match")}async function Dt(){var s,a;const t=b.find(o=>o.id==k);if(!t){alert("Ingen match valgt");return}const i={name:f("edit-match-name")||t.name,type:f("edit-match-type")||t.type,date:f("edit-match-date")||t.date,location:f("edit-match-location")||t.location,plannedStages:S("edit-match-stages",t.plannedStages),searchable:((s=l("edit-match-searchable"))==null?void 0:s.checked)!==!1,status:(a=l("edit-match-finished"))!=null&&a.checked?"finished":"active"},e=await oe(t.id,i);if(e.success){let o=0;for(const r of U)(await he(r.email,{matchId:t.id,matchName:i.name})).success&&o++;P("modal-edit-match"),o>0&&alert(`Match oppdatert! Invitasjoner sendt til ${o} bruker(e).`)}else alert("Kunne ikke oppdatere match: "+e.error)}function Rt(){const t=b.find(e=>e.id==k);if(!t){alert("Ingen match valgt");return}const i=t.id?"Match ID "+t.id+" "+t.name:t.name;l("delete-match-name").textContent=i,$("modal-confirm-delete")}async function At(){const t=b.find(e=>e.id==k);if(!t){alert("Ingen match valgt");return}const i=await pt(t.id);i.success?(P("modal-confirm-delete"),P("modal-edit-match"),k=null,N(),H(),alert("Match slettet")):alert("Kunne ikke slette match: "+i.error)}let te=null;function be(){var i;const t=b.find(e=>e.id==k);if(!t){alert("Ingen match valgt");return}te=null,l("stage-modal-title").textContent=n("create_stage"),l("stage-number").value=(((i=t.stages)==null?void 0:i.length)||0)+1,l("stage-name").value="",l("stage-paper-targets").value=0,l("stage-poppers").value=0,l("stage-plates").value=0,l("stage-no-shoots").value=0,l("stage-bonus-paper-targets").value=0,l("stage-bonus-included").checked=!1,$("modal-create-stage")}function jt(){P("modal-edit-match"),be()}function Ot(){P("modal-new-match"),be()}function Ut(t){const i=b.find(s=>s.id==k);if(!i||!i.stages||!i.stages[t]){alert("Stage ikke funnet");return}te=t;const e=i.stages[t];l("stage-modal-title").textContent=n("edit_stage"),l("stage-number").value=e.number||t+1,l("stage-name").value=e.name||"",l("stage-paper-targets").value=e.paperTargets||0,l("stage-poppers").value=e.poppers||0,l("stage-plates").value=e.plates||0,l("stage-no-shoots").value=e.noShoots||0,l("stage-bonus-paper-targets").value=e.bonusPaperTargets||0,l("stage-bonus-included").checked=e.bonusIncluded||!1,$("modal-create-stage")}function Ht(t){const i=l("stage-number"),e=Math.max(1,parseInt(i.value)+t);i.value=e}function zt(t,i){const e=l("stage-"+t),s=Math.max(0,parseInt(e.value)+i);e.value=s}async function Vt(){var a;const t=b.find(o=>o.id==k);if(!t){alert("Ingen match valgt");return}const i={number:S("stage-number",1),name:f("stage-name")||"",paperTargets:S("stage-paper-targets",0),poppers:S("stage-poppers",0),plates:S("stage-plates",0),noShoots:S("stage-no-shoots",0),bonusPaperTargets:S("stage-bonus-paper-targets",0),bonusIncluded:((a=l("stage-bonus-included"))==null?void 0:a.checked)||!1},e=t.stages||[];te!==null?e[te]=i:e.push(i);const s=await oe(t.id,{stages:e});s.success?P("modal-create-stage"):alert("Kunne ikke lagre stage: "+s.error)}let T=[],I=[],O=[],U=[];function Gt(){if(!k){alert("Ingen match valgt");return}I=[],l("user-search-input").value="",l("user-search-results").innerHTML="",l("send-invitations-btn").style.display="none",$("modal-invite-user")}async function Kt(){const t=f("user-search-input").trim();if(t.length===0){l("user-search-results").innerHTML='<p style="color:#9ca3af;text-align:center;">Skriv inn et søk</p>';return}const i=await fe(t),e=l("user-search-results");if(!e)return;if(i.length===0){e.innerHTML='<p style="color:#9ca3af;text-align:center;">Ingen brukere funnet</p>';return}let s='<div style="margin-bottom:10px;font-weight:600;">RESULTATER ('+i.length+"):</div>";i.forEach(a=>{const o=a.displayName||a.email,r=I.some(g=>g.uid===a.uid),p=o.replace(/'/g,"\\'");s+=`
    ...
    `}),e.innerHTML=s,Ce()}function qt(t,i,e){const s=I.findIndex(a=>a.uid===t);s>-1?I.splice(s,1):I.push({uid:t,email:i,displayName:e}),Ce()}function Ce(){const t=l("send-invitations-btn");t&&(I.length>0?(t.style.display="block",t.textContent=`Send invitasjoner (${I.length} valgt)`):t.style.display="none")}async function Jt(){if(I.length===0){alert("Ingen brukere valgt");return}const t=b.find(s=>s.id==k);if(!t)return;let i=0,e=0;for(const s of I)(await he(s.email,{matchId:t.id,matchName:t.name})).success?i++:e++;P("modal-invite-user"),i>0&&alert(`Invitasjoner sendt til ${i} bruker(e)!`),e>0&&alert(`${e} invitasjon(er) feilet.`),I=[]}async function Wt(){const t=f("new-match-user-search").trim();if(t.length===0){l("new-match-search-results").innerHTML="";return}const i=await fe(t),e=l("new-match-search-results");if(!e)return;if(i.length===0){e.innerHTML='<p style="color:#9ca3af;text-align:center;font-size:14px;">Ingen brukere funnet</p>';return}let s='<div style="margin-bottom:8px;font-size:14px;font-weight:600;">RESULTATER ('+i.length+"):</div>";i.forEach(a=>{const o=a.displayName||a.email,r=O.some(g=>g.uid===a.uid),p=o.replace(/'/g,"\\'");s+=`
    ...
    `}),e.innerHTML=s}function Yt(t,i,e){const s=O.findIndex(a=>a.uid===t);s>-1?O.splice(s,1):O.push({uid:t,email:i,displayName:e})}async function Qt(){console.log("🔍 searchUsersEditMatch called");const t=f("edit-match-user-search").trim();if(console.log("📝 Search term:",t),t.length===0){console.log("⚠️ Empty search term"),l("edit-match-search-results").innerHTML="";return}console.log("🌐 Calling searchUsersByNameOrEmail...");const i=await fe(t);console.log("✅ Results received:",i);const e=l("edit-match-search-results");if(!e){console.error("❌ Container not found: edit-match-search-results");return}if(i.length===0){console.log("⚠️ No users found"),e.innerHTML='<p style="color:#9ca3af;text-align:center;font-size:14px;">Ingen brukere funnet</p>';return}console.log("🎨 Rendering",i.length,"results");let s='<div style="margin-bottom:8px;font-size:14px;font-weight:600;">RESULTATER ('+i.length+"):</div>";i.forEach(a=>{const o=a.displayName||a.email,r=U.some(g=>g.uid===a.uid),p=o.replace(/'/g,"\\'");s+=`
      <label style="display:flex;align-items:center;gap:8px;padding:8px;background:#2d3748;border-radius:8px;margin-bottom:6px;cursor:pointer;font-size:14px;">
    ...
    `}),e.innerHTML=s,console.log("✅ HTML rendered to container")}function Zt(t,i,e){const s=U.findIndex(a=>a.uid===t);s>-1?U.splice(s,1):U.push({uid:t,email:i,displayName:e})}function Xt(){ye(),$("modal-invitations")}function ye(){const t=l("invitations-list");if(!t)return;if(!T||T.length===0){t.innerHTML='<div class="empty-state"><div class="empty-sub">'+n("no_invitations")+"</div></div>";return}let i="";T.forEach((e,s)=>{i+='<div class="card" style="margin-bottom:10px;">',i+='<div style="margin-bottom:10px;"><strong>'+n("invited_to_match")+"</strong></div>",i+='<div style="margin-bottom:10px;">Match ID '+e.matchId+" "+e.matchName+"</div>",i+='<div style="margin-bottom:10px;color:#94a3b8;">Fra: '+e.invitedBy+"</div>",i+='<div style="display:flex;gap:10px;">',i+='<button class="btn-primary" onclick="acceptInvitation('+s+')" style="flex:1;">'+n("accept")+"</button>",i+='<button onclick="declineInvitation('+s+')" style="flex:1;padding:12px;background:#374151;color:white;border:none;border-radius:8px;font-weight:600;cursor:pointer;">'+n("decline")+"</button>",i+="</div>",i+="</div>"}),t.innerHTML=i}async function ei(t){const i=T[t];if(!i)return;const e=await ht(i.matchId);e.success?(T.splice(t,1),we(),ye()):alert("Kunne ikke akseptere invitasjon: "+e.error)}async function ti(t){const i=T[t];if(!i)return;const e=await ft(i.matchId);e.success?(T.splice(t,1),we(),ye()):alert("Kunne ikke avvise invitasjon: "+e.error)}function we(){const t=l("invitation-badge");if(!t)return;const i=T.length;i>0?(t.textContent=i,t.style.display="flex"):t.style.display="none"}function N(){var a,o;const t=l("home-content");if(!t)return;const i=b.find(r=>r.id==k);if(!i){t.innerHTML=`
    ...
    `;return}let e="";e+='<div class="card">',e+='<div class="mhc-name">'+i.name+"</div>",e+='<div class="mhc-meta">'+_e(i.date)+" · "+i.type+"</div>",e+='<div class="mhc-stats">',e+='<div><div class="mhc-val">'+(((a=i.stages)==null?void 0:a.length)||0)+'</div><div class="mhc-lbl">Stages</div></div>',e+='<div><div class="mhc-val">'+(((o=i.shooters)==null?void 0:o.length)||0)+'</div><div class="mhc-lbl">Skyttere</div></div>',e+="</div>",e+='<div style="display:flex;gap:10px;margin-top:15px;">',e+='<button class="btn-primary" onclick="openEditMatch()" style="flex:1;">Rediger match</button>',e+='<button class="btn-primary" onclick="openCreateStage()" style="flex:1;">Ny stage</button>',e+="</div>",e+='<div style="margin-top:10px;">',e+='<button class="btn-primary" onclick="openInviteUser()" style="width:100%;">Inviter bruker</button>',e+="</div>";const s=me();s&&i.ownerId===s.uid&&(e+='<div style="margin-top:10px;">',e+='<button onclick="confirmDeleteMatch()" style="width:100%;padding:12px;background:#ef4444;color:white;border:none;border-radius:8px;font-weight:600;cursor:pointer;">Slett match</button>',e+="</div>"),e+="</div>",i.stages&&i.stages.length>0&&(e+='<div class="section-title">Stages</div>',e+='<div class="card">',i.stages.forEach((r,p)=>{e+='<div class="stage-row" style="cursor:pointer;border-bottom:1px solid #2d3748;padding:12px 0;" onclick="openEditStage('+p+')">',e+='<div class="stage-num">S'+(r.number||p+1)+"</div>",e+='<div class="stage-info">',e+='<div class="stage-name">'+(r.name||"Stage "+(r.number||p+1))+"</div>",e+='<div class="stage-meta">',r.paperTargets&&(e+="Paper: "+r.paperTargets+" "),r.poppers&&(e+="Poppers: "+r.poppers+" "),r.plates&&(e+="Plates: "+r.plates+" "),r.noShoots&&(e+="NS: "+r.noShoots+" "),r.bonusPaperTargets&&(e+="Bonus: "+r.bonusPaperTargets+(r.bonusIncluded?" (included)":"")),e+="</div>",e+="</div>",e+="</div>"}),e+="</div>"),t.innerHTML=e}function H(){const t=l("match-list-container");if(!t)return;let i=b.filter(s=>{if(A==="all")return!0;if(A==="active")return s.status!=="finished";if(A==="trening")return s.type==="Trening";if(A==="stevne")return s.type==="Stevne";const a=s.date?new Date(s.date).getFullYear().toString():"";return A===a});if(i.length===0){t.innerHTML='<div class="empty-state"><div class="empty-sub">Ingen matcher funnet</div></div>';return}let e="";i.forEach(s=>{var r;const a=s.id===k,o=s.id?"Match ID "+s.id+" "+s.name:s.name;e+='<div class="match-row">',e+='<div class="match-row-icon'+(a?" is-active":"")+`" onclick="selectMatch('`+s.id+`')">🏆</div>`,e+=`<div class="match-row-info" onclick="selectMatch('`+s.id+`')">`,e+='<div class="match-row-name">'+o+"</div>",e+='<div class="match-row-meta">'+_e(s.date)+" · "+(s.location||s.type)+"</div>",e+="</div>",e+='<div class="match-row-right">',e+=`<button onclick="event.stopPropagation(); selectMatch('`+s.id+`'); openEditMatch();" style="padding:8px 16px;background:#e8b84b;color:#1a202c;border:none;border-radius:8px;font-weight:600;cursor:pointer;margin-bottom:8px;">Rediger</button>`,e+='<div class="match-stg-count">'+(((r=s.stages)==null?void 0:r.length)||0)+"</div>",e+='<div class="match-stg-lbl">stages</div>',e+="</div>",e+="</div>"}),t.innerHTML=e}function ie(){var o;const t=l("results-content");if(!t)return;const i=b.find(r=>r.id===k);if(!i){t.innerHTML='<div class="empty-state"><div class="empty-sub">Velg en match først</div></div>';return}if(!i.shooters||i.shooters.length===0){t.innerHTML='<div class="empty-state"><div class="empty-icon">👥</div><div class="empty-title">Ingen skyttere</div><div class="empty-sub">Trykk + for å legge til skyttere</div></div>';return}let e='<div class="card">';e+='<div class="card-header"><div class="card-title">Standings</div></div>',e+='<div class="standings-table-wrap"><table class="standings-table">',e+='<thead><tr class="standings-header-row">',e+='<th class="standings-th standings-th-rank">#</th>',e+='<th class="standings-th standings-th-shooter">Skytter</th>',e+='<th class="standings-th standings-th-pts">Pts</th>',e+='<th class="standings-th standings-th-pct">%</th>',e+="</tr></thead>",e+="<tbody>";const s=i.shooters.map(r=>{var g;const p=((g=r.stages)==null?void 0:g.reduce((m,v)=>m+(v.pts||0),0))||0;return{...r,totalPts:p}}).sort((r,p)=>p.totalPts-r.totalPts),a=((o=s[0])==null?void 0:o.totalPts)||0;s.forEach((r,p)=>{const g=a>0?(r.totalPts/a*100).toFixed(2):"0.00";e+='<tr class="standings-row">',e+='<td class="standings-td standings-td-rank">'+(p+1)+"</td>",e+='<td class="standings-td standings-td-shooter">',e+='<div class="standings-shooter-name">'+r.firstName+" "+r.lastName+"</div>",e+='<div class="standings-shooter-meta">'+r.division+" · "+j(r.pf||"minor")+"</div>",e+="</td>",e+='<td class="standings-td standings-td-pts">'+r.totalPts.toFixed(2)+"</td>",e+='<td class="standings-td standings-td-pct">'+g+"%</td>",e+="</tr>"}),e+="</tbody></table></div>",e+="</div>",t.innerHTML=e}function Ne(){const t=B();["prof-avatar","nav-av-home","nav-av-matches","nav-av-prog","nav-av-results"].forEach(p=>{const g=l(p);g&&(g.textContent=t)});const e=l("prof-name");e&&(e.textContent=(d.firstName||"")+" "+(d.lastName||""));const s=l("prof-div");s&&(s.textContent=(d.division||"—")+" · "+(d.club||"—"));const a=l("prof-badge-pf");a&&(a.textContent=d.powerFactor?j(d.powerFactor):"—");const o=l("prof-badge-region");o&&(o.textContent=d.region||"—");const r={"info-firstname":d.firstName||"—","info-lastname":d.lastName||"—","info-division":d.division||"—","info-category":d.category||"—","info-pf":d.powerFactor?j(d.powerFactor):"—","info-region":d.region||"—","info-club":d.club||"—"};Object.keys(r).forEach(p=>{const g=l(p);g&&(g.textContent=r[p])}),$e()}function $e(){const t=[];b.forEach(h=>{h.stages&&h.stages.forEach(E=>t.push(E))});let i=0,e=0,s=0;t.forEach(h=>{i+=h.a||0,e+=(h.a||0)+(h.c||0)+(h.d||0),s+=h.hf||0});const a=t.length?(s/t.length).toFixed(2):"—",o=e?Math.round(i/e*100)+"%":"—",r=l("stat-matches");r&&(r.textContent=b.length);const p=l("stat-stages");p&&(p.textContent=t.length);const g=l("stat-avg-hf");g&&(g.textContent=a);const m=l("stat-a-rate");m&&(m.textContent=o);const v=l("prog-a-rate");v&&(v.textContent=o)}function ii(){l("edit-firstname").value=d.firstName||"",l("edit-lastname").value=d.lastName||"",l("edit-club").value=d.club||"",l("edit-draw").value=d.draw||"",l("edit-reload").value=d.reloadTime||"";let t="";kt.forEach(s=>{t+='<option value="'+s+'"'+(s===d.division?" selected":"")+">"+s+"</option>"}),l("edit-division").innerHTML=t;let i="";St.forEach(s=>{i+='<option value="'+s+'"'+(s===d.category?" selected":"")+">"+s+"</option>"}),l("edit-category").innerHTML=i;let e="";Pt.forEach(s=>{e+='<option value="'+s+'"'+(s===d.region?" selected":"")+">"+s+"</option>"}),l("edit-region").innerHTML=e,Fe(),$("modal-edit-profile")}function Fe(){const t=f("edit-division"),i=xt[t]||["minor","major"];let e="";i.forEach(s=>{const a=d.powerFactor===s;e+='<label class="pf-option'+(a?" active":"")+`" onclick="selectPF(this,'`+s+`')">`,e+='<input type="radio" name="pf" value="'+s+'">',e+='<div class="pf-label">'+s.toUpperCase()+"</div>",e+='<div class="pf-sub">'+(s==="major"?"≥170 PF":"<170 PF")+"</div>",e+="</label>"}),l("pf-options").innerHTML=e,i.indexOf(d.powerFactor)<0&&(d.powerFactor=i[0])}function si(t,i){document.querySelectorAll(".pf-option").forEach(e=>e.classList.remove("active")),t.classList.add("active"),d.powerFactor=i}async function ai(){d.firstName=f("edit-firstname").trim()||"",d.lastName=f("edit-lastname").trim()||"",d.division=f("edit-division")||"",d.category=f("edit-category")||"",d.region=f("edit-region")||"",d.club=f("edit-club").trim()||"",d.draw=q("edit-draw")||null,d.reloadTime=q("edit-reload")||null;const t=await ot(d),i=l("save-profile-btn");t.success?(i.textContent="✓ Lagret!",i.style.background="var(--green)",setTimeout(()=>{i.textContent=n("save_profile"),i.style.background=""},1800)):(i.textContent="❌ Feil!",i.style.background="var(--red)",setTimeout(()=>{i.textContent=n("save_profile"),i.style.background=""},1800)),Ne(),le(),N(),P("modal-edit-profile")}function le(){const t=S("prog-shots",12),i=S("prog-targets",6),e=S("prog-steel",2),s=q("prog-move",3),a=q("prog-draw",d.draw||1.42),o=d.division||"Classic",r=d.powerFactor||"minor",p=Te(t,o,r);l("prog-reloads").value=p;const g=d.reloadTime||1.8,m=Et();let v=.18;m&&m.avgSplit&&(v=m.avgSplit),l("prog-split-display")&&(l("prog-split-display").textContent=v.toFixed(3)+"s");const h=a+t*v+p*g+s,E=i*10+e*10,R=h>0?E/h:0;l("prog-hf-out").textContent=R.toFixed(2);let w="";w+='<div class="prog-breakdown-detail">',w+="Trekk: "+a.toFixed(2)+"s · ",w+="Skudd: "+(t*v).toFixed(2)+"s · ",w+="Reload: "+(p*g).toFixed(2)+"s · ",w+="Beveg: "+s.toFixed(2)+"s",w+="</div>",m?(w+='<div class="prog-breakdown-detail" style="margin-top:8px;color:var(--muted);font-size:12px;">',w+="Basert på "+m.completedStages+" av "+m.totalStages+" stages (t/skudd: "+v.toFixed(3)+"s)",w+="</div>"):(w+='<div class="prog-breakdown-detail" style="margin-top:8px;color:var(--muted);font-size:12px;">',w+="Ingen data ennå - bruker standard 0.18s split",w+="</div>"),l("prog-breakdown").innerHTML=w}async function ni(){const t=b.find(o=>o.id===k);if(!t)return;const i=f("new-shooter-firstname").trim(),e=f("new-shooter-lastname").trim(),s=f("new-shooter-division")||"Classic";if(!i||!e){alert("Fyll inn navn");return}const a={id:"s_"+Date.now(),isMe:!1,firstName:i,lastName:e,division:s,pf:"minor",club:"",stages:[]};t.shooters||(t.shooters=[]),t.shooters.push(a),await oe(t.id,t),P("modal-add-shooter"),ie()}async function ri(){const t=b.find(r=>r.id===k);if(!t)return;const i=S("new-result-stage",1),e=q("new-result-time",0),s=S("new-result-points",0),a=e>0?s/e:0,o={num:i,name:"Stage "+i,hf:a,time:e,pts:s,pf:d.powerFactor||"minor"};t.stages||(t.stages=[]),t.stages.push(o),await oe(t.id,t),P("modal-add"),N()}async function oi(){G&&G(),K&&K(),await tt(),window.location.reload()}const Be=document.getElementById("app");function li(){rt(Be,De)}function De(){It(Be)}Ze(t=>{t?De():li()});
