...
\
 ...
 <p>Vi behandler f\'f8lgende personopplysninger om deg:</p>\
 <ul>\
 ...
 <li><strong>Invitasjonskode:</strong> For \'e5 verifisere din tilgang til tjenesten</li>\
 </ul>\
\
 <h3>3. Form\'e5l og behandlingsgrunnlag</h3>\
 <p>Vi behandler dine personopplysninger for f\'f8lgende form\'e5l:</p>\
 <ul>\
 <li><strong>Brukerkonto og autentisering:</strong> For \'e5 opprette og administrere din konto (behandlingsgrunnlag: samtykke)</li>\
 <li><strong>Treningsanalyse:</strong> For \'e5 gi deg innsikt i dine prestasjoner og treningsutvikling (behandlingsgrunnlag: samtykke)</li>\
 <li><strong>Deling av match-data:</strong> For \'e5 dele resultater med andre brukere du inviterer (behandlingsgrunnlag: samtykke)</li>\
 <li><strong>Teknisk drift:</strong> For \'e5 sikre at tjenesten fungerer korrekt (behandlingsgrunnlag: berettiget interesse)</li>\
 </ul>\
\
 <h3>4. Lagring og teknisk l\'f8sning</h3>\
 <p>Dine opplysninger lagres og behandles ved hjelp av:</p>\
 <ul>\
 <li><strong>Google Firebase Authentication:</strong> Sikker h\'e5ndtering av p\'e5logging og brukerkonto</li>\
 ...
 <p>\
 Alle tjenester er hostet i EU/E\'d8S-regionen og f\'f8lger GDPR-kravene. \
 Google Firebase er sertifisert under EU-U.S. Data Privacy Framework.\
 </p>\
\
 <h3>5. Deling av opplysninger</h3>\
 <p>Dine personopplysninger deles kun i f\'f8lgende tilfeller:</p>\
 <ul>\
 <li><strong>Match-deltakere:</strong> N\'e5r du inviterer andre brukere til \'e5 se eller samarbeide om en match, vil de se dine match-resultater og ditt navn</li>\
 <li><strong>Tekniske leverand\'f8rer:</strong> Google Firebase og GitHub (databehandlere) har tilgang til opplysningene som n\'f8dvendig for \'e5 levere tjenesten</li>\
 </ul>\
 <p>Vi selger eller utleverer aldri dine opplysninger til tredjeparter for markedsf\'f8ringsform\'e5l.</p>\
\
 <h3>6. Lagringstid</h3>\
 <p>\
 Dine personopplysninger lagres s\'e5 lenge du har en aktiv konto hos oss. \
 N\'e5r du sletter kontoen din, vil alle dine personopplysninger bli slettet innen 30 dager.\
 Match-data du har delt med andre brukere vil fortsatt v\'e6re synlig for dem, men koblingen til din konto fjernes.\
 </p>\
\
 <h3>7. Dine rettigheter</h3>\
 <p>Du har f\'f8lgende rettigheter knyttet til dine personopplysninger:</p>\
 <ul>\
 <li><strong>Innsyn:</strong> Du kan n\'e5r som helst be om \'e5 f\'e5 innsyn i hvilke opplysninger vi har om deg</li>\
 <li><strong>Retting:</strong> Du kan endre dine profildata direkte i appen</li>\
 <li><strong>Sletting:</strong> Du kan slette din konto og alle tilh\'f8rende data</li>\
 <li><strong>Tilbaketrekking av samtykke:</strong> Du kan n\'e5r som helst trekke tilbake samtykket ditt ved \'e5 slette kontoen</li>\
 <li><strong>Dataportabilitet:</strong> Du kan be om \'e5 f\'e5 utlevert dine data i et maskinlesbart format</li>\
...
\
 ...
 <p>\
 Vi bruker Firebase Authentication med sikker kryptering for p\'e5logging. \
...
\
 ...
 <p>\
 Har du sp\'f8rsm\'e5l om personvern eller \'f8nsker \'e5 ut\'f8ve dine rettigheter, kan du kontakte oss p\'e5:<br>\
 <strong>E-post:</strong> [DIN KONTAKT E-POST HER]\
 </p>\
\
 <h3>10. Endringer i personvernerkl\'e6ringen</h3>\
 <p>\
 Vi forbeholder oss retten til \'e5 oppdatere denne personvernerkl\'e6ringen. \
 Ved vesentlige endringer vil du bli varslet ved innlogging.\
 </p>\
\
 <div class="gdpr-consent-box">\
 <p><strong>Ved \'e5 godta denne erkl\'e6ringen samtykker du til:</strong></p>\
 <ul>\
...
`;function At(e,i)\{const t=document.getElementById("gdpr-modal");t&&t.remove();const s=document.createElement("div");s.id="gdpr-modal",s.className="gdpr-modal",s.innerHTML=`\
 ...
 <a href="#" class="gdpr-link" id="gdpr-open-modal">personvernerkl\'e6ringen</a>\
 </span>\
 </label>\
 `,setTimeout(()=>\{const i=e.querySelector("#gdpr-open-modal");i&&i.addEventListener("click",t=>\{t.preventDefault(),At(()=>\{const s=document.getElementById("gdpr-consent-checkbox");s&&(s.checked=!0)\},()=>\{const s=document.getElementById("gdpr-consent-checkbox");s&&(s.checked=!1)\})\})\},0),e\}function Dt()\{const e=document.getElementById("gdpr-consent-checkbox");return!e||!e.checked?\{valid:!1,error:"Du m\'e5 godta personvernerkl\'e6ringen for \'e5 registrere deg"\}:\{valid:!0\}\}function Bt(e,i)\{e.innerHTML=`\
 <style>\
 * \{\
...
<div class="screen" id="screen-matches">\
 ...
 <div class="search-wrap"><span class="search-icon"></span><input class="search-input" id="match-id-search" placeholder="$\{d("search_match_placeholder")\}" type="number"><button class="btn-primary" style="margin-left:10px;padding:8px 16px;font-size:14px;" onclick="searchMatchByIdHandler()">S\'f8k</button></div>\
...
<div class="screen" id="screen-prognose">\
 ...
 <div id="prog-data-status" style="margin-top:12px;padding:12px;background:var(--bg);border-radius:8px;font-size:13px;color:var(--muted);text-align:center;display:none;">\
  Ingen skutte stages enn\'e5. Data vil vises etter at du har lagt til resultater.\
 </div>\
 </div>\
...
<div class="screen" id="screen-profile">\
 ...
 <div class="profile-div" id="prof-div">$\{g.division||""\} \'b7 $\{g.club||""\}</div>\
...
<div class="modal-overlay" id="modal-new-match" onclick="closeModalOutside(event,'modal-new-match')">\
 ...
 <input class="field-input" type="text" id="new-match-user-search" placeholder="S\'f8k etter navn eller e-post..." style="flex:1;">\
 <button onclick="searchUsersNewMatch()" style="width:80px;padding:12px;background:#e8b84b;color:#1a202c;border:none;border-radius:8px;font-weight:600;cursor:pointer;">S\'f8k</button>\
 </div>\
...
<div class="modal-overlay" id="modal-edit-match" onclick="closeModalOutside(event,'modal-edit-match')">\
 ...
 <div class="field-label">Inviter brukere (valgfritt)</div>\
 <div style="display:flex;gap:8px;margin-bottom:10px;">\
 <input class="field-input" type="text" id="edit-match-user-search" placeholder="S\'f8k etter navn eller e-post..." style="flex:1;">\
 <button onclick="searchUsersEditMatch()" style="width:80px;padding:12px;background:#e8b84b;color:#1a202c;border:none;border-radius:8px;font-weight:600;cursor:pointer;">S\'f8k</button>\
 </div>\
...
<div class="modal-overlay" id="modal-invite-user" onclick="closeModalOutside(event,'modal-invite-user')">\
 ...
 <div class="modal-body">\
 <div class="field-group">\
 <div class="field-label">S\'f8k etter navn eller e-post</div>\
 <div style="display:flex;gap:8px;">\
 <input class="field-input" type="text" id="user-search-input" placeholder="S\'f8k..." style="flex:1;">\
 <button onclick="searchUsers()" style="width:80px;padding:12px;background:#e8b84b;color:#1a202c;border:none;border-radius:8px;font-weight:600;cursor:pointer;">S\'f8k</button>\
 </div>\
 </div>\
...
<div class="modal-overlay" id="modal-confirm-delete" onclick="closeModalOutside(event,'modal-confirm-delete')">\
 ...
 <div class="modal-body">\
 <p style="margin-bottom:15px;">Er du sikker p\'e5 at du vil slette denne matchen?</p>\
