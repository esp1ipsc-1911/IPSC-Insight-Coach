...
<button onclick="var _sp=document.getElementById('stageplan-body');var _arr=document.getElementById('stageplan-arrow');if(_sp){_sp.style.display=_sp.style.display==='none'?'block':'none';_arr.textContent=_sp.style.display==='block'?'▼':'▶';}" style="width:100%;padding:0;background:transparent;border:none;color:var(--text);cursor:pointer;display:flex;justify-content:space-between;align-items:center;"><div style="font-size:11px;font-weight:700;letter-spacing:0.06em;color:var(--muted);">STAGEPLANLEGGING</div><span id="stageplan-arrow" style="font-size:12px;color:var(--muted);">▶</span></button><div id="stageplan-body" style="display:none;margin-top:12px;"><ol style="margin:0;padding:0 0 0 18px;font-size:13px;line-height:1.9;color:var(--text);"><li style="margin-bottom:6px;">Kartlegg alle mål — papirskiver, poppere, plates og svingere — før du bestemmer skyterekkefølge</li><li style="margin-bottom:6px;">Tenk hit factor i alle beslutninger — vurder tid, poeng og risiko samtidig. Velg ikke løsningen som er raskest eller tryggest isolert — velg den som gir best forventet totalscore</li><li style="margin-bottom:6px;">Identifiser risikosoner: hvor er no-shoot-eksponeringen størst, og hvor er sannsynligheten for miss høyest?</li><li style="margin-bottom:6px;">Del stagen i segmenter — aggressive soner der du kan presse, og kontrollsoner der du må beskytte poengene</li><li style="margin-bottom:6px;">Aktiver svingere og mekaniske mål så tidlig som mulig — ikke bygg venting inn i planen</li><li style="margin-bottom:6px;">Synkroniser bevegelse, target acquisition og timing — jobb mens mekanikk skjer, unngå passive stopp foran aktivatorer og svingere</li><li style="margin-bottom:6px;">Planlegg reloads inn i bevegelse, ikke som separate stopp</li><li style="margin-bottom:6px;">Tenk exit: planlegg hvordan du forlater posisjonen etter siste skudd, ikke bare ankomst</li><li>Velg en plan du faktisk kan gjennomføre stabilt — en enkel plan utført rent slår en «hero plan» med feil</li></ol></div></div>
