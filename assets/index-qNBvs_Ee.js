...
<div class="gdpr-content">
 ...
 Google Firebase is sertifisert under EU-U.S. Data Privacy Framework.
 </p>
 ...
 * {
 ...
 .separator {
 display: flex;
 align-items: center; gap: 12px; color: #7d8598; font-size: 14px; margin: 16px 0; } .separator::before, .separator::after { content: ""; flex: 1; height: 1px; background: rgba(255,255,255,0.12); } .secondary-btn { width: 100%; height: 50px; border-radius: 14px; border: 1px solid #2c3446; background: rgba(19, 25, 40, 0.74); color: #f3f5fb; font-size: clamp(15px, 4vw, 17px); font-weight: 700; cursor: pointer; } .ghost-btn { width: 100%; height: 48px; border-radius: 14px; border: 1px solid #2c3446; background: transparent; color: #d7dbe4; font-size: 16px; font-weight: 700; cursor: pointer; margin-top: 10px; } .section { display: none; } .section.active { display: block; } .strength-wrap { margin-top: -6px; margin-bottom: 12px; } .strength-bar-bg { width: 100%; height: 8px; border-radius: 999px; background: rgba(255,255,255,0.10); overflow: hidden; } .strength-bar-fill { height: 100%; width: 0%; border-radius: 999px; transition: width 0.2s ease; background: #ff6b6b; } .strength-text { font-size: 13px; color: #9aa3b2; margin-top: 6px; min-height: 18px; } .error-text { color: #ff8a8a; font-size: 14px; margin-top: 12px; min-height: 20px; } @media (min-width: 700px) { .ipsc-login-page { align-items: center; padding: 24px; } .ipsc-login-shell { max-width: 380px; } } </style> <div class="ipsc-login-page"> <div class="ipsc-login-shell"> <div class="ipsc-header"> <div class="brand-icon"> <img src="Logo_IPSC-insight.png" alt="Insight Dynamics Shooting"> </div> <div class="lang-flags"> <button id="langNo" class="lang-btn active" type="button" aria-label="Norsk">🇳🇴</button> <button id="langEn" class="lang-btn" type="button" aria-label="English">🇺🇸</button> </div> </div> <div class="brand-title"> <span class="top">INSIGHT</span> <span class="bottom">DYNAMICS</span> </div> <div id="brandSubtitle" class="brand-subtitle">Analyse. Presisjon. Resultat.</div> <div id="loginSection" class="section active"> <div id="loginEmailLabel" class="field-label">E-post</div> <input id="loginEmail" class="field" type="email" placeholder="navn@epost.no" /> <div id="loginPasswordLabel" class="field-label">Passord</div> <input id="loginPassword" class="field" type="password" placeholder="Passord" /> <button id="loginBtn" class="primary-btn">Logg inn</button> <div id="separatorText" class="separator">eller</div> <button id="showRegisterBtn" class="secondary-btn">Registrer ny bruker</button> </div> <div id="registerSection" class="section"> <div id="registerFirstNameLabel" class="field-label">Fornavn</div> <input id="registerFirstName" class="field" type="text" placeholder="Fornavn" /> <div id="registerLastNameLabel" class="field-label">Etternavn</div> <input id="registerLastName" class="field" type="text" placeholder="Etternavn" /> <div id="registerEmailLabel" class="field-label">E-post</div> <input id="registerEmail" class="field" type="email" placeholder="navn@epost.no" /> <div id="registerEmailConfirmLabel" class="field-label">Bekreft e-post</div> <input id="registerEmailConfirm" class="field" type="email" placeholder="Gjenta e-post" /> <div id="registerPasswordLabel" class="field-label">Passord</div> <input id="registerPassword" class="field" type="password" placeholder="Passord" /> <div class="strength-wrap"> <div class="strength-bar-bg"> <div id="passwordStrengthBar" class="strength-bar-fill"></div> </div> <div id="passwordStrengthText" class="strength-text"></div> </div> <div id="registerPasswordConfirmLabel" class="field-label">Bekreft passord</div> <input id="registerPasswordConfirm" class="field" type="password" placeholder="Gjenta passord" /> <div id="registerDivisionLabel" class="field-label">Divisjon</div> <select id="registerDivision" class="field-select"> <option value="">Velg divisjon</option> <option value="Standard">Standard</option> <option value="Open">Open</option> <option value="Production">Production</option> <option value="Production Optics">Production Optics</option> <option value="Classic">Classic</option> <option value="Revolver">Revolver</option> </select> <div id="registerCategoryLabel" class="field-label">Kategori</div> <select id="registerCategory" class="field-select"> <option value="">Velg kategori (valgfri)</option> <option value="Junior">Junior</option> <option value="Senior">Senior</option> <option value="Super Senior">Super Senior</option> <option value="Lady">Lady</option> <option value="Lady Junior">Lady Junior</option> <option value="Lady Senior">Lady Senior</option> </select> <div id="registerPowerFactorLabel" class="field-label">Power Factor</div> <div class="pf-selector"> <div class="pf-option selected" data-pf="minor" id="pfMinor">Minor</div> <div class="pf-option" data-pf="major" id="pfMajor">Major</div> </div> <div id="registerRegionLabel" class="field-label">Region</div> <select id="registerRegion" class="field-select"> <option value="">Velg region (valgfri)</option> <option value="Norge">Norge</option> <option value="Sverige">Sverige</option> <option value="Danmark">Danmark</option> <option value="Finland">Finland</option> <option value="Tyskland">Tyskland</option> <option value="Storbritannia">Storbritannia</option> <option value="USA">USA</option> <option value="Annet">Annet</option> </select> <div id="registerClubLabel" class="field-label">Klubb</div> <input id="registerClub" class="field" type="text" placeholder="Klubbnavn (valgfri)" /> <div id="registerCodeLabel" class="field-label">Invitasjonskode</div> <input id="registerCode" class="field" type="text" placeholder="Invitasjonskode" /> <div id="gdprCheckboxContainer"></div> <button id="registerBtn" class="primary-btn">Opprett bruker</button> <button id="cancelRegisterBtn" class="ghost-btn">Avbryt</button> </div> <div id="error" class="error-text"></div> </div> </div> `;const t={no:{subtitle:"Analyse. Presisjon. Resultat.",loginEmailLabel:"E-post",loginEmailPlaceholder:"navn@epost.no",loginPasswordLabel:"Passord",loginPasswordPlaceholder:"Passord",login:"Logg inn",or:"eller",showRegister:"Registrer ny bruker",registerFirstNameLabel:"Fornavn",registerFirstNamePlaceholder:"Fornavn",registerLastNameLabel:"Etternavn",registerLastNamePlaceholder:"Etternavn",registerEmailLabel:"E-post",registerEmailPlaceholder:"navn@epost.no",registerEmailConfirmLabel:"Bekreft e-post",registerEmailConfirmPlaceholder:"Gjenta e-post",registerPasswordLabel:"Passord",registerPasswordPlaceholder:"Passord",registerPasswordConfirmLabel:"Bekreft passord",registerPasswordConfirmPlaceholder:"Gjenta passord",registerDivisionLabel:"Divisjon",registerCategoryLabel:"Kategori",registerPowerFactorLabel:"Power Factor",registerRegionLabel:"Region",registerClubLabel:"Klubb",registerCodeLabel:"Invitasjonskode",registerCodePlaceholder:"Invitasjonskode",register:"Opprett bruker",cancel:"Avbryt",emailMismatch:"E-postadressene er ikke like",passwordMismatch:"Passordene er ikke like",missingFields:"Fyll ut alle påkrevde feltene",missingName:"Du må skrive inn fornavn og etternavn",missingDivision:"Du må velge divisjon",weakPassword:"Passordet er for svakt",strengthEmpty:"",strengthVeryWeak:"Passordstyrke: Svært svak",strengthWeak:"Passordstyrke: Svak",strengthMedium:"Passordstyrke: Middels",strengthStrong:"Passordstyrke: Sterk",strengthVeryStrong:"Passordstyrke: Svært sterk",gdprRequired:"Du må godta personvernerklæringen for å registrere deg"},en:{subtitle:"Analyse. Presisjon. Resultat.",loginEmailLabel:"Email",loginEmailPlaceholder:"name@email.com",loginPasswordLabel:"Password",loginPasswordPlaceholder:"Password",login:"Log in",or:"or",showRegister:"Create new user",registerFirstNameLabel:"First Name",registerFirstNamePlaceholder:"First name",registerLastNameLabel:"Last Name",registerLastNamePlaceholder:"Last name",registerEmailLabel:"Email",registerEmailPlaceholder:"name@email.com",registerEmailConfirmLabel:"Confirm email",registerEmailConfirmPlaceholder:"Repeat email",registerPasswordLabel:"Password",registerPasswordPlaceholder:"Password",registerPasswordConfirmLabel:"Confirm password",registerPasswordConfirmPlaceholder:"Repeat password",registerDivisionLabel:"Division",registerCategoryLabel:"Category",registerPowerFactorLabel:"Power Factor",registerRegionLabel:"Region",registerClubLabel:"Club",registerCodeLabel:"Invite code",registerCodePlaceholder:"Invite code",register:"Create account",cancel:"Cancel",emailMismatch:"The email addresses do not match",passwordMismatch:"Passwords do not match",missingFields:"Please fill in all required fields",missingName:"Please enter your first and last name",missingDivision:"Please select a division",weakPassword:"The password is too weak",strengthEmpty:"",strengthVeryWeak:"Password strength: Very weak",strengthWeak:"Password strength: Weak",strengthMedium:"Password strength: Medium",strengthStrong:"Password strength: Strong",strengthVeryStrong:"Password strength: Very strong",gdprRequired:"You must accept the privacy policy to register"}};let s="no",a="minor";const n=document.getElementById("error"),r=document.getElementById("loginSection"),u=document.getElementById("registerSection"),m=document.getElementById("showRegisterBtn"),b=document.getElementById("cancelRegisterBtn"),f=document.getElementById("loginBtn"),p=document.getElementById("registerBtn"),h=document.getElementById("langNo"),E=document.getElementById("langEn"),k=document.getElementById("registerPassword"),P=document.getElementById("passwordStrengthBar"),C=document.getElementById("passwordStrengthText"),L=document.getElementById("pfMinor"),M=document.getElementById("pfMajor");L.onclick=()=>{a="minor",L.classList.add("selected"),M.classList.remove("selected")},M.onclick=()=>{a="major",M.classList.add("selected"),L.classList.remove("selected")};function D(w){let y=0;return w?(w.length>=8&&(y+=1),w.length>=12&&(y+=1),/[a-z]/.test(w)&&/[A-Z]/.test(w)&&(y+=1),/\d/.test(w)&&(y+=1),/[^A-Za-z0-9]/.test(w)&&(y+=1),y<=1?{score:y,width:"20%",labelKey:"strengthVeryWeak",color:"#ff6b6b"}:y===2?{score:y,width:"40%",labelKey:"strengthWeak",color:"#ff9f43"}:y===3?{score:y,width:"60%",labelKey:"strengthMedium",color:"#feca57"}:y===4?{score:y,width:"80%",labelKey:"strengthStrong",color:"#1dd1a1"}:{score:y,width:"100%",labelKey:"strengthVeryStrong",color:"#10ac84"}):{score:0,width:"0%",labelKey:"strengthEmpty",color:"#ff6b6b"}}function B(){const w=t[s],y=k.value,H=D(y);P.style.width=H.width,P.style.background=H.color,C.innerText=w[H.labelKey]}function _(w){s=w;const y=t[w];document.getElementById("brandSubtitle").innerText=y.subtitle,document.getElementById("loginEmailLabel").innerText=y.loginEmailLabel,document.getElementById("loginEmail").placeholder=y.loginEmailPlaceholder,document.getElementById("loginPasswordLabel").innerText=y.loginPasswordLabel,document.getElementById("loginPassword").placeholder=y.loginPasswordPlaceholder,document.getElementById("loginBtn").innerText=y.login,document.getElementById("separatorText").innerText=y.or,document.getElementById("showRegisterBtn").innerText=y.showRegister,document.getElementById("registerFirstNameLabel").innerText=y.registerFirstNameLabel,document.getElementById("registerFirstName").placeholder=y.registerFirstNamePlaceholder,document.getElementById("registerLastNameLabel").innerText=y.registerLastNameLabel,document.getElementById("registerLastName").placeholder=y.registerLastNamePlaceholder,document.getElementById("registerEmailLabel").innerText=y.registerEmailLabel,document.getElementById("registerEmail").placeholder=y.registerEmailPlaceholder,document.getElementById("registerEmailConfirmLabel").innerText=y.registerEmailConfirmLabel,document.getElementById("registerEmailConfirm").placeholder=y.registerEmailConfirmPlaceholder,document.getElementById("registerPasswordLabel").innerText=y.registerPasswordLabel,document.getElementById("registerPassword").placeholder=y.registerPasswordPlaceholder,document.getElementById("registerPasswordConfirmLabel").innerText=y.registerPasswordConfirmLabel,document.getElementById("registerPasswordConfirm").placeholder=y.registerPasswordConfirmPlaceholder,document.getElementById("registerDivisionLabel").innerText=y.registerDivisionLabel,document.getElementById("registerCategoryLabel").innerText=y.registerCategoryLabel,document.getElementById("registerPowerFactorLabel").innerText=y.registerPowerFactorLabel,document.getElementById("registerRegionLabel").innerText=y.registerRegionLabel,document.getElementById("registerClubLabel").innerText=y.registerClubLabel,document.getElementById("registerCodeLabel").innerText=y.registerCodeLabel,document.getElementById("registerCode").placeholder=y.registerCodePlaceholder,document.getElementById("registerBtn").innerText=y.register,document.getElementById("cancelRegisterBtn").innerText=y.cancel,h.classList.toggle("active",w==="no"),E.classList.toggle("active",w==="en"),B()}function K(){r.classList.remove("active"),u.classList.add("active"),n.innerText="";const w=document.getElementById("gdprCheckboxContainer");if(w&&!w.hasChildNodes()){const y=Rt();w.appendChild(y)}}function j(){u.classList.remove("active"),r.classList.add("active"),n.innerText=""}h.onclick=()=>_("no"),E.onclick=()=>_("en"),m.onclick=K,b.onclick=j,k.oninput=B,f.onclick=async()=>{n.innerText="";const w=document.getElementById("loginEmail").value.trim(),y=document.getElementById("loginPassword").value,H=await _t(w,y);H.success?i():n.innerText=H.error},p.onclick=async()=>{n.innerText="";const w=t[s],y=document.getElementById("registerFirstName").value.trim(),H=document.getElementById("registerLastName").value.trim(),Y=document.getElementById("registerEmail").value.trim(),ce=document.getElementById("registerEmailConfirm").value.trim(),X=document.getElementById("registerPassword").value,pe=document.getElementById("registerPasswordConfirm").value,se=document.getElementById("registerDivision").value,ae=document.getElementById("registerCategory").value,T=document.getElementById("registerRegion").value,I=document.getElementById("registerClub").value.trim(),c=document.getElementById("registerCode").value.trim();if(!y||!H){n.innerText=w.missingName;return}if(!Y||!ce||!X||!pe||!c){n.innerText=w.missingFields;return}if(!se){n.innerText=w.missingDivision;return}if(Y!==ce){n.innerText=w.emailMismatch;return}if(X!==pe){n.innerText=w.passwordMismatch;return}if(D(X).score<=1){n.innerText=w.weakPassword;return}if(!Dt().valid){n.innerText=w.gdprRequired;return}const v=await Nt(Y,X,c,y,H,se,ae,a,T,I);v.success?i():n.innerText=v.error},_("no"),B()}async function Ot(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{return await de(U(O,"users",i.uid),{...e,updatedAt:Ie()}),{success:!0}}catch(t){return console.error("Save profile error:",t),{success:!1,error:t.message}}}async function jt(){const e=W();if(!e)return null;try{const i=await be(U(O,"users",e.uid));return i.exists()?{uid:e.uid,...i.data()}:null}catch(i){return console.error("Get profile error:",i),null}}async function Ut(e){try{const i=await be(U(O,"users",e));return i.exists()?{uid:e,...i.data()}:null}catch(i){return console.error("Get user by ID error:",i),null}}async function Ht(){const e=U(O,"counters","matchId");try{const i=await be(e);if(!i.exists())return await Ne(e,{value:1}),1;const s=i.data().value+1;return await de(e,{value:s}),s}catch(i){throw console.error("Error getting next match ID:",i),i}}async function zt(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{const t=await Ht(),s={id:t,...e,searchable:e.searchable!==!1,ownerId:i.uid,participants:[i.uid],createdAt:Ie(),updatedAt:Ie()};return await Ne(U(O,"matches",t.toString()),s),{success:!0,matchId:t}}catch(t){return console.error("Create match error:",t),{success:!1,error:t.message}}}async function Ee(e,i){if(!W())return{success:!1,error:"Not authenticated"};try{return await de(U(O,"matches",e.toString()),{...i,updatedAt:Ie()}),{success:!0}}catch(s){return console.error("Update match error:",s),{success:!1,error:s.message}}}async function Gt(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{const t=await be(U(O,"matches",e.toString()));return t.exists()?t.data().ownerId!==i.uid?{success:!1,error:"Only the creator can delete this match"}:(await Pt(U(O,"matches",e.toString())),{success:!0}):{success:!1,error:"Match not found"}}catch(t){return console.error("Delete match error:",t),{success:!1,error:t.message}}}async function Kt(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{const t=e.toString().trim(),s=await Vt(),a=s.find(n=>n.id&&n.id.toString()===t);return a?{success:!0,match:a}:{success:!1,error:"Du har ikke tilgang til denne matchen. Bruk invitasjoner for å få tilgang."}}catch(t){return console.error("Search match error:",t),{success:!1,error:t.message}}}async function Vt(){const e=W();if(!e)return[];try{const i=$e(Le(O,"matches"),Fe("participants","array-contains",e.uid)),t=await He(i),s=[];return t.forEach(a=>{s.push({id:a.id,...a.data()})}),s.sort((a,n)=>{var m,b;const r=a.date||((m=a.createdAt)==null?void 0:m.toDate())||new Date(0);return(n.date||((b=n.createdAt)==null?void 0:b.toDate())||new Date(0))-r}),s}catch(i){return console.error("Get user matches error:",i),[]}}function qt(e){const i=W();if(!i)return()=>{};const t=$e(Le(O,"matches"),Fe("participants","array-contains",i.uid));return ze(t,a=>{const n=[];a.forEach(r=>{n.push({id:r.id,...r.data()})}),n.sort((r,u)=>{var f,p;const m=r.date||((f=r.createdAt)==null?void 0:f.toDate())||new Date(0);return(u.date||((p=u.createdAt)==null?void 0:p.toDate())||new Date(0))-m}),e(n)})}async function Wt(e,i){if(!W())return{success:!1,error:"Not authenticated"};try{const t=U(O,"matches",e.toString()),s=await be(t);if(!s.exists())return{success:!1,error:"Match not found"};const a=s.data().participants||[];return a.includes(i)?{success:!1,error:"User already a participant"}:(await de(t,{participants:st(i)}),{success:!0})}catch(t){return console.error("Add participant error:",t),{success:!1,error:t.message}}}async function Qt(e,i){if(!W())return{success:!1,error:"Not authenticated"};try{const t=U(O,"matches",e.toString());return await de(t,{participants:st(i)}),{success:!0}}catch(t){return console.error("Invite user error:",t),{success:!1,error:t.message}}}async function Yt(e){if(!W())return{success:!1,error:"Not authenticated"};try{const i=$e(Le(O,"users"),Fe("email","==",e.toLowerCase().trim())),t=await He(i);if(t.empty)return{success:!1,error:"User not found"};const s=t.docs[0];return{success:!0,user:{uid:s.id,...s.data()}}}catch(i){return console.error("Search user error:",i),{success:!1,error:i.message}}}async function Xt(e,i,t,s){if(!W())return{success:!1,error:"Not authenticated"};try{const a=U(O,"matches",e.toString(),"stages",i.toString());return await Ne(a,{id:i,...t,createdAt:Ie(),updatedAt:Ie()}),s&&await de(U(O,"matches",e.toString()),{updatedAt:Ie()}),{success:!0}}catch(a){return console.error("Save stage error:",a),{success:!1,error:a.message}}}async function Zt(e,i,t,s){if(!W())return{success:!1,error:"Not authenticated"};try{const a=U(O,"matches",e.toString(),"stages",i.toString());return await de(a,{...t,updatedAt:Ie()}),s&&await de(U(O,"matches",e.toString()),{updatedAt:Ie()}),{success:!0}}catch(a){return console.error("Update stage error:",a),{success:!1,error:a.message}}}async function er(e,i,t){if(!W())return{success:!1,error:"Not authenticated"};try{return await Pt(U(O,"matches",e.toString(),"stages",i.toString())),t&&await de(U(O,"matches",e.toString()),{updatedAt:Ie()}),{success:!0}}catch(s){return console.error("Delete stage error:",s),{success:!1,error:s.message}}}async function tr(e){if(!W())return[];try{const i=Le(O,"matches",e.toString(),"stages"),t=await He(i),s=[];return t.forEach(a=>{s.push({id:a.id,...a.data()})}),s.sort((a,n)=>(a.order||0)-(n.order||0)),s}catch(i){return console.error("Get match stages error:",i),[]}}function ir(e,i){if(!W())return()=>{};const t=Le(O,"matches",e.toString(),"stages");return ze(t,s=>{const a=[];s.forEach(n=>{a.push({id:n.id,...n.data()})}),a.sort((n,r)=>(n.order||0)-(r.order||0)),i(a)})}async function nr(e,i,t,s,a){if(!W())return{success:!1,error:"Not authenticated"};try{const n=U(O,"matches",e.toString(),"stages",i.toString(),"runs",t.toString());return await Ne(n,{id:t,...s,createdAt:Ie(),updatedAt:Ie()}),a&&await de(U(O,"matches",e.toString(),"stages",i.toString()),{updatedAt:Ie()}),{success:!0}}catch(n){return console.error("Save run error:",n),{success:!1,error:n.message}}}async function rr(e,i,t,s,a){if(!W())return{success:!1,error:"Not authenticated"};try{const n=U(O,"matches",e.toString(),"stages",i.toString(),"runs",t.toString());return await de(n,{...s,updatedAt:Ie()}),a&&await de(U(O,"matches",e.toString(),"stages",i.toString()),{updatedAt:Ie()}),{success:!0}}catch(n){return console.error("Update run error:",n),{success:!1,error:n.message}}}async function sr(e,i,t,s){if(!W())return{success:!1,error:"Not authenticated"};try{return await Pt(U(O,"matches",e.toString(),"stages",i.toString(),"runs",t.toString())),s&&await de(U(O,"matches",e.toString(),"stages",i.toString()),{updatedAt:Ie()}),{success:!0}}catch(a){return console.error("Delete run error:",a),{success:!1,error:a.message}}}async function ar(e,i){if(!W())return[];try{const t=Le(O,"matches",e.toString(),"stages",i.toString(),"runs"),s=await He(t),a=[];return s.forEach(n=>{a.push({id:n.id,...n.data()})}),a.sort((n,r)=>{var u,m;return(((u=n.createdAt)==null?void 0:u.toDate())||new Date(0))-(((m=r.createdAt)==null?void 0:m.toDate())||new Date(0))}),a}catch(t){return console.error("Get runs error:",t),[]}}function or(e,i,t){if(!W())return()=>{};const s=Le(O,"matches",e.toString(),"stages",i.toString(),"runs");return ze(s,a=>{const n=[];a.forEach(r=>{n.push({id:r.id,...r.data()})}),n.sort((r,u)=>{var m,b;return(((m=r.createdAt)==null?void 0:m.toDate())||new Date(0))-(((b=u.createdAt)==null?void 0:b.toDate())||new Date(0))}),t(n)})}async function lr(e,i,t){if(!W())return{success:!1,error:"Not authenticated"};try{const s=wb(O);return t.forEach(a=>{const n=U(O,"matches",e.toString(),"stages",i.toString(),"runs",a.id.toString());s.update(n,{order:a.order,updatedAt:Ie()})}),await s.commit(),{success:!0}}catch(s){return console.error("Update runs order error:",s),{success:!1,error:s.message}}}async function ur(e,i){if(!W())return{success:!1,error:"Not authenticated"};try{const t=wb(O);return i.forEach(s=>{const a=U(O,"matches",e.toString(),"stages",s.id.toString());t.update(a,{order:s.order,updatedAt:Ie()})}),await t.commit(),{success:!0}}catch(t){return console.error("Update stages order error:",t),{success:!1,error:t.message}}}function d(e,i){const t=parseFloat(e)||0,s=parseFloat(i)||0;return s===0?0:t/s}function Me(e){const i=parseInt(e.alpha)||0,t=parseInt(e.charlie)||0,s=parseInt(e.delta)||0,a=parseInt(e.miss)||0,n=parseInt(e.proc)||0,r=e.powerFactor==="major",u=i*5+t*(r?4:3)+s*(r?2:1)-a*10-n*10;return Math.max(0,u)}function cr(e,i){const t=Me(e),s=Me(i);return s===0?0:t/s*100}function fr(e){const i=e.reduce((t,s)=>t+Me(s),0),a=e.reduce((t,s)=>t+(parseFloat(s.time)||0),0);return a===0?0:i/a}function dr(e,i,t){const s=Me(e),a=parseFloat(e.time)||0,n=t?5:0,r=t?5:0,u=t?10:0,m=t?10:0,b=i*5,f=i*5-n-r-u-m;return{points:s,time:a,hitFactor:a===0?0:s/a,possiblePoints:b,scorePercentage:b===0?0:s/b*100}}function pr(e,i){const t=e.map(s=>({points:Me(s),time:parseFloat(s.time)||0})),a=t.reduce((s,a)=>s+a.points,0),n=t.reduce((s,a)=>s+a.time,0);return{totalPoints:a,totalTime:n,averageHitFactor:n===0?0:a/n,stageCount:e.length}}function hr(e,i){const t=new Blob([i],{type:"text/csv;charset=utf-8;"}),s=document.createElement("a"),a=URL.createObjectURL(t);s.setAttribute("href",a),s.setAttribute("download",e),s.style.visibility="hidden",document.body.appendChild(s),s.click(),document.body.removeChild(s)}function mr(e,i){const t=["Stage,Order,Type,Targets,Alpha,Charlie,Delta,Miss,Proc,Time,Hit Factor"],s=i.map(a=>{const n=Me(a),r=parseFloat(a.time)||0,u=r===0?0:n/r;return`"${a.name||"Uten navn"}",${a.order||0},"${a.type||"S"}",${a.targets||0},${a.alpha||0},${a.charlie||0},${a.delta||0},${a.miss||0},${a.proc||0},${r},${u.toFixed(4)}`});hr(`${e.name||"Match"}.csv`,t.concat(s).join("\n"));}async function gr(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{const t=U(O,"matches",e.toString());return await de(t,{archived:!0,updatedAt:Ie()}),{success:!0}}catch(t){return console.error("Archive match error:",t),{success:!1,error:t.message}}}async function vr(e){const i=W();if(!i)return{success:!1,error:"Not authenticated"};try{const t=U(O,"matches",e.toString());return await de(t,{archived:!1,updatedAt:Ie()}),{success:!0}}catch(t){return console.error("Unarchive match error:",t),{success:!1,error:t.message}}}let ke=null,xe=null;function i(){const e=W();if(!e){Bt(ht,i);return}Ct(t=>{t?(oe=t,ht.innerHTML="",br(ht)):(oe=null,ht.innerHTML="",Bt(ht,i))})}async function br(e){e.innerHTML=`<div id="main-container"></div>`;const i=document.getElementById("main-container");yr(i)}async function yr(e){e.innerHTML=`
 <style>
 .dashboard { padding: 20px; max-width: 1200px; margin: 0 auto; }
 .header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; }
 .welcome h1 { margin: 0; font-size: 28px; color: #f5f7fb; }
 .welcome p { margin: 5px 0 0; color: #7d8598; }
 .actions { display: flex; gap: 12px; }
 .btn { padding: 10px 20px; border-radius: 10px; font-weight: 600; cursor: pointer; border: none; transition: all 0.2s; }
 .btn-primary { background: #e0b649; color: #111; }
 .btn-secondary { background: rgba(255,255,255,0.05); color: #f5f7fb; border: 1px solid rgba(255,255,255,0.1); }
 .match-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 20px; margin-top: 20px; }
 .match-card { background: rgba(19, 25, 40, 0.5); border: 1px solid rgba(255,255,255,0.08); border-radius: 16px; padding: 20px; cursor: pointer; transition: all 0.2s; }
 .match-card:hover { transform: translateY(-4px); background: rgba(19, 25, 40, 0.8); border-color: #e0b649; }
 .match-card h3 { margin: 0 0 10px; color: #f5f7fb; }
 .match-card .meta { display: flex; gap: 15px; color: #7d8598; font-size: 14px; }
 .loading { text-align: center; padding: 50px; color: #7d8598; }
 .empty-state { text-align: center; padding: 60px 20px; background: rgba(19, 25, 40, 0.3); border-radius: 20px; border: 2px dashed rgba(255,255,255,0.05); }
 </style>
 <div class="dashboard">
 <div class="header">
 <div class="welcome">
 <h1>Hei, ${oe.firstName||oe.name}!</h1>
 <p>Velkommen tilbake til Insight Dynamics</p>
 </div>
 <div class="actions">
 <button id="newMatchBtn" class="btn btn-primary">Ny Match</button>
 <button id="logoutBtn" class="btn btn-secondary">Logg ut</button>
 </div>
 </div>
 <div id="matchList" class="match-grid">
 <div class="loading">Laster dine matcher...</div>
 </div>
 </div>
 `;document.getElementById("logoutBtn").onclick=Ks,document.getElementById("newMatchBtn").onclick=()=>wr(e);const i=document.getElementById("matchList");ke=qt(t=>{if(t.length===0){i.innerHTML=`
 <div class="empty-state">
 <h3 style="color: #f5f7fb; margin-bottom: 10px;">Ingen matcher ennå</h3>
 <p style="color: #7d8598; margin-bottom: 20px;">Start med å opprette din første match for å analysere dine resultater.</p>
 <button id="newMatchBtnEmpty" class="btn btn-primary">Opprett første match</button>
 </div>
 `,document.getElementById("newMatchBtnEmpty").onclick=()=>wr(e);return}i.innerHTML="",t.forEach(s=>{const a=document.createElement("div");a.className="match-card",a.innerHTML=`
 <h3>${s.name}</h3>
 <div class="meta">
 <span>📅 ${s.date?new Date(s.date).toLocaleDateString("nb-NO"):"Ingen dato"}</span>
 <span>🎯 ${s.location||"Ingen lokasjon"}</span>
 </div>
 `,a.onclick=()=>kr(e,s),i.appendChild(a)})})}function wr(e){e.innerHTML=`
 <style>
 .form-container { max-width: 500px; margin: 40px auto; padding: 30px; background: rgba(19, 25, 40, 0.8); border-radius: 20px; border: 1px solid rgba(255,255,255,0.1); }
 .form-group { margin-bottom: 20px; }
 .form-group label { display: block; margin-bottom: 8px; color: #7d8598; font-size: 14px; text-transform: uppercase; }
 .form-group input { width: 100%; padding: 12px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: #f5f7fb; }
 </style>
 <div class="form-container">
 <h2 style="margin-bottom: 25px; color: #f5f7fb;">Opprett Ny Match</h2>
 <div class="form-group">
 <label>Navn på match</label>
 <input type="text" id="matchName" placeholder="f.eks. Oslo Open 2024">
 </div>
 <div class="form-group">
 <label>Dato</label>
 ...
 <input type="text" id="matchLocation" placeholder="f.eks. Løvenskioldbanen">
 </div>
 <div style="display: flex; gap: 12px; margin-top: 30px;">
 <button id="saveMatchBtn" class="btn btn-primary" style="flex: 1;">Opprett</button>
 <button id="cancelBtn" class="btn btn-secondary" style="flex: 1;">Avbryt</button>
 </div>
 </div>
 `,document.getElementById("cancelBtn").onclick=()=>yr(e),document.getElementById("saveMatchBtn").onclick=async()=>{const i=document.getElementById("matchName").value,t=document.getElementById("matchDate").value,s=document.getElementById("matchLocation").value;if(!i)return alert("Du må gi matchen et navn");const a=await zt({name:i,date:t,location:s});a.success?yr(e):alert("Feil: "+a.error)}}function kr(e,i){ke&&ke(),e.innerHTML=`
 <style>
 .match-view { padding: 20px; max-width: 1000px; margin: 0 auto; }
 .back-link { color: #e0b649; cursor: pointer; margin-bottom: 20px; display: inline-block; }
 .match-header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 30px; }
 .match-info h1 { margin: 0; color: #f5f7fb; }
 .match-info p { color: #7d8598; margin: 5px 0; }
 .stage-list { margin-top: 30px; }
 .stage-item { background: rgba(255,255,255,0.03); border-radius: 12px; padding: 15px 20px; margin-bottom: 10px; display: flex; justify-content: space-between; align-items: center; cursor: pointer; }
 .stage-item:hover { background: rgba(255,255,255,0.06); }
 </style>
 <div class="match-view">
 <div class="back-link" id="backBtn">← Tilbake til dashboard</div>
 <div class="match-header">
 <div class="match-info">
 <h1>${i.name}</h1>
 <p>📅 ${i.date?new Date(i.date).toLocaleDateString("nb-NO"):"Ingen dato"} | 🎯 ${i.location||"Ingen lokasjon"}</p>
 </div>
 <div class="actions">
 <button id="addStageBtn" class="btn btn-primary">Legg til Stage</button>
 <button id="exportCsvBtn" class="btn btn-secondary">Eksporter CSV</button>
 </div>
 </div>
 <div id="stageList" class="stage-list">
 <div class="loading">Laster stager...</div>
 </div>
 </div>
 `,document.getElementById("backBtn").onclick=()=>yr(e),document.getElementById("addStageBtn").onclick=()=>xr(e,i),document.getElementById("exportCsvBtn").onclick=async()=>{const t=await tr(i.id);mr(i,t)};const t=document.getElementById("stageList");xe=ir(i.id,s=>{if(s.length===0){t.innerHTML=`<div class="empty-state"><p>Ingen stager lagt til ennå.</p></div>`;return}t.innerHTML="",s.forEach(a=>{const n=document.createElement("div");n.className="stage-item",n.innerHTML=`
 <div>
 <span style="font-weight: bold; color: #f5f7fb;">Stage ${a.order||""}: ${a.name||"Uten navn"}</span>
 <div style="font-size: 12px; color: #7d8598; margin-top: 4px;">🎯 ${a.targets||0} skiver | ${a.type||"S"}</div>
 </div>
 <div style="color: #e0b649; font-weight: bold;">${(Me(a)/parseFloat(a.time||1)).toFixed(3)} HF</div>
 `,n.onclick=()=>Sr(e,i,a),t.appendChild(a)})})}function xr(e,i){e.innerHTML=`
 <div class="form-container">
 <h2 style="color: #f5f7fb; margin-bottom: 25px;">Legg til Stage</h2>
 <div class="form-group">
 <label>Stage Navn</label>
 <input type="text" id="stageName" placeholder="f.eks. Stage 1">
 </div>
 <div class="form-group">
 ...
 <div class="form-group">
 <label>Antall skiver</label>
 <input type="number" id="stageTargets" value="9">
 </div>
 <div class="form-group">
 <label>Type (S/M/L)</label>
 <input type="text" id="stageType" placeholder="S">
 </div>
 <div style="display: flex; gap: 12px; margin-top: 30px;">
 <button id="saveStageBtn" class="btn btn-primary" style="flex: 1;">Lagre</button>
 <button id="cancelBtn" class="btn btn-secondary" style="flex: 1;">Avbryt</button>
 </div>
 </div>
 `,document.getElementById("cancelBtn").onclick=()=>kr(e,i),document.getElementById("saveStageBtn").onclick=async()=>{const t=document.getElementById("stageName").value,s=parseInt(document.getElementById("stageOrder").value),a=parseInt(document.getElementById("stageTargets").value),n=document.getElementById("stageType").value,r=Date.now();await Xt(i.id,r,{name:t,order:s,targets:a,type:n,alpha:0,charlie:0,delta:0,miss:0,proc:0,time:0},!0),kr(e,i)}}function Sr(e,i,t){xe&&xe(),e.innerHTML=`
 <style>
 .stage-view { padding: 20px; max-width: 800px; margin: 0 auto; }
 .score-card { background: rgba(19, 25, 40, 0.6); border-radius: 20px; padding: 25px; border: 1px solid rgba(255,255,255,0.1); margin-bottom: 25px; }
 .score-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; margin-top: 20px; }
 .stat-box { background: rgba(0,0,0,0.2); padding: 15px; border-radius: 12px; text-align: center; }
 .stat-val { display: block; font-size: 24px; font-weight: 800; color: #e0b649; }
 .stat-label { font-size: 12px; color: #7d8598; text-transform: uppercase; }
 .input-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(120px, 1fr)); gap: 15px; margin-top: 25px; }
 .input-group label { display: block; font-size: 12px; color: #7d8598; margin-bottom: 5px; }
 .input-group input { width: 100%; padding: 10px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.3); color: #f5f7fb; }
 </style>
 <div class="stage-view">
 <div class="back-link" id="backBtn">← Tilbake til matchen</div>
 <div class="match-header">
 <div class="match-info">
 <h1>Stage ${t.order}: ${t.name}</h1>
 <p>${i.name} | ${t.targets} skiver</p>
 </div>
 <button id="deleteStageBtn" class="btn btn-secondary" style="color: #ff6b6b;">Slett Stage</button>
 </div>

 <div class="score-card">
 <div class="score-grid">
 <div class="stat-box">
 <span class="stat-val" id="hfVal">${(Me(t)/parseFloat(t.time||1)).toFixed(4)}</span>
 <span class="stat-label">Hit Factor</span>
 </div>
 <div class="stat-box">
 <span class="stat-val" id="pointsVal">${Me(t)}</span>
 <span class="stat-label">Poeng</span>
 </div>
 <div class="stat-box">
 <span class="stat-val" id="percVal">${(Me(t)/(t.targets*5)*100).toFixed(1)}%</span>
 <span class="stat-label">Poeng-bruk</span>
 </div>
 </div>

 <div class="input-grid">
 <div class="input-group"><label>Alpha</label><input type="number" id="in-alpha" value="${t.alpha||0}"></div>
 <div class="input-group"><label>Charlie</label><input type="number" id="in-charlie" value="${t.charlie||0}"></div>
 <div class="input-group"><label>Delta</label><input type="number" id="in-delta" value="${t.delta||0}"></div>
 <div class="input-group"><label>Miss</label><input type="number" id="in-miss" value="${t.miss||0}"></div>
 <div class="input-group"><label>Proc</label><input type="number" id="in-proc" value="${t.proc||0}"></div>
 <div class="input-group"><label>Tid (sek)</label><input type="number" step="0.01" id="in-time" value="${t.time||0}"></div>
 </div>
 <button id="saveScoreBtn" class="btn btn-primary" style="width: 100%; margin-top: 25px;">Oppdater Resultat</button>
 </div>
 </div>
 `,document.getElementById("backBtn").onclick=()=>kr(e,i),document.getElementById("deleteStageBtn").onclick=async()=>{confirm("Slette denne stagen?")&&(await er(i.id,t.id,!0),kr(e,i))},document.getElementById("saveScoreBtn").onclick=async()=>{const s={alpha:parseInt(document.getElementById("in-alpha").value),charlie:parseInt(document.getElementById("in-charlie").value),delta:parseInt(document.getElementById("in-delta").value),miss:parseInt(document.getElementById("in-miss").value),proc:parseInt(document.getElementById("in-proc").value),time:parseFloat(document.getElementById("in-time").value)};await Zt(i.id,t.id,s,!0),kr(e,i)}}async function Ks(){ke&&ke(),xe&&xe(),await $t(),window.location.reload()}const ht=document.getElementById("app");ht.innerHTML=`<div style="position:fixed;inset:0;background:#0a0c10;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:9999;" id="loading-screen"><img src="/Logo_IPSC-insight.png" alt="Insight Dynamics Shooting" style="width:88px;height:88px;border-radius:20px;box-shadow:0 8px 32px rgba(232,184,75,0.18);margin-bottom:28px;"><div style="font-size:26px;font-weight:900;color:#f5f7fb;letter-spacing:1px;margin-bottom:8px;">INSIGHT DYNAMICS</div><div style="font-size:14px;color:#7d8598;font-weight:500;margin-bottom:40px;font-style:italic;">Analyse. Presisjon. Resultat.</div><div style="width:180px;height:3px;background:rgba(255,255,255,0.08);border-radius:99px;overflow:hidden;"><div style="height:100%;width:40%;background:#e8b84b;border-radius:99px;animation:ipsc-loading 1.2s ease-in-out infinite;"></div></div><style>@keyframes ipsc-loading{0%{margin-left:-40%}100%{margin-left:100%}}</style></div>`;i();
