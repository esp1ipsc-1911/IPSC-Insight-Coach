...
<div class="modal-overlay" id="modal-edit-match" onclick="closeModalOutside(event,'modal-edit-match')">
 ...
 <div class="field-group">
 <div class="field-label">Eksterne deltakere (kun for denne matchen)</div>
 <input class="field-input" type="text" id="edit-match-manual-name" placeholder="Navn" style="margin-bottom:10px;">
 <select class="field-select" id="edit-match-manual-division" style="margin-bottom:10px;"></select>
 <select class="field-select" id="edit-match-manual-pf" style="margin-bottom:10px;">
 <option value="minor">Minor</option>
 <option value="major">Major</option>
 </select>
 <button onclick="addEditMatchCompetitor()" style="width:100%;padding:12px;background:#e8b84b;color:#1a202c;border:none;border-radius:8px;font-weight:600;cursor:pointer;">Legg til ekstern deltaker</button>
 <div id="edit-match-manual-list" style="margin-top:10px;"></div>
 </div>
