...
<div class="gdpr-content">
 ...
 <p>Vi behandler fÃ¸lgende personopplysninger om deg:</p>
 <ul>
 ...
 <li><strong>Invitasjonskode:</strong> For Ã¥ verifisere din tilgang til tjenesten</li>
 </ul>

 <h3>3. FormÃ¥l og behandlingsgrunnlag</h3>
 <p>Vi behandler dine personopplysninger for fÃ¸lgende formÃ¥l:</p>
 <ul>
 <li><strong>Brukerkonto og autentisering:</strong> For Ã¥ opprette og administrere din konto (behandlingsgrunnlag: samtykke)</li>
 <li><strong>Treningsanalyse:</strong> For Ã¥ gi deg innsikt i dine prestasjoner og treningsutvikling (behandlingsgrunnlag: samtykke)</li>
 <li><strong>Deling av match-data:</strong> For Ã¥ dele resultater med andre brukere du inviterer (behandlingsgrunnlag: samtykke)</li>
 <li><strong>Teknisk drift:</strong> For Ã¥ sikre at tjenesten fungerer korrekt (behandlingsgrunnlag: berettiget interesse)</li>
 </ul>

 <h3>4. Lagring og teknisk lÃ¸sning</h3>
 <p>Dine opplysninger lagres og behandles ved hjelp av:</p>
 <ul>
 <li><strong>Google Firebase Authentication:</strong> Sikker hÃ¥ndtering av pÃ¥logging og brukerkonto</li>
 ...
 <p>
 Alle tjenester er hostet i EU/EÃS-regionen og fÃ¸lger GDPR-kravene. 
 Google Firebase er sertifisert under EU-U.S. Data Privacy Framework.
 </p>

 <h3>5. Deling av opplysninger</h3>
 <p>Dine personopplysninger deles kun i fÃ¸lgende tilfeller:</p>
 <ul>
 <li><strong>Match-deltakere:</strong> NÃ¥r du inviterer andre brukere til Ã¥ se eller samarbeide om en match, vil de se dine match-resultater og ditt navn</li>
 <li><strong>Tekniske leverandÃ¸rer:</strong> Google Firebase og GitHub (databehandlere) har tilgang til opplysningene som nÃ¸dvendig for Ã¥ levere tjenesten</li>
 </ul>
 <p>Vi selger eller utleverer aldri dine opplysninger til tredjeparter for markedsfÃ¸ringsformÃ¥l.</p>

 <h3>6. Lagringstid</h3>
 <p>
 Dine personopplysninger lagres sÃ¥ lenge du har en aktiv konto hos oss. 
 NÃ¥r du sletter kontoen din, vil alle dine personopplysninger bli slettet innen 30 dager.
 Match-data du har delt med andre brukere vil fortsatt vÃ¦re synlig for dem, men koblingen til din konto fjernes.
 </p>

 <h3>7. Dine rettigheter</h3>
 <p>Du har fÃ¸lgende rettigheter knyttet til dine personopplysninger:</p>
 <ul>
 <li><strong>Innsyn:</strong> Du kan nÃ¥r som helst be om Ã¥ fÃ¥ innsyn i hvilke opplysninger vi har om deg</li>
 <li><strong>Retting:</strong> Du kan endre dine profildata direkte i appen</li>
 <li><strong>Sletting:</strong> Du kan slette din konto og alle tilhÃ¸rende data</li>
 <li><strong>Tilbaketrekking av samtykke:</strong> Du kan nÃ¥r som helst trekke tilbake samtykket ditt ved Ã¥ slette kontoen</li>
 <li><strong>Dataportabilitet:</strong> Du kan be om Ã¥ fÃ¥ utlevert dine data i et maskinlesbart format</li>
 ...
 <p>
 Vi bruker Firebase Authentication med sikker kryptering for pÃ¥logging. 
 ...
 <p>
 Har du spÃ¸rsmÃ¥l om personvern eller Ã¸nsker Ã¥ utÃ¸ve dine rettigheter, kan du kontakte oss pÃ¥:<br>
 <strong>E-post:</strong> [DIN KONTAKT E-POST HER]
 </p>

 <h3>10. Endringer i personvernerklÃ¦ringen</h3>
 <p>
 Vi forbeholder oss retten til Ã¥ oppdatere denne personvernerklÃ¦ringen. 
 Ved vesentlige endringer vil du bli varslet ved innlogging.
 </p>

 <div class="gdpr-consent-box">
 <p><strong>Ved Ã¥ godta denne erklÃ¦ringen samtykker du til:</strong></p>
 <ul>
...
`;function At(e,i){const t=document.getElementById("gdpr-modal");t&&t.remove();const s=document.createElement("div");s.id="gdpr-modal",s.className="gdpr-modal",s.innerHTML=`
 ...
 <a href="#" class="gdpr-link" id="gdpr-open-modal">personvernerklÃ¦ringen</a>
 </span>
 </label>
 `,setTimeout(()=>{const i=e.querySelector("#gdpr-open-modal");i&&i.addEventListener("click",t=>{t.preventDefault(),At(()=>{const s=document.getElementById("gdpr-consent-checkbox");s&&(s.checked=!0)},()=>{const s=document.getElementById("gdpr-consent-checkbox");s&&(s.checked=!1)})})},0),e}function Dt(){const e=document.getElementById("gdpr-consent-checkbox");return!e||!e.checked?{valid:!1,error:"Du mÃ¥ godta personvernerklÃ¦ringen for Ã¥ registrere deg"}:{valid:!0}}function Bt(e,i){e.innerHTML=`
 <style>
 * {
...
<div class="screen" id="screen-matches">
 ...
 <div class="search-wrap"><span class="search-icon"></span><input class="search-input" id="match-id-search" placeholder="${d("search_match_placeholder")}" type="number"><button class="btn-primary" style="margin-left:10px;padding:8px 16px;font-size:14px;" onclick="searchMatchByIdHandler()">SÃ¸k</button></div>
...
<div class="screen" id="screen-prognose">
 ...
 <div id="prog-data-status" style="margin-top:12px;padding:12px;background:var(--bg);border-radius:8px;font-size:13px;color:var(--muted);text-align:center;display:none;">
  Ingen skutte stages ennÃ¥. Data vil vises etter at du har lagt til resultater.
 </div>
 </div>
...
<div class="screen" id="screen-results">
 ...
 <div class="match-chip-wrapper">
 <div class="match-chip" onclick="toggleMatchDropdown('live')">
 <div class="match-chip-dot"></div>
 <div class="match-chip-name" id="results-chip-name">${d("no_match_selected")}</div>
 <div class="match-chip-arrow">&#9660;</div>
 </div>
 <div class="match-dropdown" id="live-match-dropdown"></div>
 </div>
...
<div class="screen" id="screen-profile">
 ...
 <div class="profile-div" id="prof-div">${g.division||""} Â· ${g.club||""}</div>
...
<div class="modal-overlay" id="modal-new-match" onclick="closeModalOutside(event,'modal-new-match')">
 ...
 <div class="modal-close" onclick="closeModal('modal-new-match')" aria-label="Lukk">Ã</div>
 </div>
 ...
 <input class="field-input" type="text" id="new-match-user-search" placeholder="SÃ¸k etter navn eller e-post..." style="flex:1;">
 <button onclick="searchUsersNewMatch()" style="width:80px;padding:12px;background:#e8b84b;color:#1a202c;border:none;border-radius:8px;font-weight:600;cursor:pointer;">SÃ¸k</button>
 </div>
...
<div class="modal-overlay" id="modal-edit-match" onclick="closeModalOutside(event,'modal-edit-match')">
 ...
 <div class="modal-close" onclick="closeModal('modal-edit-match')" aria-label="Lukk">Ã</div>
 </div>
 <div class="modal-body">
 <div class="field-group">
 <div class="field-label">${d("match_name")}</div>
 ...
 <div class="field-label">Inviter brukere (valgfritt)</div>
 <div style="display:flex;gap:8px;margin-bottom:10px;">
 <input class="field-input" type="text" id="edit-match-user-search" placeholder="SÃ¸k etter navn eller e-post..." style="flex:1;">
 <button onclick="searchUsersEditMatch()" style="width:80px;padding:12px;background:#e8b84b;color:#1a202c;border:none;border-radius:8px;font-weight:600;cursor:pointer;">SÃ¸k</button>
 </div>
...
<div class="modal-overlay" id="modal-edit-profile" onclick="closeModalOutside(event,'modal-edit-profile')">
 ...
 <div class="modal-close" onclick="closeModal('modal-edit-profile')" aria-label="Lukk">Ã</div>
 </div>
 <div class="modal-body">
 <div class="field-group">
...
<div class="modal-overlay" id="modal-add-shooter" onclick="closeModalOutside(event,'modal-add-shooter')">
 ...
 <div class="modal-close" onclick="closeModal('modal-add-shooter')" aria-label="Lukk">Ã</div>
 </div>
 <div class="modal-body">
 <div class="field-group">
 <div class="field-label">${d("first_name")}</div>
...
<div class="modal-overlay" id="modal-upload-result" onclick="closeModalOutside(event,'modal-upload-result')">
 ...
 <div class="modal-close" onclick="closeModal('modal-upload-result')" aria-label="Lukk">Ã</div>
 </div>
 <div class="modal-body">
...
<div class="modal-overlay" id="modal-ocr-confirm" onclick="closeModalOutside(event,'modal-ocr-confirm')">
 ...
 <div class="modal-close" onclick="closeModal('modal-ocr-confirm')" aria-label="Lukk">Ã</div>
 </div>
 <div class="modal-body">
 ...
 <div style="font-size:12px;color:var(--muted);margin-bottom:4px;">Stage</div>
 <div id="ocr-stage-info" style="font-size:15px;font-weight:700;color:var(--text);">Ingen stage valgt</div>
 <div id="ocr-stage-shots-info" style="margin-top:6px;font-size:12px;color:var(--muted);"></div>
 </div>
 <div class="field-group">
 ...
 <div class="section-label" style="margin-top:15px;">Treffbilde <span style="font-size:12px;color:var(--muted);font-weight:400;">(lÃ¥st til <span id="ocr-total-display">0</span> treff)</span></div>
 ...
 <div class="field-input" style="display:flex;align-items:center;justify-content:space-between;background:var(--bg);gap:10px;min-width:0;">
 <span id="ocr-a-display" style="font-size:32px;font-weight:700;line-height:1;">0</span>
 <span style="font-size:12px;color:var(--muted);text-transform:uppercase;flex-shrink:0;">Auto</span>
 </div>
 </div>
 <div class="field-group" style="min-width:0;">
 <div class="field-label">Steel</div>
 <div style="display:grid;grid-template-columns:44px minmax(0,1fr) 44px;gap:8px;align-items:center;min-width:0;">
 <button type="button" onclick="adjustOcrHits('steel',-1)" style="width:44px;height:44px;border:none;border-radius:10px;background:var(--bg3);color:var(--text);font-size:24px;cursor:pointer;">â</button>
 <input class="field-input" type="number" id="ocr-steel" value="0" readonly style="text-align:center;background:var(--bg);width:100%;min-width:0;padding:12px 8px;">
 ...
 <div style="display:grid;grid-template-columns:44px minmax(0,1fr) 44px;gap:8px;align-items:center;min-width:0;">
 <button type="button" onclick="adjustOcrHits('c',-1)" style="width:44px;height:44px;border:none;border-radius:10px;background:var(--bg3);color:var(--text);font-size:24px;cursor:pointer;">â</button>
 <input class="field-input" type="number" id="ocr-c" value="0" readonly style="text-align:center;background:var(--bg);width:100%;min-width:0;padding:12px 8px;">
 ...
 <div style="display:grid;grid-template-columns:44px minmax(0,1fr) 44px;gap:8px;align-items:center;min-width:0;">
 <button type="button" onclick="adjustOcrHits('d',-1)" style="width:44px;height:44px;border:none;border-radius:10px;background:var(--bg3);color:var(--text);font-size:24px;cursor:pointer;">â</button>
 <input class="field-input" type="number" id="ocr-d" value="0" readonly style="text-align:center;background:var(--bg);width:100%;min-width:0;padding:12px 8px;">
 ...
 <div style="display:grid;grid-template-columns:44px minmax(0,1fr) 44px;gap:8px;align-items:center;min-width:0;">
 <button type="button" onclick="adjustOcrHits('miss',-1)" style="width:44px;height:44px;border:none;border-radius:10px;background:var(--bg3);color:var(--text);font-size:24px;cursor:pointer;">â</button>
 <input class="field-input" type="number" id="ocr-miss" value="0" readonly style="text-align:center;background:var(--bg);width:100%;min-width:0;padding:12px 8px;">
 ...
 <button type="button" onclick="adjustOcrPenalty('ns',-1)" style="width:44px;height:44px;border:none;border-radius:10px;background:var(--bg3);color:var(--text);font-size:24px;cursor:pointer;">â</button>
 <input class="field-input" type="number" id="ocr-ns" value="0" readonly style="text-align:center;flex:1;background:var(--bg);">
 <button type="button" onclick="adjustOcrPenalty('ns',1)" style="width:44px;height:44px;border:none;border-radius:10px;background:var(--bg3);color:var(--text);font-size:24px;cursor:pointer;">+</button>
 </div>
 </div>
 <div class="field-group">
 <div class="field-label">Proc (Procedural)</div>
 <div style="display:flex;align-items:center;gap:8px;">
 <button type="button" onclick="adjustOcrPenalty('proc',-1)" style="width:44px;height:44px;border:none;border-radius:10px;background:var(--bg3);color:var(--text);font-size:24px;cursor:pointer;">â</button>
 <input class="field-input" type="number" id="ocr-proc" value="0" readonly style="text-align:center;flex:1;background:var(--bg);">
 <button type="button" onclick="adjustOcrPenalty('proc',1)" style="width:44px;height:44px;border:none;border-radius:10px;background:var(--bg3);color:var(--text);font-size:24px;cursor:pointer;">+</button>
 </div>
 </div>
 </div>
...
<div class="modal-overlay" id="modal-add" onclick="closeModalOutside(event,'modal-add')">
 ...
 <div class="modal-close" onclick="closeModal('modal-add')" aria-label="Lukk">Ã</div>
 </div>
 <div class="modal-body">
 <div class="field-group">
...
<div class="modal-overlay" id="modal-create-stage" onclick="closeModalOutside(event,'modal-create-stage')">
 ...
 <div class="modal-close" onclick="closeModal('modal-create-stage')" aria-label="Lukk">Ã</div>
 </div>
 <div class="modal-body">
 <div class="field-group">
...
<div class="modal-overlay" id="modal-invite-user" onclick="closeModalOutside(event,'modal-invite-user')">
 ...
 <div class="modal-close" onclick="closeModal('modal-invite-user')" aria-label="Lukk">Ã</div>
 </div>
 <div class="modal-body">
 <div class="field-group">
 <div class="field-label">SÃ¸k etter navn eller e-post</div>
 <div style="display:flex;gap:8px;">
 <input class="field-input" type="text" id="user-search-input" placeholder="SÃ¸k..." style="flex:1;">
 <button onclick="searchUsers()" style="width:80px;padding:12px;background:#e8b84b;color:#1a202c;border:none;border-radius:8px;font-weight:600;cursor:pointer;">SÃ¸k</button>
 </div>
 </div>
...
<div class="modal-overlay" id="modal-invitations" onclick="closeModalOutside(event,'modal-invitations')">
 ...
 <div class="modal-close" onclick="closeModal('modal-invitations')" aria-label="Lukk">Ã</div>
 </div>
...
<div class="modal-overlay" id="modal-confirm-delete" onclick="closeModalOutside(event,'modal-confirm-delete')">
 ...
 <div class="modal-close" onclick="closeModal('modal-confirm-delete')" aria-label="Lukk">Ã</div>
 </div>
 <div class="modal-body">
 <p style="margin-bottom:15px;">Er du sikker pÃ¥ at du vil slette denne matchen?</p>
 ...
 <div class="empty-sub">Trykk pÃ¥ match-chip over eller gÃ¥ til Matcher-fanen</div>
 <button class="btn-primary btn-home-action" onclick="switchTab('screen-matches')">Se matcher</button>
 </div>
 `;return}let t="";t+='<div class="card">',t+='<div class="mhc-name">'+i.name+"</div>",t+='<div class="mhc-meta">'+We(i.date)+" Â· "+i.type+"</div>",t+='<div class="mhc-stats">',t+='<div><div class="mhc-val">'+(((a=i.stages)==null?void 0:a.length)||0)+'</div><div class="mhc-lbl">Stages</div></div>',t+='<div><div class="mhc-val">'+(((n=i.shooters)==null?void 0:n.length)||0)+'</div><div class="mhc-lbl">Skyttere</div></div>',t+="</div>",t+='<div style="display:flex;gap:10px;margin-top:15px;">',t+='<button class="btn-primary" onclick="openEditMatch()" style="flex:1;">Rediger match</button>',t+='<button class="btn-primary" onclick="openCreateStage()" style="flex:1;">Ny stage</button>',t+="</div>",t+='<div style="margin-top:10px;">',t+='<button class="btn-primary" onclick="openInviteUser()" style="width:100%;">Inviter bruker</button>',t+="</div>";const s=Pe();s&&i.ownerId===s.uid&&(t+='<div style="margin-top:10px;">',t+='<button onclick="confirmDeleteMatch()" style="width:100%;padding:12px;background:#ef4444;color:white;border:none;border-radius:8px;font-weight:600;cursor:pointer;">Slett match</button>',t+="</div>"),t+="</div>",i.stages&&i.stages.length>0&&(t+='<div class="section-title">Stages</div>',t+='<div class="card">',i.stages.forEach((r,u)=>{t+='<div class="stage-row" style="cursor:pointer;border-bottom:1px solid #2d3748;padding:12px 0;" onclick="openEditStage('+u+')">',t+='<div class="stage-num">S'+(r.number||u+1)+"</div>",t+='<div class="stage-info">',t+='<div class="stage-name">'+(r.name||"Stage "+(r.number||u+1))+"</div>",t+='<div class="stage-meta">',r.paperTargets&&(t+="Paper: "+r.paperTargets+" "),r.poppers&&(t+="Poppers: "+r.poppers+" "),r.plates&&(t+="Plates: "+r.plates+" "),r.noShoots&&(t+="NS: "+r.noShoots+" "),r.bonusPaperTargets&&(t+="Bonus: "+r.bonusPaperTargets+(r.bonusIncluded?" (included)":"")),t+="</div>",t+="</div>",t+="</div>"}),t+="</div>"),e.innerHTML=t}function fe(){const e=o("match-list-container");if(!e)return;let i=$.filter(s=>{if(ue==="all")return!0;if(ue==="active")return s.status!=="finished";if(ue==="trening")return s.type==="Trening";if(ue==="stevne")return s.type==="Stevne";const a=s.date?new Date(s.date).getFullYear().toString():"";return ue===a});if(i.length===0){e.innerHTML='<div class="empty-state"><div class="empty-sub">Ingen matcher funnet</div></div>';return}let t="";i.forEach(s=>{var r;const a=s.id!=null&&s.id.toString()===String(R),n=s.id?"Match ID "+s.id+" "+s.name:s.name;t+='<div class="match-row">',t+='<div class="match-row-icon'+(a?" is-active":"")+`" onclick="selectMatch('`+s.id+`')"></div>`,t+=`<div class="match-row-info" onclick="selectMatch('`+s.id+`')">`,t+='<div class="match-row-name">'+n+"</div>",t+='<div class="match-row-meta">'+We(s.date)+" Â· "+(s.location||s.type)+"</div>",t+="</div>",t+='<div class="match-row-right">',t+=`<button onclick="event.stopPropagation(); selectMatch('`+s.id+`'); openEditMatch();" style="padding:8px 16px;background:#e8b84b;color:#1a202c;border:none;border-radius:8px;font-weight:600;cursor:pointer;margin-bottom:8px;">Rediger</button>`,t+='<div class="match-stg-count">'+(((r=s.stages)==null?void 0:r.length)||0)+"</div>",t+='<div class="match-stg-lbl">stages</div>',t+="</div>",t+="</div>"}),e.innerHTML=t}function _e(){var n;const e=o("results-content");if(!e)return;const i=$.find(r=>r.id!=null&&r.id.toString()===String(R));if(!i){e.innerHTML='<div class="empty-state"><div class="empty-sub">Velg en match fÃ¸rst</div></div>';return}if(!i.shooters||i.shooters.length===0){e.innerHTML='<div class="empty-state"><div class="empty-icon"></div><div class="empty-title">Ingen skyttere</div><div class="empty-sub">Trykk + for Ã¥ legge til skyttere</div></div>';return}const t=icMatchTotals(i);if(!t.length){e.innerHTML='<div class="empty-state"><div class="empty-title">Ingen resultater ennÃ¥</div><div class="empty-sub">Live vises nÃ¥r stages har resultater</div></div>';return}let s='<div class="card">';s+='<div class="card-header"><div class="card-title">Standings</div></div>',s+='<div class="standings-table-wrap"><table class="standings-table">',s+='<thead><tr class="standings-header-row">',s+='<th class="standings-th standings-th-rank">#</th>',s+='<th class="standings-th standings-th-shooter">Skytter</th>',s+='<th class="standings-th standings-th-pts">STG PTS</th>',s+='<th class="standings-th standings-th-pct">%</th>',s+="</tr></thead>",s+="<tbody>";const a=((n=t[0])==null?void 0:n.totalStagePts)||0;t.forEach((r,u)=>{const m=a>0?(r.totalStagePts/a*100).toFixed(2):"0.00";s+='<tr class="standings-row">',s+='<td class="standings-td standings-td-rank">'+(u+1)+"</td>",s+='<td class="standings-td standings-td-shooter">',s+='<div class="standings-shooter-name">'+r.name+"</div>",s+='<div class="standings-shooter-meta">'+r.division+" Â· "+ge(r.pf||"minor")+"</div>",s+="</td>",s+='<td class="standings-td standings-td-pts">'+r.totalStagePts.toFixed(2)+"</td>",s+='<td class="standings-td standings-td-pct">'+m+"%</td>",s+="</tr>"}),s+="</tbody></table></div>",s+="</div>",e.innerHTML=s}function gt(){const e=le();["prof-avatar","nav-av-home","nav-av-matches","nav-av-prog","nav-av-results"].forEach(u=>{const m=o(u);m&&(m.textContent=e)});const t=o("prof-name");t&&(t.textContent=(g.firstName||"")+" "+(g.lastName||""));const s=o("prof-div");s&&(s.textContent=(g.division||"")+" Â· "+(g.club||""));const a=o("prof-badge-pf");a&&(a.textContent=g.powerFactor?ge(g.powerFactor):"");const n=o("prof-badge-region");n&&(n.textContent=g.region||"");const r={"info-firstname":g.firstName||"","info-lastname":g.lastName||"","info-division":g.division||"","info-category":g.category||"","info-pf":g.powerFactor?ge(g.powerFactor):"","info-region":g.region||"","info-club":g.club||""};Object.keys(r).forEach(u=>{const m=o(u);m&&(m.textContent=r[u])}),vt()}function vt(){const e=[];$.forEach(p=>{icCurrentResults(p).forEach(h=>e.push(h))});let i=0,t=0,s=0;e.forEach(p=>{i+=p.a||0,t+=(p.a||0)+(p.c||0)+(p.d||0),s+=p.hf||0});const a=e.length?(s/e.length).toFixed(2):"",n=t?Math.round(i/t*100)+"%":"",r=o("stat-matches");r&&(r.textContent=$.length);const u=o("stat-stages");u&&(u.textContent=e.length);const m=o("stat-avg-hf");m&&(m.textContent=a);const b=o("stat-a-rate");b&&(b.textContent=n);const f=o("prog-a-rate");f&&(f.textContent=n)}function Ns(){o("edit-firstname").value=g.firstName||"",o("edit-lastname").value=g.lastName||"",o("edit-club").value=g.club||"",o("edit-draw").value=g.draw||"",o("edit-reload").value=g.reloadTime||"";let e="";Yi.forEach(s=>{e+='<option value="'+s+'"'+(s===g.division?" selected":"")+">"+s+"</option>"}),o("edit-division").innerHTML=e;let i="";Qi.forEach(s=>{i+='<option value="'+s+'"'+(s===g.category?" selected":"")+">"+s+"</option>"}),o("edit-category").innerHTML=i;let t="";Xi.forEach(s=>{t+='<option value="'+s+'"'+(s===g.region?" selected":"")+">"+s+"</option>"}),o("edit-region").innerHTML=t,mt(),ie("modal-edit-profile")}function mt(){const e=F("edit-division"),i=Zi[e]||["minor","major"];let t="";i.forEach(s=>{const a=g.powerFactor===s;t+='<label class="pf-option'+(a?" active":"")+`" onclick="selectPF(this,'`+s+`')">`,t+='<input type="radio" name="pf" value="'+s+'">',t+='<div class="pf-label">'+s.toUpperCase()+"</div>",t+='<div class="pf-sub">'+(s==="major"?"170 PF":"<170 PF")+"</div>",t+="</label>"}),o("pf-options").innerHTML=t,i.indexOf(g.powerFactor)<0&&(g.powerFactor=i[0])}function $s(e,i){document.querySelectorAll(".pf-option").forEach(t=>t.classList.remove("active")),e.classList.add("active"),g.powerFactor=i}async function Fs(){g.firstName=F("edit-firstname").trim()||"",g.lastName=F("edit-lastname").trim()||"",g.division=F("edit-division")||"",g.category=F("edit-category")||"",g.region=F("edit-region")||"",g.club=F("edit-club").trim()||"",g.draw=he("edit-draw")||null,g.reloadTime=he("edit-reload")||null;const e=await Ot(g),i=o("save-profile-btn");e.success?(i.textContent=" Lagret!",i.style.background="var(--green)",setTimeout(()=>{i.textContent=d("save_profile"),i.style.background=""},1800)):(i.textContent=" Feil!",i.style.background="var(--red)",setTimeout(()=>{i.textContent=d("save_profile"),i.style.background=""},1800)),gt(),De(),te(),G("modal-edit-profile")}function icStageTotalsThrough(e,i){const t={};if(!e||i==null)return t;(e.shooters||[]).forEach(s=>{t[String(s.id)]={id:s.id,name:((s.firstName||"")+" "+(s.lastName||"")).trim()||"Skytter",division:s.division||"",pf:s.pf||"minor",totalStagePts:0,totalRawPts:0}});icStageDefs(e).filter(s=>(s.number||0)<=i).forEach(s=>{icStageMetricsForMatch(e,s).forEach(a=>{const n=String(a.id);t[n]||(t[n]={id:a.id,name:a.name,division:a.division||"",pf:a.pf||"minor",totalStagePts:0,totalRawPts:0}),t[n].totalStagePts+=(a.stagePts||0),t[n].totalRawPts+=(a.pts||0)})});return t}function As(e,i,t,s){if(!e||!t||!s)return null;const a=icCurrentShooter(e);if(!a)return null;const n=t.number!=null?t.number:t.num;if(n==null)return null;const r=icStageTotalsThrough(e,n),u=r[String(a.id)];if(!u)return null;let m=null;if(e.rivalId&&e.rivalId!=="me")m=(e.shooters||[]).find(C=>C&&String(C.id)===String(e.rivalId));const b=Object.values(r).filter(C=>String(C.id)!==String(a.id)&&isFinite(C.totalStagePts));if(!m&&b.length){const C=b.slice().sort((L,M)=>Math.abs((L.totalStagePts||0)-(u.totalStagePts||0))-Math.abs((M.totalStagePts||0)-(u.totalStagePts||0)));C.length&&(m=(e.shooters||[]).find(L=>String(L.id)===String(C[0].id))||null)}if(!m)return null;const f=r[String(m.id)];if(!f)return null;const p=((m.firstName||"")+" "+(m.lastName||"")).trim()||"Rival",h=(u.totalStagePts||0)-(f.totalStagePts||0),E=h>=0,k=Math.abs(h),P=s.number!=null?s.number:s.num;if(P==null)return null;const C=((a.stages||[]).slice().filter(L=>(L.num||L.number)<P).sort((L,M)=>(L.num||0)-(M.num||0))),L=icFormFromResults(C,P-1,a),M=L?icProjectNext(L,s):null;if(!M)return{statusText:(E?"LEDER ":"BAK ")+k.toFixed(1)+" stg pts",advice:E?`Du leder ${p}. Hold prosessen stabil og unngÃ¥ unÃ¸dvendige tap.`:`Du ligger bak ${p}. Neste stage blir viktig.`,rivalName:p,gap:h,targetHF:null,estHF:null,deltaHF:null};const D=((m.stages||[]).slice().filter(B=>(B.num||B.number)<P).sort((B,_)=>(B.num||0)-(_.num||0))),B=icFormFromResults(D,P-1,m),_=B?icProjectNext(B,s):null,K=Math.max(M.estHF||0,(_&&_.estHF)||0,.01),j=K>0?(M.estHF/K*M.maxPts):0,w=K>0?(((_&&_.estHF)||0)/K*M.maxPts):0;let y=null,H=null,Y=null,ce="",X="";if(E){y=Math.max(0,w-k),H=K>0?y/M.maxPts*K:null,Y=H!=null?H-M.estHF:null,ce=`LEDER ${k.toFixed(1)} stg pts`,X=y<=0?`Du leder ${p}. Holder du omtrent forventet nivÃ¥ (${M.estHF.toFixed(2)} HF), skal det vÃ¦re nok til Ã¥ beholde ledelsen.`:Y!=null&&Y<=0?`Du leder ${p}. For Ã¥ holde ledelsen holder det omtrent med ${H.toFixed(2)} HF, altsÃ¥ under eller rundt forventet nivÃ¥.`:Y!=null&&Y<=.35?`Du leder ${p}, men ikke slipp deg helt ned. Det krever omtrent ${H.toFixed(2)} HF for Ã¥ holde ledelsen, ca ${Y.toFixed(2)} HF over minimum.`:`Du leder ${p}, men stageen kan snu bildet. Hold prosessen stabil og unngÃ¥ miss/procedurals.`}else{if(y=w+k+.01,H=K>0?y/M.maxPts*K:null,Y=H!=null?H-M.estHF:null,ce=`BAK ${k.toFixed(1)} stg pts`,H==null)X=`Du ligger bak ${p}. Hold fokus pÃ¥ en ren og effektiv stage.`;else if(Y<=.2)X=`Du er tett bak ${p}. For Ã¥ ta inn forspranget trenger du omtrent ${H.toFixed(2)} HF, altsÃ¥ ca ${Y.toFixed(2)} HF over forventet nivÃ¥. Dette kan du dekke med litt bedre flyt og null unÃ¸dvendige feil.`;else if(Y<=.75){const pe=M.expTime&&H>0?Math.max(0,M.expTime-M.expPts/H):0,se=M.expTime?Math.max(0,H*M.expTime-M.expPts):0;X=`Du er bak ${p}. For Ã¥ ta inn forspranget mÃ¥ du fra forventet ${M.estHF.toFixed(2)} HF opp mot ca ${H.toFixed(2)} HF. Det er en delta pÃ¥ ${Y.toFixed(2)} HF. Tenk ca ${pe.toFixed(2)} sek raskere totalt eller rundt ${se.toFixed(1)} flere rÃ¥poeng, helst som en kombinasjon av begge.`}else{const pe=M.expTime&&H>0?Math.max(0,M.expTime-M.expPts/H):0,se=M.expTime?Math.max(0,H*M.expTime-M.expPts):0;X=`Du er et stykke bak ${p}. Target er omtrent ${H.toFixed(2)} HF mot forventet ${M.estHF.toFixed(2)} HF, altsÃ¥ en delta pÃ¥ ${Y.toFixed(2)} HF. Det er krevende. Du mÃ¥ hente dette med bÃ¥de bedre tempo og renere treffbilde â ca ${pe.toFixed(2)} sek raskere totalt og/eller rundt ${se.toFixed(1)} flere rÃ¥poeng.`}}return{statusText:ce,advice:X,rivalName:p,gap:h,targetHF:H,estHF:M.estHF,deltaHF:Y,rivalEstHF:(_&&_.estHF)||null,yourEstStagePts:j,rivalEstStagePts:w,requiredStagePts:y,maxStagePts:M.maxPts}}function De(){const e=ct(),i=o("prog-a-rate");i&&(i.textContent=e&&e.aPercent!==void 0?Math.round(e.aPercent*100)+"%":"");const t=o("prog-data-status");t&&(t.style.display=!e||e.completedStages===0?"block":"none"),Rs()}function Rs(){const e=$.find(a=>a.id!=null&&a.id.toString()===String(R)),i=o("prog-stages-container");if(!i||!e){i&&(i.innerHTML="");return}const t=icStageDefs(e);if(!t.length){i.innerHTML="";return}const s=icCurrentShooter(e),a=icCurrentResults(e),n=icCurrentShooterId(),rActive=getActiveReferenceShooters(e),nextStage=t.find(u=>!a.some(m=>String(m.num||m.number)===String(u.number))),overallForm=icFormFromResults(a,null,s),overallProjection=nextStage&&overallForm?icProjectNext(overallForm,nextStage):null;let r="";t.forEach(u=>{const m=icStageMetricsForMatch(e,u).map(E=>({...E,isMe:String(E.id)===String(n)||E.isMe})),b=m.length>0;let h=null;r+='<div class="card" style="margin-top:15px;border-left:4px solid '+(b?"var(--green)":"var(--muted)")+';">',r+='<div class="card-header">',r+='<div class="card-title">Stage '+u.number+". "+(u.name||("Stage "+u.number))+"</div>",r+='<span class="badge '+(b?"badge-green":"badge-gray")+'">'+(b?" SKUTT":" IKKE SKUTT")+"</span>",r+="</div>";if(b){r+='<div style="overflow-x:auto;margin-top:12px;">',r+='<table style="width:100%;font-size:12px;border-collapse:collapse;">',r+='<tr style="border-bottom:1px solid var(--border);color:var(--muted);">',r+='<th style="padding:8px 6px;text-align:left;">#</th>',r+='<th style="padding:8px 6px;text-align:left;">NAVN</th>',r+='<th style="padding:8px 6px;text-align:right;">PTS</th>',r+='<th style="padding:8px 6px;text-align:right;">STG</th>',r+='<th style="padding:8px 6px;text-align:right;">%</th>',r+='<th style="padding:8px 6px;text-align:right;">HF</th>',r+="</tr>",m.forEach(E=>{const k=E.isMe?"background:var(--accent-fade);font-weight:600;":"";r+='<tr style="'+k+'border-bottom:1px solid var(--border);">',r+='<td style="padding:8px 6px;">'+E.rank+"</td>",r+='<td style="padding:8px 6px;">'+E.name+"</td>",r+='<td style="padding:8px 6px;text-align:right;color:var(--accent);">'+E.pts.toFixed(1)+"</td>",r+='<td style="padding:8px 6px;text-align:right;">'+E.stagePts.toFixed(2)+"</td>",r+='<td style="padding:8px 6px;text-align:right;">'+E.stagePct.toFixed(2)+"%</td>",r+='<td style="padding:8px 6px;text-align:right;">'+(E.hf||0).toFixed(2)+"</td>",r+="</tr>"}),r+="</table>",r+="</div>";const f=a.filter(E=>(E.num||E.number)<=u.number).sort((E,k)=>(E.num||0)-(k.num||0)),p=m.find(E=>E.isMe);h=p?p.res:null;const E=icFormFromResults(f,u.number,s);if(E){const k=t.find(P=>P.number>u.number&&!a.some(C=>String(C.num||C.number)===String(P.number))),P=k?icProjectNext(E,k):null,Ce=a.filter(P=>(P.num||P.number)<u.number).sort((P,C)=>(P.num||0)-(C.num||0)),Le=icFormFromResults(Ce,u.number-1,s),Me=Le?icProjectNext(Le,u):null;r+='<div style="margin-top:15px;padding:12px;background:var(--bg);border-radius:8px;">',r+='<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;font-size:13px;">',r+='<div><div style="color:var(--muted);margin-bottom:4px;">t/skudd</div><div style="font-weight:600;">'+E.avgSplit.toFixed(3)+"s</div></div>",r+='<div><div style="color:var(--muted);margin-bottom:4px;">Treff</div><div style="font-weight:600;color:var(--green);">'+(E.aPercent*100).toFixed(0)+"%A</div></div>",r+='<div><div style="color:var(--muted);margin-bottom:4px;">Est. HF</div><div style="font-weight:600;color:var(--accent);">'+(Me?Me.estHF.toFixed(2):"â")+"</div></div>",r+="</div>",r+="</div>",P&&k&&(r+='<div style="margin-top:15px;padding:12px;background:var(--accent-fade);border-radius:8px;border-left:3px solid var(--accent);">',r+='<div style="font-size:12px;color:var(--muted);margin-bottom:8px;">NESTE: '+(k.name||("STAGE "+k.number)).toUpperCase()+" ("+P.shots+" SKUDD, "+P.reloads+" RELOAD"+(P.reloads===1?"":"S")+", MAX "+P.maxPts+" PTS)</div>",r+='<div style="font-size:14px;line-height:1.5;">'+Ds(h,k,E,e)+"</div>",r+="</div>");const C=Bs(f.length>1?f[f.length-2]:null,h,E),L=As(e,Le,u,u);C&&(r+='<div style="margin-top:15px;padding:12px;background:var(--card-bg);border-radius:8px;">',r+='<div style="font-size:12px;color:var(--muted);margin-bottom:8px;">ð¢ REFLEKSJON</div>',r+='<div style="font-size:13px;line-height:1.5;color:var(--text);">'+C+"</div>",r+="</div>"),L&&(r+='<div style="margin-top:15px;padding:12px;background:var(--bg);border-radius:8px;border-left:3px solid '+(L.gap>=0?"var(--green)":"var(--red)")+';">',r+='<div style="font-size:12px;color:var(--muted);margin-bottom:8px;">KONKURRANSEBILDE</div>',r+='<div style="font-size:14px;font-weight:700;margin-bottom:8px;">'+L.statusText+"</div>",r+='<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;font-size:12px;margin-bottom:10px;">',r+='<div><div style="color:var(--muted);margin-bottom:4px;">Est HF</div><div style="font-weight:700;color:var(--accent);">'+(L.estHF!=null?L.estHF.toFixed(2):"â")+"</div></div>",r+='<div><div style="color:var(--muted);margin-bottom:4px;">Target HF</div><div style="font-weight:700;color:var(--text);">'+(L.targetHF!=null?L.targetHF.toFixed(2):"â")+"</div></div>",r+='<div><div style="color:var(--muted);margin-bottom:4px;">Delta HF</div><div style="font-weight:700;color:'+(L.deltaHF!=null&&L.deltaHF>0?"var(--red)":"var(--green)")+';">'+(L.deltaHF!=null?(L.deltaHF>0?"+":"")+L.deltaHF.toFixed(2):"â")+"</div></div>",r+="</div>",r+='<div style="font-size:14px;line-height:1.55;">'+L.advice+"</div>",r+="</div>")}}else r+='<div style="padding:20px;text-align:center;color:var(--muted);font-size:13px;">Ingen resultater ennÃ¥. Last opp resultat eller legg til manuelt.</div>';const refCompare=h?{estHF:h.hf!=null?h.hf:null,expTime:h.time!=null?h.time:null}:nextStage&&String(u.number)===String(nextStage.number)&&overallProjection?overallProjection:null;rActive.length&&(r+=renderReferenceBenchmarkBlock(e,u,refCompare)),r+="</div>"}),i.innerHTML=r}function Ds(e,i,t,s){if(!i||!t)return"Hold samme rytme som hittil.";const a=icStageShots(i),n=Se(a,t.division||"Classic",t.pf||"minor"),r=Math.round((t.aPercent||0)*100),u=t.avgSplit?t.avgSplit.toFixed(3):"0.000";return t.aPercent<.7?`Behold tempoet, men gi siktet litt mer tid. Neste stage er ${a} skudd med ${n} reload${n===1?"":"s"}. Baseline nÃ¥ er ${r}%A og ${u}s/skudd.`:t.avgSplit<.22?`Bra flyt. Ikke jag mer tempo enn nÃ¸dvendig. Neste stage er ${a} skudd med ${n} reload${n===1?"":"s"}. Hold ${r}%A og ${u}s/skudd.`:`Hold samme rytme som hittil. Neste stage er ${a} skudd med ${n} reload${n===1?"":"s"}. Baseline nÃ¥ er ${r}%A og ${u}s/skudd.`}function Bs(e,i,t){if(!e||!i||!t)return null;const s=icStageShots(e),a=icStageShots(i);if(!s||!a)return null;const n=((e.time||0)-t.draw-Se(s,t.division||"Classic",t.pf||"minor")*t.reloadTime)/s,r=((i.time||0)-t.draw-Se(a,t.division||"Classic",t.pf||"minor")*t.reloadTime)/a,u=s>0?(e.a||0)/s:0,m=a>0?(i.a||0)/a:0;if(r>n+.05&&m<u-.1)return`Tempo og treff falt fra forrige stage (${n.toFixed(3)}s  ${r.toFixed(3)}s/skudd, ${(u*100).toFixed(0)}%A  ${(m*100).toFixed(0)}%A). Tenk gjennom hva som stjal tid og fokus.`;if(r>n+.05)return`Tempoet falt fra forrige stage (${n.toFixed(3)}s  ${r.toFixed(3)}s/skudd). Reflekter over hva som stjal tid.`;if(m<u-.1)return`Treffbildet falt fra forrige stage (${(u*100).toFixed(0)}%A  ${(m*100).toFixed(0)}%A). Vurder om du presset for hardt.`;if(r<n-.03&&m>=u-.05)return`Bra flyt. Du gikk raskere enn forrige stage uten stort tap i treffbildet.`;return null}async function Os(){const e=$.find(n=>n.id!=null&&n.id.toString()===String(R));if(!e)return;const i=F("new-shooter-firstname").trim(),t=F("new-shooter-lastname").trim(),s=F("new-shooter-division")||"Classic";if(!i||!t){alert("Fyll inn navn");return}const a={id:"s_"+Date.now(),isMe:!1,firstName:i,lastName:t,division:s,pf:"minor",club:"",stages:[]};e.shooters||(e.shooters=[]),e.shooters.push(a),await Ee(e.id,e),G("modal-add-shooter"),_e()}async function js(){const e=$.find(f=>f.id!=null&&f.id.toString()===String(R));if(!e)return;const i=A("new-result-stage",1),t=he("new-result-time",0),s=icRecalcPoints("new-result"),a=A("new-result-a",0),n=A("new-result-c",0),r=A("new-result-d",0),u=A("new-result-miss",0),m=A("new-result-ns",0),b=A("new-result-proc",0);if(t<=0||s<=0){alert("Tid og poeng mÃ¥ vÃ¦re stÃ¸rre enn 0");return}const f=icStageDefs(e).find(h=>h.number==i);if(!f){alert("Stage ikke funnet");return}const p=await icEnsureShooter(e,icCurrentShooterId());if(!p){alert("Skytter ikke funnet");return}const E=t>0?s/t:0,k={num:f.number,name:f.name||("Stage "+f.number),hf:E,time:t,pts:s,pf:icResultPF(p.pf||g.powerFactor||"minor"),a:a,c:n,d:r,miss:u,ns:m,proc:b,paperTargets:f.paperTargets||0,poppers:f.poppers||0,plates:f.plates||0};icUpsertStageResult(p,k),await Ee(e.id,{shooters:e.shooters}),G("modal-add"),te(),_e(),De()}function Us(){G("modal-upload-result"),Re()}async function Hs(e){if(!$.find(u=>u.id!=null&&u.id.toString()===String(R))){alert("Ingen aktiv match valgt");return}const i=o("upload-stage-select"),t=o("upload-shooter-select"),s=o("upload-result-file");if(!i.value||!t.value){alert("Velg stage og skytter");return}if(!s.files||s.files.length===0){alert("Velg en fil");return}const a=s.files[0];Me=i.value,icUploadShooterSel=t.value,icSetResultDialogMode("ocr");const n=e&&e.currentTarget?e.currentTarget:o("upload-scan-btn"),r=n?n.textContent:"Last opp og skann";n&&(n.textContent="Skanner...",n.disabled=!0);try{const u=await new Promise((m,b)=>{const f=new FileReader;f.onerror=()=>b(new Error("Kunne ikke lese filen")),f.onload=p=>m(p.target.result),f.readAsDataURL(a)}),m=await qi.recognize(u,"eng+nor",{logger:b=>console.log(b)}),f=(m&&m.data&&m.data.text?m.data.text:"").trim();if(console.log("OCR Text:",f),!f)throw new Error("Ingen tekst funnet i bildet");const p=zs(f);if(p.time==null&&p.a===0&&p.c===0&&p.d===0&&p.miss===0&&p.ns===0&&p.proc===0)throw new Error("Fant ingen resultater i bildet");o("ocr-time").value=p.time||"",o("ocr-a").value=p.a||0,o("ocr-c").value=p.c||0,o("ocr-d").value=p.d||0,o("ocr-miss").value=p.miss||0,o("ocr-steel").value=0,o("ocr-ns").value=p.ns||0,o("ocr-proc").value=p.proc||0,icUpdateManualStageInfo(),icNormalizeOcrHitCounts(),icRecalcPoints("ocr"),G("modal-upload-result"),ie("modal-ocr-confirm")}catch(u){console.error("OCR Error:",u),alert("Feil ved skanning: "+u.message)}finally{n&&(n.textContent=r,n.disabled=!1)}}function zs(e){const i={time:null,points:null,a:0,c:0,d:0,miss:0,ns:0,proc:0},t=e.replace(/\r/g,"\n"),s=t.replace(/[\n\r]+/g," ").toLowerCase(),a=(c=>{const l=(c||"").trim();if(!l)return null;const v=l.replace(/(?<=^|\s)[oO](?=$|\s)/g,"0").replace(/[|]/g,"1"),S=(v.match(/\d+\.\d+/g)||[]).map(x=>parseFloat(x)),x=(v.match(/(?<![\d.])\d+(?![\d.])/g)||[]).map(N=>parseInt(N,10));if(!S.length||x.length<2)return null;const N=S.findLast?S.findLast(z=>/^\d+\.\d{2}$/.test(String(z))):[...S].reverse().find(z=>/^\d+\.\d{2}$/.test(String(z)));const z=N!=null?N:S[S.length-1],V=x.slice(0,6);if(V.length<2)return null;const J={a:0,c:0,d:0,miss:0,ns:0,proc:0,time:z};return V.length>=6?(J.a=V[0],J.c=V[1],J.d=V[2],J.miss=V[3],J.ns=V[4],J.proc=V[5]):V.length===5?(J.a=V[0],J.c=V[1],J.d=V[2],J.miss=V[3],J.ns=V[4]):V.length===4?(J.a=V[0],J.c=V[1],J.d=V[2],J.miss=V[3]):(J.a=V[0],J.c=V[1],J.d=V[2]||0),J})(t.split("\n").map(c=>c.trim()).filter(Boolean).sort((c,l)=>((l.match(/\d/g)||[]).length+((l.match(/\d+\.\d+/g)||[]).length*10))-((c.match(/\d/g)||[]).length+((c.match(/\d+\.\d+/g)||[]).length*10)))[0]);if(a){i.a=a.a||0,i.c=a.c||0,i.d=a.d||0,i.miss=a.miss||0,i.ns=a.ns||0,i.proc=a.proc||0,i.time=a.time||null}const n=[/time[:\s]*(\d+\.?\d*)/i,/(\d+\.\d+)\s*s(?:ec)?/i,/^(\d+\.\d+)$/m];if(i.time==null)for(const c of n){const l=s.match(c);if(l){i.time=parseFloat(l[1]);break}}const r=[/(?:points?|pts?)[:\s]*(\d+)/i,/score[:\s]*(\d+)/i];for(const c of r){const l=s.match(c);if(l){i.points=parseInt(l[1]);break}}const u=[/(\d+)\s*a(?:lpha)?(?:\s|$)/i,/a(?:lpha)?[:\s]*(\d+)/i];if(!i.a)for(const c of u){const l=s.match(c);if(l){i.a=parseInt(l[1]);break}}const m=[/(\d+)\s*c(?:harlie)?(?:\s|$)/i,/c(?:harlie)?[:\s]*(\d+)/i];if(!i.c)for(const c of m){const l=s.match(c);if(l){i.c=parseInt(l[1]);break}}const b=[/(\d+)\s*d(?:elta)?(?:\s|$)/i,/d(?:elta)?[:\s]*(\d+)/i];if(!i.d)for(const c of b){const l=s.match(c);if(l){i.d=parseInt(l[1]);break}}const f=[/(\d+)\s*m(?:iss)?(?:\s|$)/i,/m(?:iss)?[:\s]*(\d+)/i];if(!i.miss)for(const c of f){const l=s.match(c);if(l){i.miss=parseInt(l[1]);break}}const p=[/(\d+)\s*n\/?s(?:\s|$)/i,/n\/?s[:\s]*(\d+)/i,/ns[:\s]*(\d+)/i,/no-?shoot[:\s]*(\d+)/i];if(!i.ns)for(const c of p){const l=s.match(c);if(l){i.ns=parseInt(l[1]);break}}const h=[/(\d+)\s*p(?:roc)?(?:\s|$)/i,/p(?:roc)?[:\s]*(\d+)/i,/procedural[:\s]*(\d+)/i];if(!i.proc)for(const c of h){const l=s.match(c);if(l){i.proc=parseInt(l[1]);break}}return i}async function Gs(){const e=$.find(P=>P.id!=null&&P.id.toString()===String(R));if(!e)return;const i=he("ocr-time",0),t=icRecalcPoints("ocr"),s=A("ocr-a",0),a=A("ocr-c",0),n=A("ocr-d",0),r=A("ocr-miss",0),u=A("ocr-steel",0),m=A("ocr-ns",0),b=A("ocr-proc",0);if(i<=0||t<=0){alert("Tid og poeng mÃ¥ vÃ¦re stÃ¸rre enn 0");return}const f=icStageDefs(e).find(P=>P.number==Me);if(!f){alert("Stage ikke funnet");return}const p=icStageShots(f),h=s+a+n+r+u;if(p>0&&h!==p){alert("Du mÃ¥ registrere nÃ¸yaktig "+p+" treff for denne stagen.");return}const E=await icEnsureShooter(e,icUploadShooterSel||icCurrentShooterId());if(!E){alert("Skytter ikke funnet");return}const k=i>0?t/i:0,P={num:f.number,name:f.name||("Stage "+f.number),hf:k,time:i,pts:t,pf:icResultPF(E.pf||g.powerFactor||"minor"),a:s,c:a,d:n,miss:r,steel:u,ns:m,proc:b,paperTargets:f.paperTargets||0,poppers:f.poppers||0,plates:f.plates||0};icUpsertStageResult(E,P),await Ee(e.id,{shooters:e.shooters}),G("modal-ocr-confirm"),te(),_e(),De(),Me=null,icUploadShooterSel=null,icSetResultDialogMode("ocr")}async function Ks(){ke&&ke(),xe&&xe(),await $t(),window.location.reload()}const ht=document.getElementById("app");function Vs(){Bt(ht,ft)}function ft(){ts(ht)}Ct(e=>{e?ft():Vs()});
