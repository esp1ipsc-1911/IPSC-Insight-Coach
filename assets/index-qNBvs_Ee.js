  ...
  try{
    ...
    img.onload=async function(){
      ...
      canvas.toBlob(async function(blob){
        try{
          const ref=_Fr(_Fstore,"avatars/"+uid+".jpg");
          await _Fu(ref,blob,{contentType:"image/jpeg"});
          const url=await _Fd(ref);
