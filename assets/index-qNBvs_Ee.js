 ...
 <div class="scroll-content">
  ...
  <div class="card">
   <div class="card-header" style="display:flex;align-items:center;gap:8px;">
    ...
    <div class="card-title">Personlig informasjon</div>
   </div>
  ...
  <div class="card">
   <div class="card-header" style="display:flex;align-items:center;gap:8px;">
    ...
    <div class="card-title">Sesongstatistikk</div>
   </div>
  ...
  <div class="card" style="margin-bottom:12px;">
   <div class="card-header" style="display:flex;align-items:center;gap:8px;">
    <div class="card-title" id="prof-lang-title">${dt==="no"?"Language / Language":"Language / Language"}</div>
   </div>
   <div style="display:flex;gap:10px;padding:4px 0;">
    <button id="prof-lang-no" onclick="setAppLang(\'no\')" style="flex:1;padding:10px;border-radius:10px;border:2px solid var(--accent);background:rgba(212,168,67,0.15);color:var(--accent);font-weight:700;font-size:15px;cursor:pointer;">🇳🇴 Norsk</button>
