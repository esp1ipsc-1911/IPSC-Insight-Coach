...
const mentalTips=[];
if(totalMiss>stageCount*0.5)mentalTips.push({t:"Indre dialog etter miss",b:"Identifiser sabotøren — stemmen som sier du er dårlig. Bruk SOAL: Stopp tanken, Observer uten å reagere, Aksepter at den er der, La den gå. Hjernen husker det siste bildet — visualiser straks hvordan du ville skutt stageen riktig. Gå videre med et positivt mentalt bilde."});
if(stageAPs.length>1){const _aps=stageAPs.map(function(x){return x.ap;});if(Math.max.apply(null,_aps)-Math.min.apply(null,_aps)>20)mentalTips.push({t:"Spenningsregulering — stor variasjon",b:"Stor variasjon mellom stages skyldes ofte ujevnt spenningsnivå. Finn ditt optimale nivå med en pustepause: pust inn 4 sek, hold 4, pust ut 6. Identifiser dine knagg-signaler — hva kjenner du i kroppen når du er i flytsonen? Bruk disse signalene bevisst før neste stage."});}
if(overallAP>=90&&avgHF<3.5)mentalTips.push({t:"Regulere opp — treffbildet er klart",b:"Kroppen er klar for mer tempo. Bruk et energigivende triggerord som Eksplosiv eller Nå, og visualiser stagene med høy intensitet og flyt. Tenk på hva denne matchen betyr for deg — indre motivasjon driver raskere og mer stabilt enn ytre press."});
if(totalProc>0)mentalTips.push({t:"Selektiv oppmerksomhet — procedurals",b:"Procedurals skjer når oppmerksomheten er rettet mot feil ting. Øv på å filtrere bort støy som RO-avgjørelser og baneforhold. Før neste stage: lukk øynene, visualiser stage-planen steg for steg og sjekk at alle regler sitter i hodet."});
const _gt=[
{t:"Triggerord",b:"Velg 1-2 ord som skaper riktig tilstand umiddelbart. Unngå ikke-ord — underbevisstheten filtrerer dem ut og du fokuserer på det du vil unngå. Gode eksempler: Pust, Flyt, Jeg er klar, Rå. Skriv dem ned og test dem i trening før du bruker dem i match."},
...
{t:"Indre motivasjon",b:"Hva driver deg egentlig? Glede av skyting, fellesskap, personlig utvikling? Nær den indre motivasjonen aktivt — ytre press som resultater og rangering gjør deg sårbar når ting går mot deg. Ha det gøy, nyt fellesskapet, og sørg for at du stadig opplever fremgang."},
{t:"Målsetting",b:"Sett mestringsmål fremfor bare resultatmål. Lag din egen skala 1-10 for f.eks. konsentrasjon, trekk eller stage-plan-etterlevelse. Skriv ned både målet og HVORDAN du skal jobbe for å nå det. Hvert delmål du når bringer deg ett steg nærmere det langsiktige målet."}
];
