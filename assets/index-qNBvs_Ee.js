...
.nav-refresh-btn:hover{color:var(--accent)!important;background:rgba(212,175,55,0.07)!important;}\
...
/* === FAB === */\
.fab{background:var(--accent)!important;color:#0a0c0e!important;border:none!important;border-radius:50%!important;width:54px!important;height:54px!important;font-size:22px!important;cursor:pointer!important;box-shadow:0 4px 20px rgba(212,175,55,0.30)!important;display:flex!important;align-items:center!important;justify-content:center!important;position:fixed!important;bottom:78px!important;right:18px!important;z-index:100!important;transition:transform 0.15s!important;}\
...
.field-input:focus,input:focus,textarea:focus,select:focus{border-color:rgba(212,175,55,0.45)!important;background:rgba(255,255,255,0.06)!important;}\
/* === STANDINGS TABLE === */\
...
/* === PROFILE AVATAR === */\
#prof-avatar{width:78px!important;height:78px!important;border-radius:50%!important;background:var(--accent)!important;color:#0a0c0e!important;font-weight:700!important;font-size:26px!important;display:flex!important;align-items:center!important;justify-content:center!important;box-shadow:0 0 0 3px var(--bg2),0 0 0 5px rgba(212,175,55,0.30),0 0 20px rgba(212,175,55,0.15)!important;overflow:hidden!important;cursor:pointer!important;}\
...
.ipad-sidebar{display:none;position:fixed;left:0;top:0;bottom:0;width:72px;background:linear-gradient(180deg,#0a0c0f 0%,#0d1017 60%,#0a0c0f 100%);border-right:1px solid rgba(212,175,55,0.10);flex-direction:column;align-items:center;padding:18px 0 16px;gap:2px;z-index:200;box-shadow:4px 0 40px rgba(0,0,0,0.6);}\
.ipad-logo{font-size:14px;font-weight:900;color:var(--accent);letter-spacing:0.1em;margin-bottom:20px;text-shadow:0 0 24px rgba(212,175,55,0.50);border-bottom:1px solid rgba(212,175,55,0.15);padding-bottom:16px;width:100%;text-align:center;}\
...
.ipad-nav-item:hover{color:rgba(212,175,55,0.8);background:rgba(212,175,55,0.05);}\
.ipad-nav-item.active{color:var(--accent);border-left-color:var(--accent);background:rgba(212,175,55,0.07);}\
.ipad-nav-item.active::after{content:'';position:absolute;right:0;top:50%;transform:translateY(-50%);width:3px;height:24px;background:var(--accent);border-radius:2px 0 0 2px;box-shadow:0 0 12px rgba(212,175,55,0.55);}\
...
.ipad-nav-item.active svg{filter:drop-shadow(0 0 6px rgba(212,175,55,0.50));}\
.ipad-nav-item:hover svg{transform:scale(1.12);}\
.ipad-panel-label{display:none;font-size:9px;font-weight:900;letter-spacing:0.12em;color:var(--accent);margin-bottom:14px;padding-bottom:10px;border-bottom:1px solid rgba(212,175,55,0.15);text-transform:uppercase;text-shadow:0 0 16px rgba(212,175,55,0.25);}\
...
.fab{right:24px!important;bottom:24px!important;box-shadow:0 4px 24px rgba(212,175,55,0.30)!important;}\
...
.ipad-live-left{width:36%!important;min-width:260px!important;padding:20px!important;overflow-y:auto!important;height:100%!important;box-sizing:border-box!important;border-right:1px solid rgba(212,175,55,0.07)!important;background:rgba(0,0,0,0.15)!important;}\
...
.ipad-left-panel{width:42%!important;min-width:260px!important;padding:20px!important;overflow-y:auto!important;height:100%!important;box-sizing:border-box!important;border-right:1px solid rgba(212,175,55,0.07)!important;background:rgba(0,0,0,0.2)!important;}\
...
.ipad-profile-left{width:32%!important;min-width:240px!important;padding:24px 20px!important;overflow-y:auto!important;height:100%!important;box-sizing:border-box!important;border-right:1px solid rgba(212,175,55,0.07)!important;background:rgba(0,0,0,0.25)!important;display:flex!important;flex-direction:column!important;align-items:center!important;}\
...
.home-hero{background:linear-gradient(135deg,rgba(15,20,15,0.98),rgba(13,14,12,0.98));border:1px solid rgba(212,175,55,0.20);border-left:3px solid var(--accent);border-radius:10px;padding:22px 24px;margin-bottom:16px;position:relative;overflow:hidden;max-width:680px;}\
...
.sec-bdg:hover,.sec-bdg.blue{background:rgba(212,175,55,0.10);border-color:rgba(212,175,55,0.25);color:var(--accent);}\
.sec-bdg.green{background:rgba(76,175,125,0.12);border-color:rgba(76,175,125,0.3);color:var(--green);}\
/* DATE BADGE */\
.dt-bdg{background:rgba(212,175,55,0.10);border:1px solid rgba(212,175,55,0.25);border-radius:10px;padding:7px 9px;text-align:center;flex-shrink:0;min-width:46px;}\
.dt-day{font-size:19px;font-weight:900;color:var(--accent);line-height:1;}\
.dt-mon{font-size:9px;font-weight:800;letter-spacing:0.06em;color:rgba(212,175,55,0.6);text-transform:uppercase;margin-top:2px;}\
/* DASHED EMPTY */\
...
.ml-it:hover{border-color:rgba(212,175,55,0.25);}\
...
.reg-b{background:rgba(212,175,55,0.15);border:1px solid rgba(212,175,55,0.25);color:var(--accent);border-radius:6px;padding:3px 8px;font-size:10px;font-weight:700;cursor:pointer;}\
/* ATTENTION */\
.att-it{display:flex;align-items:center;gap:10px;padding:10px 12px;background:rgba(212,175,55,0.05);border:1px solid rgba(212,175,55,0.18);border-radius:9px;margin-bottom:7px;}\
...
<div class="modal-overlay" id="modal-new-match" onclick="closeModalOutside(event,'modal-new-match')">
 ...
 <button onclick="searchUsersNewMatch()" style="width:80px;padding:12px;background:#D4AF37;color:#0a0c0e;border:none;border-radius:6px;font-family:\'Outfit\',sans-serif;font-weight:700;cursor:pointer;">Search</button>
 </div>
...
<div class="modal-overlay" id="modal-edit-match" onclick="closeModalOutside(event,'modal-edit-match')">
 ...
 <button onclick="searchUsersEditMatch()" style="width:80px;padding:12px;background:#D4AF37;color:#0a0c0e;border:none;border-radius:6px;font-family:\'Outfit\',sans-serif;font-weight:700;cursor:pointer;">Search</button>
 </div>
...
<div class="modal-overlay" id="modal-invite-user" onclick="closeModalOutside(event,'modal-invite-user')">
 ...
 <button onclick="searchUsers()" style="width:80px;padding:12px;background:#D4AF37;color:#0a0c0e;border:none;border-radius:6px;font-family:\'Outfit\',sans-serif;font-weight:700;cursor:pointer;">Search</button>
 </div>
 </div>
...
function icGetXPLevel(xp) {
  ...
  if (xp >= 1000) return {level: 3, name: 'Gold', color: '#E8B84B', glow: 'rgba(212,175,55,0.25)'};
...
function icRenderRewards() {
  ...
  function badgeSVG(tier, size) {
    ...
    const colors = {
      ...
      gold:    {fill:'#E8B84B', glow:'rgba(212,175,55,0.55)',  stroke:'#b8901f'},
...
t+='<textarea id="hero-goal-input" style="width:100%;background:rgba(255,255,255,0.06);border:1px solid rgba(212,175,55,0.35);border-radius:8px;color:var(--text);font-size:14px;padding:10px 12px;resize:none;outline:none;box-sizing:border-box;font-family:inherit;line-height:1.5;" rows="3" placeholder="Write your season goal here...">'+_goal.replace(/</g,"&lt;").replace(/>/g,"&gt;")+'</textarea>';
...
(function(){
  ...
  var colors=['#D4AF37','#4caf7d','#60a5fa','#f87171','#a78bfa','#fb923c','#34d399','#f472b6'];
...
window.setAppLang=function setAppLang(lang){
  ...
  if(btnNo&&btnEn){
    if(no){
      btnNo.style.borderColor="#D4AF37";btnNo.style.background="rgba(212,175,55,0.15)";btnNo.style.color="#D4AF37";
      btnEn.style.borderColor="rgba(255,255,255,0.15)";btnEn.style.background="transparent";btnEn.style.color="var(--muted)";
    }else{
      btnEn.style.borderColor="#D4AF37";btnEn.style.background="rgba(212,175,55,0.15)";btnEn.style.color="#D4AF37";
