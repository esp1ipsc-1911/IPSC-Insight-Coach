...
<div class="modal-overlay" id="modal-upload-result" onclick="closeModalOutside(event,'modal-upload-result')">
  <div class="modal-sheet" onclick="event.stopPropagation()">
    ...
    <div class="modal-body">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;"><button class="btn-secondary" onclick="icOpenManualResult()">Registrer manuelt</button><button class="btn-primary" onclick="uploadAndScanResult()">Last opp og skann</button></div>
    </div>
  </div>
</div>
...
<div class="modal-overlay" id="modal-ocr-confirm" onclick="closeModalOutside(event,'modal-ocr-confirm')">
  <div class="modal-sheet" onclick="event.stopPropagation()">
    <div class="modal-header">
      <div class="modal-title">Bekreft resultat</div>
      <div class="modal-close" onclick="closeModal('modal-ocr-confirm')">✕</div>
    </div>
    <div class="modal-body">
      <div style="margin-bottom:15px;color:var(--muted);font-size:13px;">Kontroller og rediger verdiene. Poeng beregnes automatisk fra Minor/Major og treffbildet.</div>
      <div class="field-group">
