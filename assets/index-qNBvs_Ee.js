...
<div class="screen" id="screen-profile">
 ...
 <div class="card" style="margin-bottom:12px;">
  <div class="card-header"><div class="card-title" id="prof-lang-title">'+d('language_title')+(dt==="no"?' / Language':' / Språk')+'</div></div>
...
<div class="screen" id="screen-teams">
 ...
 <button class="btn-primary" onclick="openCreateTeam()" style="width:100%;">'+d('create_new_team')+'</button>
 </div>
...
<div class="modal-overlay" id="modal-edit-match" onclick="closeModalOutside(event,'modal-edit-match')">
 ...
 <button class="btn-primary" onclick="openCreateStageFromEdit()" style="width:100%;">'+d('add_stage')+'</button>
 </div>
 <div class="field-group">
 <label style="display:flex;align-items:center;gap:10px;cursor:pointer;">
 ...
 <button id="delete-match-btn" onclick="confirmDeleteMatch()" style="width:100%;margin-top:10px;padding:12px;background:#ef4444;color:white;border:none;border-radius:8px;font-weight:600;cursor:pointer;display:none;">'+d('delete_match')+'</button>
 </div>
 </div>
</div>
