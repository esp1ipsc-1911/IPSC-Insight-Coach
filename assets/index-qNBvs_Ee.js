...
function renderProfileMatchTips(){
  const container=o("profile-match-tips");
  ...
  myMatches.forEach(function(match,mi){
    ...
    let tHF=0,tA=0,tHits=0;
    myShooter.stages.forEach(function(s){
      tHF+=s.hf||0;tA+=s.a||0;
      tHits+=(s.a||0)+(s.c||0)+(s.d||0)+(s.miss||0);
    });
