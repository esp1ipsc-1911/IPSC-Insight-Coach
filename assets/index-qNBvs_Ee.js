...
try{await de(U(O,"matches",e.toString()),{participants:newParticipants,updatedAt:Ie()});console.log("[Jt] Steg 2 OK - match oppdatert");}catch(e2){console.error("[Jt] Steg 2 FEIL - updateDoc match:",e2.message);return{success:!1,error:"Steg2: "+e2.message};}
