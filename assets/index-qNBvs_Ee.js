...
/* === TAB BAR === */\
.tab-bar{background:var(--bg2)!important;border-top:1px solid var(--border)!important;padding:8px 0 6px!important;}\
.tab-item{color:var(--muted)!important;font-size:9px!important;font-weight:700!important;letter-spacing:0.05em!important;text-transform:uppercase!important;transition:color 0.15s!important;position:relative!important;padding:4px 0 2px!important;display:flex!important;flex-direction:column!important;align-items:center!important;gap:3px!important;}\
...
<div class="modal-overlay" id="modal-create-stage" onclick="closeModalOutside(event,'modal-create-stage')">
 ...
 <input class="field-input" type="text" id="stage-name" placeholder="Name" style="font-size:16px;font-weight:600;">
 </div>
 ...
 <div style="display:flex;align-items:center;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:10px;overflow:hidden;">
  <button onclick="changeStageField('paper-targets', -1)" style="width:40px;height:42px;font-size:20px;font-weight:700;background:transparent;color:rgba(255,255,255,0.6);border:none;border-right:1px solid rgba(255,255,255,0.08);cursor:pointer;flex-shrink:0;">−</button>
  <input class="field-input" type="number" id="stage-paper-targets" value="0" readonly style="text-align:center;font-size:18px;font-weight:700;width:100%;background:transparent;border:none;color:#f0f2f5;padding:0;">
  <button onclick="changeStageField('paper-targets', 1)" style="width:40px;height:42px;font-size:20px;font-weight:700;background:transparent;color:rgba(255,255,255,0.6);border:none;border-left:1px solid rgba(255,255,255,0.08);cursor:pointer;flex-shrink:0;">+</button>
 </div>
</div>
  <div style="display:flex;flex-direction:column;gap:4px;">
 ...
 <div style="display:flex;align-items:center;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:10px;overflow:hidden;">
  <button onclick="changeStageField('poppers', -1)" style="width:40px;height:42px;font-size:20px;font-weight:700;background:transparent;color:rgba(255,255,255,0.6);border:none;border-right:1px solid rgba(255,255,255,0.08);cursor:pointer;flex-shrink:0;">−</button>
  <input class="field-input" type="number" id="stage-poppers" value="0" readonly style="text-align:center;font-size:18px;font-weight:700;width:100%;background:transparent;border:none;color:#f0f2f5;padding:0;">
  <button onclick="changeStageField('poppers', 1)" style="width:40px;height:42px;font-size:20px;font-weight:700;background:transparent;color:rgba(255,255,255,0.6);border:none;border-left:1px solid rgba(255,255,255,0.08);cursor:pointer;flex-shrink:0;">+</button>
 </div>
</div>
  <div style="display:flex;flex-direction:column;gap:4px;">
 ...
 <div style="display:flex;align-items:center;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:10px;overflow:hidden;">
  <button onclick="changeStageField('plates', -1)" style="width:40px;height:42px;font-size:20px;font-weight:700;background:transparent;color:rgba(255,255,255,0.6);border:none;border-right:1px solid rgba(255,255,255,0.08);cursor:pointer;flex-shrink:0;">−</button>
  <input class="field-input" type="number" id="stage-plates" value="0" readonly style="text-align:center;font-size:18px;font-weight:700;width:100%;background:transparent;border:none;color:#f0f2f5;padding:0;">
  <button onclick="changeStageField('plates', 1)" style="width:40px;height:42px;font-size:20px;font-weight:700;background:transparent;color:rgba(255,255,255,0.6);border:none;border-left:1px solid rgba(255,255,255,0.08);cursor:pointer;flex-shrink:0;">+</button>
 </div>
</div>
  <div style="display:flex;flex-direction:column;gap:4px;">
 ...
 <div style="display:flex;align-items:center;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:10px;overflow:hidden;">
  <button onclick="changeStageField('no-shoots', -1)" style="width:40px;height:42px;font-size:20px;font-weight:700;background:transparent;color:rgba(255,255,255,0.6);border:none;border-right:1px solid rgba(255,255,255,0.08);cursor:pointer;flex-shrink:0;">−</button>
  <input class="field-input" type="number" id="stage-no-shoots" value="0" readonly style="text-align:center;font-size:18px;font-weight:700;width:100%;background:transparent;border:none;color:#f0f2f5;padding:0;">
  <button onclick="changeStageField('no-shoots', 1)" style="width:40px;height:42px;font-size:20px;font-weight:700;background:transparent;color:rgba(255,255,255,0.6);border:none;border-left:1px solid rgba(255,255,255,0.08);cursor:pointer;flex-shrink:0;">+</button>
 </div>
</div>
  <div style="display:flex;flex-direction:column;gap:4px;">
 ...
 <div style="display:flex;align-items:center;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:10px;overflow:hidden;">
  <button onclick="changeStageField('bonus-paper-targets', -1)" style="width:40px;height:42px;font-size:20px;font-weight:700;background:transparent;color:rgba(255,255,255,0.6);border:none;border-right:1px solid rgba(255,255,255,0.08);cursor:pointer;flex-shrink:0;">−</button>
  <input class="field-input" type="number" id="stage-bonus-paper-targets" value="0" readonly style="text-align:center;font-size:18px;font-weight:700;width:100%;background:transparent;border:none;color:#f0f2f5;padding:0;">
  <button onclick="changeStageField('bonus-paper-targets', 1)" style="width:40px;height:42px;font-size:20px;font-weight:700;background:transparent;color:rgba(255,255,255,0.6);border:none;border-left:1px solid rgba(255,255,255,0.08);cursor:pointer;flex-shrink:0;">+</button>
 </div>
</div>
  <div></div>
 </div>
 <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;"><button onclick="deleteCurrentStage()" style="padding:14px;background:rgba(239,68,68,0.12);border:1px solid rgba(239,68,68,0.4);border-radius:12px;color:#f87171;font-size:15px;font-weight:700;cursor:pointer;">Delete Stage</button><button class="btn-primary" onclick="saveStage()" style="margin-top:0;">${d("save")}</button></div>
 </div>
 </div>
</div>
