...
// Steg 1: Legg brukeren til participants i matchen (invitasjonen er fortsatt "pending" her)
await de(U(O,"matches",e.toString()),{participants:st(i.uid),updatedAt:Ie()});
