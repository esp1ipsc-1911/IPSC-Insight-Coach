...
html+="</div>";return html;}function icSeasonAnalysis(matches){
  ...
  var html='<button onclick="var x=document.getElementById(\'sa-body\');x&&(x.style.display=x.style.display===\'none\'?\'block\':\'none\');this.querySelector(\'.sa-arrow\').textContent=x&&x.style.display===\'block\'?\'\u25bc\':\'\u25b6\';" style="width:100%;padding:12px 14px;background:var(--card);border:1px solid rgba(232,184,75,0.2);border-radius:12px;color:var(--text);font-size:13px;font-weight:700;cursor:pointer;text-align:left;display:flex;justify-content:space-between;align-items:center;">';
...
function icTrainingSeasonAnalysis(matches){
  ...
  var html='<button onclick="var x=document.getElementById(\'ta-body\');x&&(x.style.display=x.style.display===\'none\'?\'block\':\'none\');this.querySelector(\'.ta-arrow\').textContent=x&&x.style.display===\'block\'?\'\u25bc\':\'\u25b6\';" style="width:100%;padding:12px 14px;background:var(--card);border:1px solid rgba(76,175,125,0.2);border-radius:12px;color:var(--text);font-size:13px;font-weight:700;cursor:pointer;text-align:left;display:flex;justify-content:space-between;align-items:center;">';
