...
html+="</div>";return html;}function icSeasonAnalysis(matches){
  ...
  // Mental trening
  var mental=[];
  if(apSpread>15)mental.push({t:"Spenningsregulering",b:"Large variation between matches is often caused by uneven activation levels. Find your optimal zone: what do you feel in your body when you are in the flow state? Use this as your reference point and adjust deliberately before each match."});
