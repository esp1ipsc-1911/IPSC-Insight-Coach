 ...
 *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
 ...
 html, body { background: var(--bg); color: var(--text); font-family: 'Rajdhani', sans-serif; min-height: 100vh; }
 .login-page {
 ...
 .field-lbl { font-family: 'Share Tech Mono', monospace; font-size: 10px; letter-spacing: 0.14em; color: var(--muted); text-transform: uppercase; margin-bottom: 7px; display: flex; align-items: center; gap: 6px; }
 ...
 .btn-primary { width: 100%; padding: 12px; background: var(--accent); color: #0a0c0e; border: none; border-radius: 6px; font-family: 'Oswald', sans-serif; font-size: 15px; font-weight: 600; letter-spacing: 0.08em; text-transform: uppercase; cursor: pointer; margin-top: 6px; transition: filter 0.15s, transform 0.12s; } .btn-primary:hover { filter: brightness(1.08); } .btn-primary:active { transform: translateY(1px); }
 .btn-primary:hover { opacity: 0.88; }
 .btn-primary:disabled { opacity: 0.5; cursor: not-allowed; }
 .btn-secondary { width: 100%; padding: 11px; background: transparent; color: var(--accent); border: 1px solid rgba(245,200,0,0.30); border-radius: 6px; font-family: 'Oswald', sans-serif; font-size: 14px; font-weight: 600; letter-spacing: 0.08em; text-transform: uppercase; cursor: pointer; transition: background 0.15s; }
 ...
 .gdpr-close { width: 100%; margin-top: 18px; padding: 12px; background: var(--accent); color: #0a0c0e; border: none; border-radius: 6px; font-family: 'Oswald', sans-serif; font-size: 12px; font-weight: 800; letter-spacing: 0.12em; text-transform: uppercase; cursor: pointer; }
...
html,body,*{background-color:inherit;font-family:'Rajdhani',sans-serif!important;}html,body{background:var(--bg)!important;color:var(--text)!important;}\
...
.nav-refresh-btn:hover{color:var(--accent)!important;background:rgba(59,130,246,0.08)!important;}\
...
.btn-secondary,.secondary-btn{background:transparent!important;border:1px solid rgba(59,130,246,0.28)!important;border-radius:var(--radius-sm)!important;color:var(--accent)!important;font-size:11px!important;font-weight:700!important;letter-spacing:0.08em!important;text-transform:uppercase!important;padding:8px 12px!important;cursor:pointer!important;transition:background 0.15s,border-color 0.15s!important;}\
.btn-secondary:hover{background:var(--accent-fade)!important;border-color:rgba(59,130,246,0.5)!important;}\
/* === FAB === */\
...
.field-input:focus,input:focus,textarea:focus,select:focus{border-color:rgba(59,130,246,0.45)!important;background:rgba(255,255,255,0.06)!important;}\
/* === STANDINGS TABLE === */\
...
/* === PROFILE AVATAR === */\
#prof-avatar{width:78px!important;height:78px!important;border-radius:50%!important;background:linear-gradient(135deg,var(--accent) 0%,var(--accent2) 100%)!important;color:#ffffff!important;font-weight:900!important;font-size:26px!important;display:flex!important;align-items:center!important;justify-content:center!important;box-shadow:0 0 0 3px var(--bg2),0 0 0 5px rgba(59,130,246,0.35),0 0 20px rgba(59,130,246,0.2)!important;overflow:hidden!important;cursor:pointer!important;}\
...
.ipad-sidebar{display:none;position:fixed;left:0;top:0;bottom:0;width:72px;background:linear-gradient(180deg,#0a0c0f 0%,#0d1017 60%,#0a0c0f 100%);border-right:1px solid rgba(59,130,246,0.12);flex-direction:column;align-items:center;padding:18px 0 16px;gap:2px;z-index:200;box-shadow:4px 0 40px rgba(0,0,0,0.6);}\
.ipad-logo{font-size:14px;font-weight:900;color:var(--accent);letter-spacing:0.1em;margin-bottom:20px;text-shadow:0 0 24px rgba(59,130,246,0.5);border-bottom:1px solid rgba(59,130,246,0.15);padding-bottom:16px;width:100%;text-align:center;}\
...
.ipad-nav-item.active::after{content:'';position:absolute;right:0;top:50%;transform:translateY(-50%);width:3px;height:24px;background:var(--accent);border-radius:2px 0 0 2px;box-shadow:0 0 12px rgba(59,130,246,0.6);}\
...
.ipad-nav-item.active svg{filter:drop-shadow(0 0 6px rgba(59,130,246,0.5));}\
.ipad-nav-item:hover svg{transform:scale(1.12);}\
.ipad-panel-label{display:none;font-size:9px;font-weight:900;letter-spacing:0.12em;color:var(--accent);margin-bottom:14px;padding-bottom:10px;border-bottom:1px solid rgba(59,130,246,0.15);text-transform:uppercase;text-shadow:0 0 16px rgba(59,130,246,0.3);}\
...
.fab{right:24px!important;bottom:24px!important;box-shadow:0 4px 24px rgba(59,130,246,0.35)!important;}\
...
.ipad-live-left{width:36%!important;min-width:260px!important;padding:20px!important;overflow-y:auto!important;height:100%!important;box-sizing:border-box!important;border-right:1px solid rgba(59,130,246,0.08)!important;background:rgba(0,0,0,0.15)!important;}\
...
.ipad-left-panel{width:42%!important;min-width:260px!important;padding:20px!important;overflow-y:auto!important;height:100%!important;box-sizing:border-box!important;border-right:1px solid rgba(59,130,246,0.08)!important;background:rgba(0,0,0,0.2)!important;}\
...
.ipad-profile-left{width:32%!important;min-width:240px!important;padding:24px 20px!important;overflow-y:auto!important;height:100%!important;box-sizing:border-box!important;border-right:1px solid rgba(59,130,246,0.08)!important;background:rgba(0,0,0,0.25)!important;display:flex!important;flex-direction:column!important;align-items:center!important;}\
...
.hero-goal-wrap{}\
#hero-goal-input:focus{border-color:rgba(59,130,246,0.6);box-shadow:0 0 0 2px rgba(59,130,246,0.1);}\
...
.hero-btn-p{background:var(--accent);color:#fff;border:none;border-radius:8px;padding:10px 20px;font-size:11px;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;cursor:pointer;}\
...
.sec-bdg:hover,.sec-bdg.blue{background:rgba(59,130,246,0.12);border-color:rgba(59,130,246,0.3);color:var(--accent);}\
.sec-bdg.green{background:rgba(76,175,125,0.12);border-color:rgba(76,175,125,0.3);color:var(--green);}\
/* DATE BADGE */\
.dt-bdg{background:rgba(59,130,246,0.12);border:1px solid rgba(59,130,246,0.25);border-radius:10px;padding:7px 9px;text-align:center;flex-shrink:0;min-width:46px;}\
.dt-day{font-size:19px;font-weight:900;color:var(--accent);line-height:1;}\
.dt-mon{font-size:9px;font-weight:800;letter-spacing:0.06em;color:rgba(59,130,246,0.7);text-transform:uppercase;margin-top:2px;}\
/* DASHED EMPTY */\
...
.ml-it:hover{border-color:rgba(59,130,246,0.3);}\
...
.reg-b{background:rgba(59,130,246,0.15);border:1px solid rgba(59,130,246,0.3);color:var(--accent);border-radius:6px;padding:3px 8px;font-size:10px;font-weight:700;cursor:pointer;}\
/* ATTENTION */\
...
<div class="modal-overlay" id="modal-new-match" onclick="closeModalOutside(event,'modal-new-match')">
 ...
 <button onclick="searchUsersNewMatch()" style="width:80px;padding:12px;background:#3b82f6;color:#ffffff;border:none;border-radius:8px;font-weight:600;cursor:pointer;">Search</button>
 </div>
...
<div class="modal-overlay" id="modal-edit-match" onclick="closeModalOutside(event,'modal-edit-match')">
 ...
 <button onclick="searchUsersEditMatch()" style="width:80px;padding:12px;background:#3b82f6;color:#ffffff;border:none;border-radius:8px;font-weight:600;cursor:pointer;">Search</button>
 </div>
...
<div class="modal-overlay" id="modal-invite-user" onclick="closeModalOutside(event,'modal-invite-user')">
 ...
 <button onclick="searchUsers()" style="width:80px;padding:12px;background:#3b82f6;color:#ffffff;border:none;border-radius:8px;font-weight:600;cursor:pointer;">Search</button>
 </div>
 </div>
...
function icGetXPLevel(xp) {
  ...
  if (xp >= 1000) return {level: 3, name: 'Gold', color: '#E8B84B', glow: 'rgba(59,130,246,0.3)'};
...
function icRenderRewards() {
  ...
  function badgeSVG(tier, size) {
    ...
    const colors = {
      ...
      gold:    {fill:'#E8B84B', glow:'rgba(59,130,246,0.6)',  stroke:'#b8901f'},
  ...
  if (manualRewards.length) {
    ...
    manualRewards.forEach(function(r) {
      ...
      if(r.id==='classic_landslaget'){
        ...
        html += '<span style="font-size:9px;background:rgba(59,130,246,0.2);color:#E8B84B;padding:2px 8px;border-radius:10px;font-weight:700;letter-spacing:0.06em;border:1px solid rgba(59,130,246,0.3);">LANDSLAGET</span>';
        html += '</div></div></div>';
        return;
      }
...
(function(){
  ...
  var colors=['#3b82f6','#4caf7d','#60a5fa','#f87171','#a78bfa','#fb923c','#34d399','#f472b6'];
...
window.setAppLang=function setAppLang(lang){
  ...
  if(btnNo&&btnEn){
    if(no){
      btnNo.style.borderColor="#3b82f6";btnNo.style.background="rgba(59,130,246,0.15)";btnNo.style.color="#3b82f6";
      btnEn.style.borderColor="rgba(255,255,255,0.15)";btnEn.style.background="transparent";btnEn.style.color="var(--muted)";
    }else{
      btnEn.style.borderColor="#3b82f6";btnEn.style.background="rgba(59,130,246,0.15)";btnEn.style.color="#3b82f6";
