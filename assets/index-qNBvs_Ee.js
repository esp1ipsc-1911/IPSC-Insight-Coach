...
<div class="modal-overlay" id="modal-add" onclick="closeModalOutside(event,'modal-add')">
 ...
 <input class="field-input" type="number" id="new-result-c" value="0" readonly style="text-align:center;background:var(--card);color:var(--text);-webkit-text-fill-color:var(--text);opacity:1;">
 ...
 <input class="field-input" type="number" id="new-result-d" value="0" readonly style="text-align:center;background:var(--card);color:var(--text);-webkit-text-fill-color:var(--text);opacity:1;">
 ...
 <input class="field-input" type="number" id="new-result-miss" value="0" readonly style="text-align:center;background:var(--card);color:var(--text);-webkit-text-fill-color:var(--text);opacity:1;">
 ...
 <input class="field-input" type="number" id="new-result-ns" value="0" readonly style="text-align:center;background:var(--card);color:var(--text);-webkit-text-fill-color:var(--text);opacity:1;">
 ...
 <input class="field-input" type="number" id="new-result-proc" value="0" readonly style="text-align:center;background:var(--card);color:var(--text);-webkit-text-fill-color:var(--text);opacity:1;">
