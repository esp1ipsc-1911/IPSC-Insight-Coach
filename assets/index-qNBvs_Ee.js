 ...
 *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
 ...
 .gdpr-close { width: 100%; margin-top: 18px; padding: 12px; background: linear-gradient(135deg,var(--accent),var(--accent2)); color: #ffffff; border: none; border-radius: 10px; font-size: 12px; font-weight: 800; letter-spacing: 0.12em; text-transform: uppercase; cursor: pointer; }
...
_st.textContent="\
:root{--accent:#3b82f6;--accent2:#2563eb;--accent-fade:rgba(59,130,246,0.12);--accent-glow:rgba(59,130,246,0.25);--bg:#0d0f12;--bg2:#111418;--bg3:#161a1f;--card:#141820;--card2:#181d24;--border:rgba(255,255,255,0.07);--border-gold:rgba(59,130,246,0.25);--text:#f0f2f5;--muted:rgba(255,255,255,0.38);--green:#4caf7d;--red:#ef4444;--radius:12px;--radius-sm:8px;}\
...
.ipad-nav-item:hover{color:rgba(59,130,246,0.8);background:rgba(59,130,246,0.05);}\
.ipad-nav-item.active{color:var(--accent);border-left-color:var(--accent);background:rgba(59,130,246,0.08);}\
