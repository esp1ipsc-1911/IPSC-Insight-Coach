...
.ipad-sidebar{display:none;position:fixed;left:0;top:0;bottom:0;width:72px;background:linear-gradient(180deg,#0a0c0f 0%,#0d1017 60%,#0a0c0f 100%);border-right:1px solid rgba(224,182,73,0.12);flex-direction:column;align-items:center;padding:18px 0 16px;gap:2px;z-index:200;box-shadow:4px 0 40px rgba(0,0,0,0.6);}\
.ipad-logo{font-size:14px;font-weight:900;color:var(--accent);letter-spacing:0.1em;margin-bottom:20px;text-shadow:0 0 24px rgba(224,182,73,0.5);border-bottom:1px solid rgba(224,182,73,0.15);padding-bottom:16px;width:100%;text-align:center;}\
...
.ipad-panel-label{display:none;font-size:9px;font-weight:900;letter-spacing:0.12em;color:var(--accent);margin-bottom:14px;padding-bottom:10px;border-bottom:1px solid rgba(224,182,73,0.15);text-transform:uppercase;text-shadow:0 0 16px rgba(224,182,73,0.3);}\
...
.ipad-profile-left{width:32%!important;min-width:240px!important;padding:24px 20px!important;overflow-y:auto!important;height:100%!important;box-sizing:border-box!important;border-right:1px solid rgba(224,182,73,0.08)!important;background:rgba(0,0,0,0.25)!important;display:flex!important;flex-direction:column!important;align-items:center!important;}\
...
function icGetXPLevel(xp) {
  ...
  if (xp >= 1000) return {level: 3, name: 'Gold', color: '#E8B84B', glow: 'rgba(232,184,75,0.3)'};
...
function icRenderRewards() {
  ...
  function badgeSVG(tier, size) {
    ...
    const colors = {
      ...
      gold:    {fill:'#E8B84B', glow:'rgba(232,184,75,0.6)',  stroke:'#b8901f'},
