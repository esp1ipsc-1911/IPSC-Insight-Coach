...
<div class="modal-overlay" id="modal-edit-match" onclick="closeModalOutside(event,'modal-edit-match')">
 ...
 <div class="field-group">
 <div class="field-label">Extra shooters in this match</div>
...
window.setAppLang=function setAppLang(lang){
  ...
  var _map={
    ...
    "Select division":"Select division","Ingen rival valgt":"No rival selected",
    ...
    "Last opp resultat":"Upload result","Create team":"Create team",
    "Save team":"Save team","Team name":"Team name","Land":"Country",
    "Extra shooters in this match":"Extra shooters in match",
