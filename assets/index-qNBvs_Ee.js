...
<div class="modal-overlay" id="modal-edit-match" onclick="closeModalOutside(event,'modal-edit-match')">
 ...
 <button class="btn-primary" onclick="openModal('modal-add-shooter')">Ny skytter i match</button>
...
<div class="modal-overlay" id="modal-add-shooter" onclick="closeModalOutside(event,'modal-add-shooter')">
 ...
 <select class="field-select" id="new-shooter-pf"><option value="minor">Minor</option><option value="major">Major</option></select>
 </div>
