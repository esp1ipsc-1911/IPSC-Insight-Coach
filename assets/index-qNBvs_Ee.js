...
<div class="modal-overlay" id="modal-edit-match" onclick="closeModalOutside(event,'modal-edit-match')">
 ...
 <div class="field-group">
 <div class="field-label">Eksterne skyttere (valgfritt)</div>
 <div class="field-group" style="margin-bottom:10px;">
 <input class="field-input" type="text" id="edit-match-shooter-name" placeholder="Navn på skytter">
 </div>
 <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px;">
 <select class="field-select" id="edit-match-shooter-division">
 <option value="Classic">Classic</option>
 <option value="Standard">Standard</option>
 <option value="Open">Open</option>
 <option value="Production">Production</option>
 ...
 <select class="field-select" id="edit-match-shooter-pf">
 <option value="minor">Minor</option>
 <option value="major">Major</option>
 </select>
 </div>
 <button class="btn-primary" onclick="addEditMatchShooter()" style="width:100%;margin-bottom:10px;">Legg til skytter</button>
