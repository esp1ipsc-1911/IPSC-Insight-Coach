...
<div class="screen" id="screen-matches">
  <div class="navbar">
    ...
    <div class="nav-avatar" id="nav-av-matches" onclick="switchTab('screen-profile')">EF</div>
  </div>
  <div class="scroll-content">
    ...
    <div class="filter-row">
      ...
      <div class="filter-chip" onclick="setFilter('2024',this)">2024</div>
  ...
  <div class="tab-bar">
    <div class="tab-item" onclick="switchTab('screen-home')"><div class="tab-icon">&#127968;</div><span class="lang-home">Hjem</span></div>
    <div class="tab-item active" onclick="switchTab('screen-matches')"><div class="tab-icon">&#127942;</div><span class="lang-matches">Matcher</span></div>
    <div class="tab-item" onclick="switchTab('screen-prognose')"><div class="tab-icon">&#128200;</div><span class="lang-prognosis">Prognose</span></div>
    <div class="tab-item" onclick="switchTab('screen-results')"><div class="tab-icon">&#127970;</div><span class="lang-results">Live</span></div>
    <div class="tab-item" onclick="switchTab('screen-profile')"><div class="tab-icon">&#128100;</div><span class="lang-profile">Profil</span></div>
  </div>
...
<div class="screen" id="screen-prognose">
  <div class="navbar">
    ...
    <div class="match-chip" onclick="switchTab('screen-matches')">
      <div class="match-chip-dot"></div>
      <div class="match-chip-name" id="prog-chip-name">Ingen match valgt</div>
      <div class="match-chip-arrow">&#9660;</div>
    </div>
    <div class="nav-avatar" id="nav-av-prog" onclick="switchTab('screen-profile')">EF</div>
  </div>
  <div class="scroll-content">
    ...
    <div class="card">
      ...
      <div class="stats-grid">
        ...
        <div class="stat-block"><div class="stat-value">1.42s</div><div class="stat-label">Draw</div></div>
        <div class="stat-block"><div class="stat-value">1.8s</div><div class="stat-label">Reload</div></div>
    ...
    <div class="card">
      ...
      <div class="prognose-inputs">
        <div class="prog-field"><input type="number" id="prog-shots" value="12" oninput="calcPrognose()"><div class="prog-field-lbl lang-shots">Skudd</div></div>
        <div class="prog-field"><input type="number" id="prog-targets" value="6" oninput="calcPrognose()"><div class="prog-field-lbl lang-targets">Skiver</div></div>
        <div class="prog-field"><input type="number" id="prog-steel" value="2" oninput="calcPrognose()"><div class="prog-field-lbl lang-steel">Stål</div></div>
      </div>
      ...
      <div class="prognose-inputs">
        ...
        <div class="prog-field"><input type="number" id="prog-move" value="3" oninput="calcPrognose()"><div class="prog-field-lbl lang-move_seconds">Beveg. (s)</div></div>
        <div class="prog-field"><input type="number" id="prog-draw" value="1.42" oninput="calcPrognose()" style="color:var(--accent)"><div class="prog-field-lbl lang-draw_seconds">Trekk (s)</div></div>
      </div>
      <div class="prognose-result">
        <div style="font-size:11px;color:var(--muted);margin-bottom:3px" id="prog-pf-note">MINOR · Standard</div>
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin:16px 0 10px">
      <div style="font-family:'Rajdhani',sans-serif;font-size:18px;font-weight:700">&#128302; Hva skjer videre?</div>
    </div>
    <div id="forward-container"></div>
    <div class="section-title">HF-utvikling – <span id="prog-history-match-name" style="color:var(--accent)">—</span></div>
    <div class="card" id="prog-history-card"><div style="color:var(--muted);font-size:13px;text-align:center;padding:10px 0">Velg en match for å se historikk</div></div>
    <div style="display:flex;align-items:center;justify-content:space-between;margin:14px 0 10px">
      <div style="font-family:'Rajdhani',sans-serif;font-size:17px;font-weight:600">Skyttere &amp; stilling</div>
      <button class="btn-sm accent" onclick="openModal('modal-add-shooter')">+ Legg til</button>
    </div>
    <div id="rivals-container"></div>
    <div style="font-family:'Rajdhani',sans-serif;font-size:17px;font-weight:600;margin:14px 0 10px">Total stilling</div>
    <div class="card" id="standings-container"></div>
  </div>
  <div class="tab-bar">
    <div class="tab-item" onclick="switchTab('screen-home')"><div class="tab-icon">&#127968;</div><span class="lang-home">Hjem</span></div>
    <div class="tab-item" onclick="switchTab('screen-matches')"><div class="tab-icon">&#127942;</div><span class="lang-matches">Matcher</span></div>
    <div class="tab-item active" onclick="switchTab('screen-prognose')"><div class="tab-icon">&#128200;</div><span class="lang-prognosis">Prognose</span></div>
    <div class="tab-item" onclick="switchTab('screen-results')"><div class="tab-icon">&#127970;</div><span class="lang-results">Live</span></div>
    <div class="tab-item" onclick="switchTab('screen-profile')"><div class="tab-icon">&#128100;</div><span class="lang-profile">Profil</span></div>
  </div>
</div>
...
<div class="screen" id="screen-profile">
  <div class="profile-header">
    <div class="profile-avatar" id="prof-avatar">EF</div>
    <div class="profile-name" id="prof-name">Espen Fiskebeck</div>
    <div class="profile-div" id="prof-div">Standard · DSSNPistol</div>
    <div class="profile-badges">
      <span class="badge badge-gold" id="prof-badge-pf">Minor</span>
      <span class="badge badge-green">Verified</span>
      <span class="badge badge-blue" id="prof-badge-region">NOR</span>
    </div>
    <button class="btn-primary" style="margin-top:16px;max-width:168px;margin-left:auto;margin-right:auto" onclick="openEditProfile()">&#9998; Rediger profil</button>
  </div>
  <div class="scroll-content" style="padding-top:0">
    <div class="card">
      <div class="card-title" style="margin-bottom:12px">Personlig informasjon</div>
      <div class="info-row"><span class="info-key lang-first_name">Fornavn</span><span class="info-val" id="info-firstname">Espen</span></div>
      <div class="info-row"><span class="info-key lang-last_name">Etternavn</span><span class="info-val" id="info-lastname">Fiskebeck</span></div>
      <div class="info-row"><span class="info-key">Divisjon</span><span class="info-val" id="info-division">Standard</span></div>
      <div class="info-row"><span class="info-key lang-category">Kategori</span><span class="info-val" id="info-category">—</span></div>
      <div class="info-row"><span class="info-key">Power Factor</span><span class="info-val" id="info-pf">Minor</span></div>
      <div class="info-row"><span class="info-key lang-region">Region</span><span class="info-val" id="info-region">Norge</span></div>
      <div class="info-row"><span class="info-key lang-club">Klubb</span><span class="info-val" id="info-club">DSSNPistol</span></div>
    </div>
    <div class="section-title">Sesongstatistikk</div>
    <div class="stats-grid" style="margin-bottom:12px">
      <div class="stat-block"><div class="stat-value" id="stat-matches">0</div><div class="stat-label lang-matches_count">Matcher</div></div>
      <div class="stat-block"><div class="stat-value" id="stat-stages">0</div><div class="stat-label lang-stages_count">Stages</div></div>
      <div class="stat-block"><div class="stat-value" id="stat-avg-hf">—</div><div class="stat-label lang-avg_hf">Snitt HF</div></div>
      <div class="stat-block"><div class="stat-value" id="stat-a-rate">—</div><div class="stat-label lang-a_rate">A-andel</div></div>
    </div>
    <div class="card" style="margin-bottom:80px">
      <div class="card-title" style="margin-bottom:4px">Konto</div>
      <div class="info-row" style="cursor:pointer"><span class="info-key">Endre passord</span><span>›</span></div>
      <div class="info-row" style="cursor:pointer"><span class="info-key">Eksporter data</span><span>›</span></div>
      <div class="info-row" style="cursor:pointer;color:var(--red)" onclick="navigate('screen-login')"><span>Logg ut</span></div>
    </div>
  </div>
  <div class="tab-bar">
    <div class="tab-item" onclick="switchTab('screen-home')"><div class="tab-icon">&#127968;</div><span class="lang-home">Hjem</span></div>
    ...
    <div class="tab-item" onclick="switchTab('screen-prognose')"><div class="tab-icon">&#128200;</div><span class="lang-prognosis">Prognose</span></div>
    <div class="tab-item" onclick="switchTab('screen-results')"><div class="tab-icon">&#127970;</div><span class="lang-results">Live</span></div>
    <div class="tab-item active" onclick="switchTab('screen-profile')"><div class="tab-icon">&#128100;</div><span class="lang-profile">Profil</span></div>
  </div>
</div>
...
<div class="screen" id="screen-results">
  <div class="navbar">
    <div class="nav-title">RESUL<span>TAT</span></div>
    <div class="match-chip" onclick="switchTab('screen-matches')">
      <div class="match-chip-dot"></div>
      <div class="match-chip-name" id="results-chip-name">Ingen match valgt</div>
      <div class="match-chip-arrow">&#9660;</div>
    </div>
    <div class="nav-avatar" onclick="switchTab('screen-profile')" id="nav-av-results">EF</div>
  </div>
  <div class="scroll-content" id="results-content" style="padding:0 0 110px"></div>
  <div class="tab-bar">
    <div class="tab-item" onclick="switchTab('screen-home')"><div class="tab-icon">&#127968;</div><span class="lang-home">Hjem</span></div>
    <div class="tab-item" onclick="switchTab('screen-matches')"><div class="tab-icon">&#127942;</div><span class="lang-matches">Matcher</span></div>
    <div class="tab-item" onclick="switchTab('screen-prognose')"><div class="tab-icon">&#128200;</div><span class="lang-prognosis">Prognose</span></div>
    <div class="tab-item active" onclick="switchTab('screen-results')"><div class="tab-icon">&#127970;</div><span class="lang-results">Live</span></div>
    <div class="tab-item" onclick="switchTab('screen-profile')"><div class="tab-icon">&#128100;</div><span class="lang-profile">Profil</span></div>
  </div>
</div>
...
<div class="modal-overlay" id="modal-new-match" onclick="closeModalOutside(event,'modal-new-match')">
  <div class="modal">
    ...
    <div class="modal-title lang-new_match">Ny match</div>
    <div class="input-full"><div class="field-label lang-match_name">Matchnavn *</div><input class="field-input" id="nm-name" placeholder="Bergen Open 2025"></div>
    <div class="input-row">
      <div><div class="field-label lang-date">Dato</div><input class="field-input" id="nm-date" type="date"></div>
      <div><div class="field-label lang-type">Type</div><select class="field-select" id="nm-type"><option class="lang-match_types_stevne">Stevne</option><option class="lang-match_types_trening">Trening</option><option class="lang-match_types_klubbmatch">Klubbmatch</option><option class="lang-match_types_landsmesterskap">Landsmesterskap</option><option class="lang-match_types_internasjonalt">Internasjonalt</option></select></div>
    </div>
    <div class="input-row">
      <div><div class="field-label lang-location">Sted</div><input class="field-input" id="nm-location" placeholder="Bergen"></div>
      <div><div class="field-label">Ant. stages</div><input class="field-input" id="nm-stages" type="number" placeholder="6"></div>
    </div>
    <div class="lang-stages_added_later" style="background:rgba(232,184,75,.07);border:1px solid rgba(232,184,75,.15);border-radius:var(--radius-sm);padding:10px 12px;margin-bottom:12px;font-size:12px;color:var(--muted);">Stages legges til etter hvert</div>
    <button class="btn-primary" onclick="createMatch()">Opprett match</button>
  </div>
</div>
...
<div class="modal-overlay" id="modal-add" onclick="closeModalOutside(event,'modal-add')">
  <div class="modal">
    <div class="modal-handle"></div>
    <div class="modal-title lang-add_result">Legg til resultat</div>
    <div id="modal-match-selector" style="margin-bottom:12px;display:none"><div class="field-label">Match</div><select class="field-select" id="result-match-select"></select></div>
    <div class="seg-control">
      <button class="seg-btn active" onclick="switchMode(this,'mode-manual')">Manuell</button>
      <button class="seg-btn" onclick="switchMode(this,'mode-email')">SSI-epost</button>
      <button class="seg-btn" onclick="switchMode(this,'mode-file')">&#128247; Skann</button>
    </div>
    <div id="mode-manual">
      <div class="input-row">
        <div><div class="field-label">Stage nr.</div><input class="field-input" type="number" placeholder="1" id="m-stage"></div>
        <div><div class="field-label">Tid (sek)</div><input class="field-input" type="number" placeholder="13.77" id="m-time" oninput="calcManual()"></div>
      </div>
      <div class="section-label">Treff</div>
      <div class="hit-row" style="margin-bottom:10px">
        <div class="hit-cell"><input style="color:var(--green)" type="number" placeholder="0" id="m-a" oninput="calcManual()"><div class="hit-lbl">A</div></div>
        <div class="hit-cell"><input style="color:var(--accent)" type="number" placeholder="0" id="m-c" oninput="calcManual()"><div class="hit-lbl">C</div></div>
        <div class="hit-cell"><input style="color:#f59e0b" type="number" placeholder="0" id="m-d" oninput="calcManual()"><div class="hit-lbl">D</div></div>
        <div class="hit-cell"><input style="color:var(--red)" type="number" placeholder="0" id="m-miss" oninput="calcManual()"><div class="hit-lbl">Miss</div></div>
        <div class="hit-cell"><input style="color:var(--red)" type="number" placeholder="0" id="m-ns" oninput="calcManual()"><div class="hit-lbl">N/S</div></div>
        <div class="hit-cell"><input style="color:var(--muted)" type="number" placeholder="0" id="m-proc" oninput="calcManual()"><div class="hit-lbl">Proc</div></div>
      </div>
      <div class="prognose-result" id="manual-preview" style="display:none">
        <div style="font-size:11px;color:var(--muted);margin-bottom:2px" id="manual-pf-note">MINOR</div>
        <div class="prog-hf-label">Hit Factor</div>
        <div class="prog-hf-value" id="manual-hf">—</div>
        <div class="prog-breakdown" id="manual-pts"></div>
      </div>
      <button class="btn-primary lang-save_result" style="margin-top:12px" onclick="saveManual()">Lagre resultat</button>
    </div>
    <div id="mode-email" style="display:none">
      <div class="section-label">Lim inn SSI verify-epost</div>
      <textarea class="paste-area" id="email-paste" placeholder="332 Ravn, Christel&#10;Stage: Stage 2&#10;Factor: Minor&#10;A  C  D  Miss  N/S  Proc  Hit Factor  Time&#10;10  2  0  0  0  0  1.9670  28.47" oninput="parseEmail()"></textarea>
      <div class="parse-preview" id="parse-preview">
        <div class="section-label" style="margin:0 0 6px">Lest av</div>
        <div class="parse-row"><span class="parse-key">Skytte</span><span class="parse-val" id="pp-name">—</span></div>
        <div class="parse-row"><span class="parse-key">Stage</span><span class="parse-val" id="pp-stage">—</span></div>
        <div class="parse-row"><span class="parse-key">Hit Factor</span><span class="parse-val" id="pp-hf">—</span></div>
        <div class="parse-row"><span class="parse-key">Tid</span><span class="parse-val" id="pp-time">—</span></div>
        <div class="parse-row"><span class="parse-key">A/C/D/M/NS</span><span class="parse-val" id="pp-hits">—</span></div>
      </div>
      <button class="btn-primary" style="margin-top:12px" onclick="saveEmail()">Importer resultat</button>
    </div>
    <div id="mode-file" style="display:none">
      <!-- HIDDEN FILE INPUT -->
      <input type="file" id="scan-file-input" accept="image/*" capture="environment" style="display:none" onchange="handleScanImage(event)">

      <!-- SCAN BUTTON -->
      <div style="background:linear-gradient(135deg,rgba(232,184,75,.1),rgba(232,184,75,.05));border:2px dashed rgba(232,184,75,.3);border-radius:var(--radius);padding:28px;text-align:center;margin-bottom:12px">
        <div style="font-size:48px;margin-bottom:10px">&#128247;</div>
        <div style="font-size:15px;font-weight:600;margin-bottom:4px">Skann SSI-skjermbilde</div>
        <div style="font-size:12px;color:var(--muted);margin-bottom:16px">AI leser av HF, tid, A, C, D, Miss automatisk</div>
        <button class="btn-primary" style="max-width:200px;margin:0 auto" onclick="el('scan-file-input').click()">&#128247; Ta bilde / Velg fil</button>
      </div>

      <!-- SCAN STATUS -->
      <div id="scan-status" style="display:none;background:var(--bg3);border-radius:var(--radius-sm);padding:14px;margin-bottom:12px;text-align:center">
        <div style="font-size:13px;color:var(--muted)" id="scan-status-text">Analyserer bilde...</div>
        <div id="scan-spinner" style="margin-top:8px;font-size:20px">&#9696;</div>
      </div>

      <!-- SCAN PREVIEW -->
      <div id="scan-preview" style="display:none;background:var(--bg3);border-radius:var(--radius-sm);padding:14px;margin-bottom:12px">
        <div style="font-size:11px;font-weight:600;color:var(--green);text-transform:uppercase;margin-bottom:10px">&#10003; Lest av fra bilde</div>
        <div id="scan-preview-content"></div>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:12px">
          <button class="btn-secondary" onclick="clearScan()">&#10005; Avbryt</button>
          <button class="btn-primary" onclick="confirmScan()">&#10003; Bruk disse</button>
        </div>
      </div>

      <!-- SCAN ERROR -->
      <div id="scan-error" style="display:none;background:rgba(224,82,82,.1);border:1px solid rgba(224,82,82,.2);border-radius:var(--radius-sm);padding:12px;margin-bottom:12px">
        <div style="font-size:13px;color:var(--red)" id="scan-error-text">Kunne ikke lese bildet. Prøv igjen.</div>
        <button class="btn-sm" style="margin-top:8px;width:100%" onclick="el('scan-file-input').click()">Prøv igjen</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal-overlay" id="modal-add-shooter" onclick="closeModalOutside(event,'modal-add-shooter')">
  <div class="modal">
    <div class="modal-handle"></div>
    <div class="modal-title lang-add_shooter">Legg til skytter</div>
    <div class="seg-control">
      <button class="seg-btn active" onclick="switchShooterMode(this,'sm-manual')">Manuell</button>
      <button class="seg-btn" onclick="switchShooterMode(this,'sm-email')">SSI-epost</button>
      <button class="seg-btn" onclick="switchShooterMode(this,'sm-scan')">&#128247; Skann</button>
      <button class="seg-btn" onclick="switchShooterMode(this,'sm-paste')">Lim inn</button>
    </div>
    <div id="sm-manual">
      <div class="input-row">
        <div><div class="field-label lang-first_name">Fornavn</div><input class="field-input" id="sh-firstname" placeholder="Jan Stian"></div>
        <div><div class="field-label lang-last_name">Etternavn</div><input class="field-input" id="sh-lastname" placeholder="Fiskerstrand"></div>
      </div>
      <div class="input-row">
        <div><div class="field-label">Divisjon</div><select class="field-select" id="sh-division"><option>Standard</option><option>Open</option><option>Production</option><option>Production Optics</option><option>Classic</option><option>Revolver</option></select></div>
        <div><div class="field-label lang-select_power_factor">Power Factor</div><select class="field-select" id="sh-pf"><option value="minor">Minor</option><option value="major">Major</option></select></div>
      </div>
      <div class="input-full"><div class="field-label lang-club">Klubb</div><input class="field-input" id="sh-club" placeholder="NOP"></div>
      <div class="input-row">
        <div><div class="field-label lang-draw_seconds">Trekk (s)</div><input class="field-input" type="number" step="0.01" id="sh-draw" placeholder="1.42"></div>
        <div><div class="field-label lang-reload_seconds">Reload (s)</div><input class="field-input" type="number" step="0.01" id="sh-reload" placeholder="1.80"></div>
      </div>
      <div class="section-label">Stage-resultater</div>
      <div id="sh-stages-list"></div>
      <button class="btn-sm" style="width:100%;padding:10px;margin-bottom:14px" onclick="addShooterStageRow()">+ Legg til stage</button>
      <button class="btn-primary lang-save_shooter" onclick="saveShooter()">Lagre skytter</button>
    </div>
    <div id="sm-email" style="display:none">
      <div class="section-label">Lim inn SSI verify-epost</div>
      <textarea class="paste-area" id="sh-email-paste" placeholder="332 Ravn, Christel&#10;Stage: Stage 2&#10;Factor: Minor&#10;A  C  D  Miss  N/S  Proc  Hit Factor  Time&#10;10  2  0  0  0  0  1.9670  28.47" oninput="parseShooterEmail()"></textarea>
      <div class="parse-preview" id="sh-parse-preview">
        <div class="section-label" style="margin:0 0 6px">Lest av</div>
        <div class="parse-row"><span class="parse-key">Skytte</span><span class="parse-val" id="sh-pp-name">—</span></div>
        <div class="parse-row"><span class="parse-key">Hit Factor</span><span class="parse-val" id="sh-pp-hf">—</span></div>
        <div class="parse-row"><span class="parse-key">Tid</span><span class="parse-val" id="sh-pp-time">—</span></div>
        <div class="parse-row"><span class="parse-key">A/C/D/M/NS</span><span class="parse-val" id="sh-pp-hits">—</span></div>
      </div>
      <button class="btn-primary" style="margin-top:12px" onclick="saveShooterFromEmail()">Importer</button>
    </div>
    <div id="sm-scan" style="display:none">
      <input type="file" id="rival-scan-input" accept="image/*" capture="environment" style="display:none" onchange="handleRivalScan(event)">
      <div style="background:linear-gradient(135deg,rgba(232,184,75,.1),rgba(232,184,75,.05));border:2px dashed rgba(232,184,75,.3);border-radius:var(--radius);padding:22px;text-align:center;margin-bottom:12px">
        <div style="font-size:40px;margin-bottom:8px">&#128247;</div>
        <div style="font-size:14px;font-weight:600;margin-bottom:4px">Skann SSI-skjermbilde</div>
        <div style="font-size:12px;color:var(--muted);margin-bottom:14px">AI leser av HF, tid og treff for rival</div>
        <button class="btn-primary" style="max-width:200px;margin:0 auto" onclick="el('rival-scan-input').click()">&#128247; Ta bilde / Velg fil</button>
      </div>
      <div id="rival-scan-status" style="display:none;background:var(--bg3);border-radius:var(--radius-sm);padding:12px;margin-bottom:10px;text-align:center">
        <div style="font-size:13px;color:var(--muted)" id="rival-scan-status-text">Analyserer...</div>
      </div>
      <div id="rival-scan-preview" style="display:none;background:var(--bg3);border-radius:var(--radius-sm);padding:12px;margin-bottom:10px">
        <div style="font-size:11px;font-weight:600;color:var(--green);text-transform:uppercase;margin-bottom:8px">&#10003; Lest av</div>
        <div id="rival-scan-content"></div>
        <div style="margin-top:10px;font-size:12px;color:var(--muted)">Navn (for å matche/opprette skytter):</div>
        <input class="field-input" id="rival-scan-name" placeholder="Henrik Johansen" style="margin-top:6px">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:10px">
          <button class="btn-secondary" onclick="clearRivalScan()">&#10005; Avbryt</button>
          <button class="btn-primary" onclick="confirmRivalScan()">&#10003; Lagre</button>
        </div>
      </div>
      <div id="rival-scan-error" style="display:none;background:rgba(224,82,82,.1);border:1px solid rgba(224,82,82,.2);border-radius:var(--radius-sm);padding:10px;margin-bottom:10px">
        <div style="font-size:13px;color:var(--red)" id="rival-scan-error-text">Kunne ikke lese bildet.</div>
        <button class="btn-sm" style="margin-top:6px;width:100%" onclick="el('rival-scan-input').click()">Prøv igjen</button>
      </div>
    </div>
    <div id="sm-paste" style="display:none">
      <div class="section-label">Lim inn SSI-tabell (en rad per linje)</div>
      <textarea class="paste-area" style="height:150px" id="sh-raw-paste" oninput="parseShooterRaw()"></textarea>
      <div id="sh-raw-preview" style="margin-top:10px"></div>
      <button class="btn-primary" style="margin-top:10px" onclick="saveShootersFromRaw()">Importer alle</button>
    </div>
  </div>
</div>
...
<div class="modal-overlay" id="modal-edit-profile" onclick="closeModalOutside(event,'modal-edit-profile')">
  <div class="modal">
    <div class="modal-handle"></div>
    <div class="modal-title lang-edit_profile">Rediger profil</div>
    <div class="input-row">
      <div><div class="field-label lang-first_name">Fornavn</div><input class="field-input" type="text" id="edit-firstname"></div>
      <div><div class="field-label lang-last_name">Etternavn</div><input class="field-input" type="text" id="edit-lastname"></div>
    </div>
    <div class="input-full"><div class="field-label">Divisjon</div><select class="field-select" id="edit-division" onchange="updatePFOptions()"></select></div>
    <div class="section-label lang-select_power_factor">Power Factor</div>
    <div class="pf-options" id="pf-options"></div>
    <div style="font-size:11px;color:var(--muted);margin-bottom:14px">Major: A=5 C=4 D=2 · Minor: A=5 C=3 D=1 · Miss/NS/Proc = -10</div>
    <div class="input-full"><div class="field-label lang-category">Kategori</div><select class="field-select" id="edit-category"></select></div>
    <div class="input-row">
      <div><div class="field-label lang-region">Region</div><select class="field-select" id="edit-region"></select></div>
      <div><div class="field-label lang-club">Klubb</div><input class="field-input" type="text" id="edit-club"></div>
    </div>
    <div style="font-family:Rajdhani,sans-serif;font-size:16px;font-weight:700;margin:14px 0 10px;color:var(--accent)">&#9201; Personlige tidsvaribler</div>
    <div style="font-size:12px;color:var(--muted);margin-bottom:10px">Brukes til å beregne skuddtid per stage</div>
    <div class="input-row">
      <div><div class="field-label lang-draw_seconds">Trekk (s)</div><input class="field-input" type="number" step="0.01" id="edit-draw" placeholder="1.42"></div>
      <div><div class="field-label lang-reload_seconds">Reload-tid (s)</div><input class="field-input" type="number" step="0.01" id="edit-reload" placeholder="1.80"></div>
    </div>
    <div style="background:var(--bg3);border-radius:var(--radius-sm);padding:10px;margin-bottom:14px;font-size:12px;color:var(--muted)">
      Skuddtid = (total tid − trekk − reloads × reload-tid) / antall skudd
    </div>
    <button class="btn-primary lang-save_profile" id="save-profile-btn" onclick="saveProfile()">Lagre profil</button>
  </div>
</div>
